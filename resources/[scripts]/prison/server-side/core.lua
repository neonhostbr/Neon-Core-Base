	...
	if Passport and vRP.HasService(Passport,"Policia") then
		...
		if Keyboard and Keyboard[1] then
			...
			if OtherPassport then
				...
				if Identity then
					TriggerClientEvent("Notify",source,"Emplacamento","<b>Passaporte:</b> "..Identity["id"].."<br><b>Telefone:</b> "..vRP.Phone(OtherPassport).."<br><b>Nome:</b> "..Identity["name"].." "..Identity["name2"],"policia",10000)
				end
			end
		end
	end
