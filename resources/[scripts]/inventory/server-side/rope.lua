...
AddEventHandler("inventory:Carry",function()
	...
	if Passport then
		if not Carry[Passport] then
			...
			if OtherSource and not Carry[OtherPassport] and not vRPC.PlayingAnim(OtherSource,"amb@world_human_sunbathe@female@back@idle_a","idle_a") and not vRP.IsEntityVisible(OtherSource) then
