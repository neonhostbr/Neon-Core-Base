...
Use = {
	...
	["ammobox"] = function(source,Passport,Amount,Slot,Full,Item,Split)
		if Split and Split[2] then
			TriggerClientEvent("chest:Open",source,"ammobox:"..Split[2],"Item",false,false,true)
		end
	end,

	["weaponbox"] = function(source,Passport,Amount,Slot,Full,Item,Split)
		if Split and Split[2] then
			TriggerClientEvent("chest:Open",source,"weaponbox:"..Split[2],"Item",false,false,true)
		end
	end,

	["suitcase"] = function(source,Passport,Amount,Slot,Full,Item,Split)
		if Split and Split[2] then
			TriggerClientEvent("chest:Open",source,"suitcase:"..Split[2],"Item",false,false,true)
		end
	end,

	["treasurebox"] = function(source,Passport,Amount,Slot,Full,Item,Split)
		if Split and Split[2] then
			TriggerClientEvent("chest:Open",source,"treasurebox:"..Split[2],"Item",Full,true,true)
		end
	end,

	["christmas_04"] = function(source,Passport,Amount,Slot,Full,Item,Split)
		if Split and Split[2] then
			TriggerClientEvent("chest:Open",source,"christmas_04:"..Split[2],"Item",Full,true,true)
		end
	end,

	["medicbag"] = function(source,Passport,Amount,Slot,Full,Item,Split)
		if Split and Split[2] then
			TriggerClientEvent("chest:Open",source,"medicbag:"..Split[2],"Item",false,false,true)
		end
	end,
