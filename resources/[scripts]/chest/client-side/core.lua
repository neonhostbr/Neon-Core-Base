...
-----------------------------------------------------------------------------------------------------------------------------------------
local Chests = {
	{ ["Name"] = "LSPD", ["Coords"] = vec3(561.09,5.28,69.35), ["Mode"] = "1" },
	{ ["Name"] = "Paramedico", ["Coords"] = vec3(-1259.55,322.29,65.5), ["Mode"] = "2" },
	{ ["Name"] = "Restaurante", ["Coords"] = vec3(-2210.09,-385.14,13.31), ["Mode"] = "2" },
	-- Facs.lua
	{ ["Name"] = "Armas1", ["Coords"] = vec3(353.0,-1427.67,32.67), ["Mode"] = "2" }, ---# Nao configurado
	{ ["Name"] = "Armas2", ["Coords"] = vec3(353.0,-1427.67,32.67), ["Mode"] = "2" }, ---# Nao configurado
	{ ["Name"] = "Municao1", ["Coords"] = vec3(353.0,-1427.67,32.67), ["Mode"] = "2" }, ---# Nao configurado
	{ ["Name"] = "Municao2", ["Coords"] = vec3(353.0,-1427.67,32.67), ["Mode"] = "2" }, ---# Nao configurado
	{ ["Name"] = "Desmanche1", ["Coords"] = vec3(353.0,-1427.67,32.67), ["Mode"] = "2" }, ---# Nao configurado
	{ ["Name"] = "Desmanche2", ["Coords"] = vec3(353.0,-1427.67,32.67), ["Mode"] = "2" }, ---# Nao configurado
	{ ["Name"] = "Drogas1", ["Coords"] = vec3(353.0,-1427.67,32.67), ["Mode"] = "2" }, ---# Nao configurado
	{ ["Name"] = "Drogas2", ["Coords"] = vec3(353.0,-1427.67,32.67), ["Mode"] = "2" }, ---# Nao configurado
	{ ["Name"] = "Contrabando", ["Coords"] = vec3(353.0,-1427.67,32.67), ["Mode"] = "2" } ---# Nao configurado
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- LABELS
-----------------------------------------------------------------------------------------------------------------------------------------
