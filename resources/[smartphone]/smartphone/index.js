var Zr, Qr, ei, ti, bi, gi, MO, e, t, n = Object.prototype.hasOwnProperty,
    ...
    o = (e$, e0) => {
        var e8 = {};
        for (var e2 in e$) n.call(e$, e2) && 0 > e0.indexOf(e2) && (e8[e2] = e$[e2]);
        if (null != e$ && l)
            for (var e2 of l(e$)) 0 > e0.indexOf(e2) && a.call(e$, e2) && (e8[e2] = e$[e2]);
        return e8
    };
...
function r(e$, e0) {
    ...
    try {
        ...
        self[e0] = e$ => new Promise((e8, e1) => {
            let e6 = new URL(e$, e2);
            if (self[e0].moduleMap[e6]) return e8(self[e0].moduleMap[e6]);
            let e4 = new Blob([`import * as m from '${e6}';`, `${e0}.moduleMap['${e6}']=m;`], {
...
function h(e$, e0) {
    ...
    if (e8 = P(e$), e2 = P(e0), e8 || e2) return !(!e8 || !e2) && function (e$, e0) {
    ...
    if (e8 = N(e$), e2 = N(e0), e8 || e2) {
        if (!e8 || !e2 || Object.keys(e$).length !== Object.keys(e0).length) return !1;
        for (let e3 in e$) {
...
const g = e$ => null == e$ ? "" : N(e$) ? JSON.stringify(e$, v, 2) : String(e$),
    v = (e$, e0) => L(e0) ? {
        [`Map(${e0.size})`]: [...e0.entries()].reduce((e$, [e0, e8]) => (e$[`${e0} =>`] = e8, e$), {})
    } : I(e0) ? {
        [`Set(${e0.size})`]: [...e0.values()]
    } : !N(e0) || P(e0) || F(e0) ? e0 : String(e0),
    x = {},
    y = [],
    k = () => {},
    w = () => !1,
...
function oe(e$, e0 = x) {
    ...
    let e2 = function (e$, e0) {
        ...
        return e8.id = ie++, e8.allowRecurse = !!e0.allowRecurse, e8._isEffect = !0, e8.active = !0, e8.raw = e$, e8.deps = [], e8.options = e0, e8
    }(e$, e0);
...
function me(e$, e0, e8) {
    ...
    let e3 = e2.get(e8);
    e3 || e2.set(e8, e3 = new Set), e3.has(le) || (e3.add(le), le.deps.push(e3))
}
...
function he(e$, e0, e8, e2, e3, e1) {
    ...
    else if ("length" === e8 && P(e$)) e6.forEach((e$, e0) => {
        ("length" === e0 || e0 >= e2) && e7(e$)
    });
    else switch (void 0 !== e8 && e7(e6.get(e8)), e0) {
    case "add":
        P(e$) ? z(e8) && e7(e6.get("length")) : (e7(e6.get(ae)), L(e$) && e7(e6.get(se)));
        break;
    case "delete":
...
function Ce(e$ = !1, e0 = !1) {
    return function (e8, e2, e3) {
        ...
        return (D(e2) ? ge.has(e2) : be(e2)) || (e$ || me(e8, 0, e2), e0) ? e6 : ot(e6) ? e1 && z(e2) ? e6 : e6.value : N(e6) ? e$ ? Qe(e6) : Ze(e6) : e6
    }
}
...
function _e(e$ = !1) {
    return function (e0, e8, e2, e3) {
        let e1 = e0[e8];
        if (!e$ && (e2 = at(e2), !P(e0) && ot(e1) && !ot(e2))) return e1.value = e2, !0;
        let e6 = P(e0) && z(e8) ? Number(e8) < e0.length : R(e0, e8),
            e4 = Reflect.set(e0, e8, e2, e3);
        return e0 === at(e3) && (e6 ? Y(e2, e1) && he(e0, "set", e8, e2) : he(e0, "add", e8, e2)), e4
    }
...
function Ie(e$, e0, e8 = !1, e2 = !1) {
    ...
    let {
        has: e6
    } = Le(e3), e4 = e8 ? Re : e2 ? Pe : Ee;
    return e6.call(e3, e0) ? e4(e$.get(e0)) : e6.call(e3, e1) ? e4(e$.get(e1)) : void 0
}
...
function Oe(e$, e0 = !1) {
    let e8 = this.__v_raw,
        e2 = at(e8),
        e3 = at(e$);
    return e$ === e3 || e0 || me(e2, 0, e$), e0 || me(e2, 0, e3), e$ === e3 ? e8.has(e$) : e8.has(e$) || e8.has(e3)
}

function Me(e$, e0 = !1) {
    return e$ = e$.__v_raw, e0 || me(at(e$), 0, ae), Reflect.get(e$, "size", e$)
}
...
function De(e$, e0) {
    ...
    let e6 = e3.call(e8, e$);
    return e8.set(e$, e0), e1 ? Y(e0, e6) && he(e8, "set", e$, e0) : he(e8, "add", e$, e0), this
}
...
function $e(e$, e0) {
    return function (e8, e2) {
        let e3 = this,
            ...
            e6 = at(e1),
            e4 = e$ ? Re : e0 ? Pe : Ee;
        return e$ || me(e6, 0, ae), e1.forEach((e$, e0) => e8.call(e2, e4(e$), e4(e0), e3))
    }
}
...
function je(e$, e0, e8) {
    return function (...e2) {
        let e3 = this.__v_raw,
            ...
            e7 = e3[e$](...e2),
            e5 = e0 ? Re : e8 ? Pe : Ee;
        return e0 || me(e1, 0, "keys" === e$ && e6 ? se : ae), {
            next() {
                let {
                    value: e$,
                    done: e0
...
function qe(e$, e0) {
    ...
    return (e0, e2, e3) => "__v_isReactive" === e2 ? !e$ : "__v_isReadonly" === e2 ? e$ : "__v_raw" === e2 ? e0 : Reflect.get(R(e8, e2) && e2 in e0 ? e8 : e0, e2, e3)
...
class it {
    constructor(e$, e0 = !1) {
        this._rawValue = e$, this._shallow = e0, this.__v_isRef = !0, this._value = e0 ? e$ : st(e$)
    }
    get value() {
...
const dt = {
    ...
    set(e$, e0, e8, e2) {
        let e3 = e$[e0];
        return ot(e3) && !ot(e8) ? (e3.value = e8, !0) : Reflect.set(e$, e0, e8, e2)
    }
};
...
class mt {
    constructor(e$, e0, e8) {
        this._setter = e0, this._dirty = !0, this.__v_isRef = !0, this.effect = oe(e$, {
            lazy: !0,
            scheduler: () => {
...
function Mt(e$, e0, e8, e2) {
    P(e$) ? e8.push(...e$) : e0 && e0.includes(e$, e$.allowRecurse ? e2 + 1 : e2) || e8.push(e$), Ot()
}

function Vt(e$, e0 = null) {
    if (wt.length) {
        for (Pt = e0, Ct = [...new Set(wt)], wt.length = 0, _t = 0; _t < Ct.length; _t++) Ct[_t]();
...
function Dt(e$) {
    if (At.length) {
        ...
        for ((St = e0).sort((e$, e0) => Nt(e$) - Nt(e0)), Tt = 0; Tt < St.length; Tt++) St[Tt]();
        St = null, Tt = 0
    }
}
...
function jt(e$, e0, e8 = !1) {
    ...
    if (!M(e$)) {
        ...
        !e8 && e0.mixins.length && e0.mixins.forEach(e6), e$.extends && e6(e$.extends), e$.mixins && e$.mixins.forEach(e6)
    }
    return e2 || e1 ? (P(e2) ? e2.forEach(e$ => e3[e$] = null) : S(e3, e2), e$.__emits = e3) : e$.__emits = null
}

function Ft(e$, e0) {
    return !(!e$ || !_(e0)) && (R(e$, (e0 = e0.slice(2).replace(/Once$/, ""))[0].toLowerCase() + e0.slice(1)) || R(e$, K(e0)) || R(e$, e0))
}
let zt = null;
...
function Ht(e$) {
    ...
    try {
        ...
        if (4 & e8.shapeFlag) {
            ...
            let eB = e0;
            eD = Vl(eB(e1, eB.length > 1 ? {
                attrs: e7,
                slots: e4,
                emit: e5
            } : null)), ez = e0.props ? e7 : Gt(e7)
        }
        let eH = eD;
        if (!1 !== e0.inheritAttrs && ez) {
            ...
            eZ.length && (1 & eG || 6 & eG) && (e6 && eZ.some(A) && (ez = Wt(ez, e6)), eH = Ll(eH, ez))
        }
        e8.dirs && (eH.dirs = eH.dirs ? eH.dirs.concat(e8.dirs) : e8.dirs), e8.transition && (eH.transition = e8.transition), eD = eH
    } catch (eq) {
        gt(eq, e$, 1), eD = Pl(vl)
    }
    return zt = null, eD
...
const Gt = e$ => {
        let e0;
        for (let e8 in e$)("class" === e8 || "style" === e8 || _(e8)) && ((e0 || (e0 = {}))[e8] = e$[e8]);
        return e0
    },
    Wt = (e$, e0) => {
        let e8 = {};
...
function on(e$, e0, e8, e2 = !1) {
    let e3 = {},
        e1 = {};
    Q(e1, Tl, 1), rn(e$, e0, e3, e1), e8 ? e$.props = e2 ? e3 : et(e3, !1, Te, We) : e$.type.props ? e$.props = e3 : e$.props = e1, e$.attrs = e1
}
...
function rn(e$, e0, e8, e2) {
    ...
    if (e0)
        for (let e6 in e0) {
            ...
            if (B(e6)) continue;
            let e7;
            e3 && R(e3, e7 = G(e6)) ? e8[e7] = e4 : Ft(e$.emitsOptions, e6) || (e2[e6] = e4)
        }
    if (e1) {
        let e5 = at(e8);
...
function cn(e$, e0, e8, e2, e3) {
    ...
    if (null != e1) {
        ...
        if (e6 && void 0 === e2) {
            let e4 = e1.default;
            e1.type !== Function && M(e4) ? (aa(e3), e2 = e4(e0), aa(null)) : e2 = e4
        }
        e1[0] && (R(e0, e8) || e6 ? e1[1] && ("" === e2 || e2 === K(e8)) && (e2 = !0) : e2 = !1)
    }
    return e2
}
...
function un(e$, e0, e8 = !1) {
    ...
    if (!M(e$)) {
        ...
        !e8 && e0.mixins.length && e0.mixins.forEach(e4), e$.extends && e4(e$.extends), e$.mixins && e$.mixins.forEach(e4)
    }
            ...
            for (let eV in e2) {
                ...
                if (dn(eN)) {
                    ...
                    if (eU) {
                        ...
                        eU[0] = ej > -1, eU[1] = eD < 0 || ej < eD, (ej > -1 || R(eU, "default")) && e1.push(eN)
                    }
                }
            }
...
const bn = e$ => (e0, e8 = na) => !oa && hn(e$, e0, e8),
    gn = bn("bm"),
    vn = bn("m"),
    xn = bn("bu"),
    yn = bn("u"),
...
function En(e$, e0, {
    ...
    let e7, e5, eV = !1;
    if (ot(e$) ? (e7 = () => e$.value, eV = !!e$._shallow) : tt(e$) ? (e7 = () => e$, e2 = !0) : e7 = P(e$) ? () => e$.map(e$ => ot(e$) ? e$.value : tt(e$) ? Pn(e$) : M(e$) ? ht(e$, e4, 2, [e4 && e4.proxy]) : void 0) : M(e$) ? e0 ? () => ht(e$, e4, 2, [e4 && e4.proxy]) : () => {
            if (!e4 || !e4.isUnmounted) return e5 && e5(), ht(e$, e4, 3, [e9])
        } : k, e0 && e2) {
        let eN = e7;
        e7 = () => Pn(eN())
    }
    let e9 = e$ => {
        ...
        ej = () => {
            if (ez.active) {
                if (e0) {
                    let e$ = ez();
                    (e2 || eV || Y(e$, eU)) && (e5 && e5(), bt(e0, e4, 3, [e$, eU === Sn ? void 0 : eU, e9]), eU = e$)
                } else ez()
            }
        },
        eD;
    ej.allowRecurse = !!e0, eD = "sync" === e3 ? ej : "post" === e3 ? () => sl(ej, e4 && e4.suspense) : () => {
        var e$;
    ...
    return ca(ez, e4), e0 ? e8 ? ej() : eU = ez() : "post" === e3 ? sl(ez, e4 && e4.suspense) : ez(), () => {
...
function Pn(e$, e0 = new Set) {
    ...
    if (e0.add(e$), ot(e$)) Pn(e$.value, e0);
        ...
        for (let e8 = 0; e8 < e$.length; e8++) Pn(e$[e8], e0);
    else if (I(e$) || L(e$)) e$.forEach(e$ => {
        Pn(e$, e0)
    });
    else
        for (let e2 in e$) Pn(e$[e2], e0);
    return e$
}
        ...
        setup(e$, {
            ...
            return () => {
                ...
                if (e9 && e9.type !== vl && (!Sl(e5, e9) || eU)) {
                    ...
                    if (Un(e9, ez), "out-in" === e4) return e2.isLeaving = !0, ez.afterLeave = () => {
                        e2.isLeaving = !1, e8.update()
                    }, Dn(e7);
                    "in-out" === e4 && (ez.delayLeave = (e$, e0, e8) => {
                        Mn(e2, e9)[String(e9.key)] = e9, e$._leaveCb = () => {
...
function Vn(e$, e0, e8, e2) {
    let {
    ...
    } = e0, eH = String(e$.key), eZ = Mn(e8, e$), eG = (e$, e0) => {
        e$ && bt(e$, e2, 9, e0)
    }, eq = {
        mode: e1,
        persisted: e6,
        ...
        enter(e$) {
            ...
            let e6 = !1,
                e4 = e$._enterCb = e0 => {
                    e6 || (e6 = !0, eG(e0 ? e1 : e2, [e$]), eq.delayedLeave && eq.delayedLeave(), e$._enterCb = void 0)
                };
        ...
        leave(e0, e2) {
            ...
            let e1 = !1,
                e6 = e0._leaveCb = e8 => {
                    e1 || (e1 = !0, e2(), eG(e8 ? ej : eU, [e0]), e0._leaveCb = void 0, eZ[e3] === e$ && delete eZ[e3])
                };
...
function Un(e$, e0) {
    6 & e$.shapeFlag && e$.component ? Un(e$.component.subTree, e0) : 128 & e$.shapeFlag ? (e$.ssContent.transition = e0.clone(e$.ssContent), e$.ssFallback.transition = e0.clone(e$.ssFallback)) : e$.transition = e0
}
...
function $n(e$, e0 = !1) {
    ...
    for (let e3 = 0; e3 < e$.length; e3++) {
        let e1 = e$[e3];
        e1.type === bl ? (128 & e1.patchFlag && e2++, e8 = e8.concat($n(e1.children, e0))) : (e0 || e1.type !== vl) && e8.push(e1)
    }
    if (e2 > 1)
        for (let e6 = 0; e6 < e8.length; e6++) e8[e6].patchFlag = -2;
    return e8
}
const jn = e$ => e$.type.__isKeepAlive,
    Fn = {
        ...
        setup(e$, {
            ...
            function eD(e$) {
                let e0 = e8.get(e$);
                e3 && e0.type === e3.type ? e3 && qn(e3) : eU(e0), e8.delete(e$), e2.delete(e$)
            }
            e4.activate = (e$, e0, e8, e2, e3) => {
                let e1 = e$.component;
                e5(e$, e0, e8, 0, e6), e7(e1.vnode, e$, e0, e8, e1, e6, e2, e3), sl(() => {
            ...
            return vn(eF), yn(eF), kn(() => {
                ...
                if (!(Al(e6) && (4 & e6.shapeFlag || 128 & e6.shapeFlag))) return e3 = null, e6;
                let e4 = Gn(e6),
                    e7 = e4.type,
                    e5 = ua(e7),
                    {
                ...
                if (eV && (!e5 || !zn(eV, e5)) || eN && e5 && zn(eN, e5)) return e3 = e4, e6;
                let eU = null == e4.key ? e7 : e4.key,
                    ej = e8.get(eU);
                return e4.el && (e4 = Ll(e4), 128 & e6.shapeFlag && (e6.ssContent = e4)), ez = eU, ej ? (e4.el = ej.el, e4.component = ej.component, e4.transition && Un(e4, e4.transition), e4.shapeFlag |= 512, e2.delete(eU), e2.add(eU)) : (e2.add(eU), e9 && e2.size > parseInt(e9, 10) && eD(e2.values().next().value)), e4.shapeFlag |= 256, e3 = e4, e6
            }
        }
    };

function zn(e$, e0) {
    return P(e$) ? e$.some(e$ => zn(e$, e0)) : V(e$) ? e$.split(",").indexOf(e0) > -1 : !!e$.test && e$.test(e0)
}

function Bn(e$, e0, e8 = na) {
    let e2 = e$.__wdc || (e$.__wdc = () => {
        let e0 = e8;
        for (; e0;) {
    ...
    if (hn(e0, e2, e8), e8) {
        let e3 = e8.parent;
        for (; e3 && e3.parent;) jn(e3.parent.vnode) && Hn(e2, e0, e8, e3), e3 = e3.parent
    }
}
    ...
    return function (e8, e2 = null) {
        ...
        let e3 = el(),
            ...
            e4 = e3.app = {
                ...
                set config(e) {},
                use: (e$, ...e0) => (e1.has(e$) || (e$ && M(e$.install) ? (e1.add(e$), e$.install(e4, ...e0)) : M(e$) && (e1.add(e$), e$(e4, ...e0))), e4),
                mixin: e$ => (e3.mixins.includes(e$) || (e3.mixins.push(e$), (e$.props || e$.emits) && (e3.deopt = !0)), e4),
                component: (e$, e0) => e0 ? (e3.components[e$] = e0, e4) : e3.components[e$],
                directive: (e$, e0) => e0 ? (e3.directives[e$] = e0, e4) : e3.directives[e$],
                mount(e1, e7) {
                    if (!e6) {
                        let e5 = Pl(e8, e2);
                        return e5.appContext = e3, e7 && e0 ? e0(e5, e1) : e$(e5, e1), e6 = !0, e4._container = e1, e1.__vue_app__ = e4, e5.component.proxy
                    }
                },
                unmount() {
...
const al = {
    ...
    sl = function (e$, e0) {
        e0 && e0.pendingBranch ? P(e$) ? e0.effects.push(...e$) : e0.effects.push(e$) : Mt(e$, St, At, Tt)
    },
    ol = (e$, e0, e8, e2) => {
        if (P(e$)) return void e$.forEach((e$, e3) => ol(e$, e0 && (P(e0) ? e0[e3] : e0), e8, e2));
        let e3;
        e3 = !e2 || e2.type.__asyncLoader ? null : 4 & e2.shapeFlag ? e2.component.exposed || e2.component.proxy : e2.el;
        let {
            i: e1,
            r: e6
        } = e$, e4 = e0 && e0.r, e7 = e1.refs === x ? e1.refs = {} : e1.refs, e5 = e1.setupState;
        if (null != e4 && e4 !== e6 && (V(e4) ? (e7[e4] = null, R(e5, e4) && (e5[e4] = null)) : ot(e4) && (e4.value = null)), V(e6)) {
            let eV = () => {
...
function rl(e$) {
    return function (e$, e0) {
        let {
        ...
        } = e$, ez = (e$, e0, e8, e2 = null, e3 = null, e1 = null, e6 = !1, e4 = !1) => {
            e$ && !Sl(e$, e0) && (e2 = tD(e$), tV(e$, e3, e1, !0), e$ = null), -2 === e0.patchFlag && (e4 = !1, e0.dynamicChildren = null);
            let {
                type: e7,
                ref: e5,
                shapeFlag: eV
            ...
            case bl:
                ...
                break;
            default:
                1 & eV ? eq(e$, e0, e8, e2, e3, e1, e6, e4) : 6 & eV ? t0(e$, e0, e8, e2, e3, e1, e6, e4) : (64 & eV || 128 & eV) && e7.process(e$, e0, e8, e2, e3, e1, e6, e4, tF)
            }
            ...
            null == e$ ? e8(e0.el = e7(e0.children || ""), e2, e3) : e0.el = e$.el
        }, eH = (e$, e0, e8, e2) => {
            ...
            e6 = e6 || "svg" === e0.type, null == e$ ? eW(e0, e8, e2, e3, e1, e6, e4) : eY(e$, e0, e3, e1, e6, e4)
            ...
            if (e$.el && void 0 !== ej && -1 === eH) eN = e$.el = ej(e$.el);
                ...
                if (eN = e$.el = e6(e$.type, e7, eD && eD.is), 8 & ez ? eV(eN, e$.children) : 16 & ez && eX(e$.children, eN, null, e1, e4, e7 && "foreignObject" !== eU, e5 || !!e$.dynamicChildren), eZ && Qn(e$, null, e1, "created"), eD) {
                    for (let eG in eD) B(eG) || e3(eN, eG, null, eD[eG], e7, e$.children, e1, e4, tj);
            ...
            eq && eF.beforeEnter(eN), e8(eN, e0, e2), ((e9 = eD && eD.onVnodeMounted) || eq || eZ) && sl(() => {
                e9 && il(e9, e1, e$), eq && eF.enter(eN), eZ && Qn(e$, null, e1, "mounted")
            }, e4)
        }, eK = (e$, e0, e8, e2) => {
            if (e0 && eU(e$, e0), e2) {
                let e3 = e2.type.__scopeId;
                e3 && e3 !== e0 && eU(e$, e3 + "-s"), e8 === e2.subTree && eK(e$, e2.vnode.scopeId, e2.vnode, e2.parent)
            }
            ...
            let eU = e$.props || x,
                ej = e0.props || x,
                eD;
            if ((eD = ej.onVnodeBeforeUpdate) && il(eD, e8, e0, e$), e9 && Qn(e0, e$, e8, "beforeUpdate"), e5 > 0) {
                if (16 & e5) eJ(e7, e0, eU, ej, e8, e2, e6);
                else if (2 & e5 && eU.class !== ej.class && e3(e7, "class", null, ej.class, e6), 4 & e5 && e3(e7, "style", eU.style, ej.style, e6), 8 & e5) {
                    let ez = e0.dynamicProps;
                    for (let eF = 0; eF < ez.length; eF++) {
                        let eB = ez[eF],
                            eH = eU[eB],
                            eZ = ej[eB];
                        (eZ !== eH || e1 && e1(e7, eB)) && e3(e7, eB, eH, eZ, e6, e$.children, e8, e2, tj)
                    }
                }
                1 & e5 && e$.children !== e0.children && eV(e7, e0.children)
            } else e4 || null != eN || eJ(e7, e0, eU, ej, e8, e2, e6);
            let eG = e6 && "foreignObject" !== e0.type;
            eN ? eQ(e$.dynamicChildren, eN, e7, e8, e2, eG) : e4 || t6(e$, e0, e7, null, e8, e2, eG), ((eD = ej.onVnodeUpdated) || e9) && sl(() => {
            ...
            for (let e6 = 0; e6 < e0.length; e6++) {
                let e4 = e$[e6],
                    e7 = e0[e6],
                    e5 = e4.type === bl || !Sl(e4, e7) || 6 & e4.shapeFlag || 64 & e4.shapeFlag ? eN(e4.el) : e8;
            ...
            if (e8 !== e2) {
                for (let e5 in e2) {
                    ...
                    let eV = e2[e5],
                        eN = e8[e5];
                    (eV !== eN || e1 && e1(e$, e5)) && e3(e$, e5, eN, eV, e7, e0.children, e6, e4, tj)
                }
                if (e8 !== x)
                    for (let e9 in e8) B(e9) || e9 in e2 || e3(e$, e9, e8[e9], null, e7, e0.children, e6, e4, tj)
            }
            ...
            e9 > 0 && (e5 = !0), null == e$ ? (e8(eV, e2, e3), e8(eN, e2, e3), eX(e0.children, e2, eN, e1, e6, e7, e5)) : e9 > 0 && 64 & e9 && eU && e$.dynamicChildren ? (eQ(e$.dynamicChildren, eU, e2, e1, e6, e7), (null != e0.key || e1 && e0 === e1.subTree) && cl(e$, e0, !0)) : t6(e$, e0, e2, eN, e1, e6, e7, e5)
        }, t0 = (e$, e0, e8, e2, e3, e1, e6, e4) => {
            null == e$ ? 512 & e0.shapeFlag ? e3.ctx.activate(e0, e8, e2, e6, e4) : t8(e0, e8, e2, e3, e1, e6, e4) : t2(e$, e0, e4)
            ...
            let e4 = e$.component = function (e$, e0, e8) {
                ...
                return e1.ctx = {
                    _: e1
                }, e1.root = e0 ? e0.root : e1, e1.emit = $t.bind(null, e1), e1
            }(e$, e2, e3);
            if (jn(e$) && (e4.ctx.renderer = tF), function (e$, e0 = !1) {
                    oa = e0;
                    let {
                        props: e8,
                        children: e2
                    ...
                    on(e$, e8, e3, e0), ((e$, e0) => {
                        if (32 & e$.vnode.shapeFlag) {
                            let e8 = e0._;
                            e8 ? (e$.slots = e0, Q(e0, "_", e8)) : Xn(e0, e$.slots = {})
                        } else e$.slots = {}, e0 && Yn(e$, e0);
                        Q(e$.slots, Tl, 1)
                    })(e$, e2), e3 && function (e$, e0) {
                        let e8 = e$.type;
                        ...
                        if (e2) {
                            let e3 = e$.setupContext = e2.length > 1 ? function (e$) {
                                let e0 = e0 => {
                                    e$.exposed = pt(e0)
                                };
                                return {
            ...
            if (function (e$, e0, e8) {
                    let {
                        ...
                        children: e4,
                        patchFlag: e7
                    } = e0, e5 = e1.emitsOptions;
                    if (e0.dirs || e0.transition) return !0;
                    if (!(e8 && e7 >= 0)) return !(!e3 && !e4 || e4 && e4.$stable) || e2 !== e6 && (e2 ? !e6 || Kt(e2, e6, e5) : !!e6);
                    if (1024 & e7) return !0;
            ...
            e$.update = oe(function () {
                if (e$.isMounted) {
                    let e4, {
                        ...
                        ej = e7;
                    e7 ? (e7.el = eU.el, t1(e$, e7, e6)) : e7 = eU, e5 && Z(e5), (e4 = e7.props && e7.props.onVnodeBeforeUpdate) && il(e4, e9, e7, eU);
                    let eD = Ht(e$),
                        eF = e$.subTree;
                    e$.subTree = eD, ez(eF, eD, eN(eF.el), tD(eF), e$, e3, e1), e7.el = eD.el, null === ej && function ({
                        vnode: e$,
                        parent: e0
                    }, e8) {
                        for (; e0 && e0.subTree === e$;)(e$ = e0.vnode).el = e8, e0 = e0.parent
                    }(e$, eD.el), eV && sl(eV, e3), (e4 = e7.props && e7.props.onVnodeUpdated) && sl(() => {
                        il(e4, e9, e7, eU)
                    }, e3)
                } else {
                    let eB, {
                    ...
                    if (eH && tH ? tH(e0.el, eK, e$, e3) : (ez(null, eK, e8, e2, e$, e3, e1), e0.el = eK.el), eq && sl(eq, e3), eB = eZ && eZ.onVnodeMounted) {
                        let eX = e0;
                        sl(() => {
                            il(eB, eW, eX)
                        }, e3)
                    ...
                    eY && 256 & e0.shapeFlag && sl(eY, e3), e$.isMounted = !0, e0 = e8 = e2 = null
                }
            }, al)
        }, t1 = (e$, e0, e8) => {
            e0.component = e$;
            let e2 = e$.vnode.props;
            e$.vnode = e0, e$.next = null,
                function (e$, e0, e8, e2) {
                    let {
                        props: e3,
                        attrs: e1,
                    ...
                    } = e$, e4 = at(e3), [e7] = e$.propsOptions;
                    if (!(e2 || e6 > 0) || 16 & e6) {
                        let e5;
                        for (let eV in rn(e$, e0, e3, e1), e4) e0 && (R(e0, eV) || (e5 = K(eV)) !== eV && R(e0, e5)) || (e7 ? e8 && (void 0 !== e8[eV] || void 0 !== e8[e5]) && (e3[eV] = cn(e7, e0 || x, eV, void 0, e$)) : delete e3[eV]);
                        if (e1 !== e4)
                    ...
                    if (32 & e8.shapeFlag) {
                        let e6 = e0._;
                        e6 ? 1 === e6 ? e3 = !1 : S(e2, e0) : (e3 = !e0.$stable, Xn(e0, e2)), e1 = e0
                    } else e0 && (Yn(e$, e0), e1 = {
                        default: 1
                    });
                    if (e3)
                        for (let e4 in e2) Wn(e4) || e4 in e1 || delete e2[e4]
                })(e$, e0.children), Vt(void 0, e$.update)
            ...
            8 & eU ? (16 & e5 && tj(e7, e3, e1), eN !== e7 && eV(e8, eN)) : 16 & e5 ? 16 & eU ? t7(e7, eN, e8, e2, e3, e1, e6, e4) : tj(e7, e3, e1, !0) : (8 & e5 && eV(e8, ""), 16 & eU && eX(eN, e8, e2, e3, e1, e6, e4))
            ...
            e7 > e5 ? tj(e$, e3, e1, !0, !1, eV) : eX(e0, e8, e2, e3, e1, e6, e4, eV)
            ...
            if (e7 > eV) {
                if (e7 <= eN) {
                    ...
                    for (; e7 <= eN;) ez(null, e0[e7] = e4 ? Dl(e0[e7]) : Vl(e0[e7]), e8, eB, e3, e1, e6), e7++
                }
            } else if (e7 > eN)
                for (; e7 <= eV;) tV(e$[e7], e3, e1, !0), e7++;
            else {
                let eH = e7,
                    eZ = e7,
                    eG = new Map;
                    ...
                    if (null != t$.key) t0 = eG.get(t$.key);
                        ...
                        for (eW = eZ; eW <= eN; eW++)
                            if (0 === eJ[eW - eZ] && Sl(t$, e0[eW])) {
                                t0 = eW;
                                break
                            } void 0 === t0 ? tV(t$, e3, e1, !0) : (eJ[t0 - eZ] = e7 + 1, t0 >= eQ ? eQ = t0 : eY = !0, ez(t$, e0[t0], e8, null, e3, e1, e6, e4), eK++)
                }
                let t8 = eY ? function (e$) {
                    let e0 = e$.slice(),
                        e8 = [0],
                        e2, e3, e1, e6, e4, e7 = e$.length;
                    for (e2 = 0; e2 < e7; e2++) {
                        let e5 = e$[e2];
                        if (0 !== e5) {
                            ...
                            for (e1 = 0, e6 = e8.length - 1; e1 < e6;) e$[e8[e4 = (e1 + e6) / 2 | 0]] < e5 ? e1 = e4 + 1 : e6 = e4;
                            e5 < e$[e8[e1]] && (e1 > 0 && (e0[e2] = e8[e1 - 1]), e8[e1] = e2)
                        }
                    }
                    for (e6 = e8[(e1 = e8.length) - 1]; e1-- > 0;) e8[e1] = e6, e6 = e0[e6];
                    return e8
                }(eJ) : y;
                for (eW = t8.length - 1, e7 = eX - 1; e7 >= 0; e7--) {
                    ...
                    0 === eJ[e7] ? ez(null, t3, e8, t1, e3, e1, e6) : eY && (eW < 0 || e7 !== t8[eW] ? t5(t3, e8, t1, 2) : eW--)
                }
            }
            ...
            if (2 !== e3 && 1 & eV && e7) {
                if (0 === e3) e7.beforeEnter(e6), e8(e6, e0, e2), sl(() => e7.enter(e6), e1);
                else {
                    let {
                        leave: e9,
                        delayLeave: eU,
                        afterLeave: ej
                    } = e7, eD = () => e8(e6, e0, e2), ez = () => {
                        e9(e6, () => {
                            eD(), ej && ej()
                        })
                    };
            ...
            if (null != e4 && ol(e4, null, e8, null), 256 & eV) return void e0.ctx.deactivate(e$);
            let eU = 1 & eV && e9,
                ej;
            if ((ej = e6 && e6.onVnodeBeforeUnmount) && il(ej, e0, e$), 6 & eV) tU(e$.component, e8, e2);
            else {
                if (128 & eV) return void e$.suspense.unmount(e8, e2);
                eU && Qn(e$, null, e0, "beforeUnmount"), e5 && (e1 !== bl || eN > 0 && 64 & eN) ? tj(e5, e0, e8, !1, !0) : (e1 === bl && (128 & eN || 256 & eN) || !e3 && 16 & eV) && tj(e7, e0, e8), 64 & eV && (e2 || !ul(e$.props)) && e$.type.remove(e$, tF), e2 && tN(e$)
            }((ej = e6 && e6.onVnodeUnmounted) || eU) && sl(() => {
            ...
            e1 && (re(e1), tV(e6, e$, e0, e8)), e4 && sl(e4, e0), sl(() => {
                e$.isUnmounted = !0
            }, e0), e0 && e0.pendingBranch && !e0.isUnmounted && e$.asyncDep && !e$.asyncResolved && e$.suspenseId === e0.pendingId && (e0.deps--, 0 === e0.deps && e0.resolve())
        }, tj = (e$, e0, e8, e2 = !1, e3 = !1, e1 = 0) => {
            for (let e6 = e1; e6 < e$.length; e6++) tV(e$[e6], e0, e8, e2, e3)
        }, tD = e$ => 6 & e$.shapeFlag ? tD(e$.component.subTree) : 128 & e$.shapeFlag ? e$.suspense.next() : e9(e$.anchor || e$.el), tz = (e$, e0) => {
            null == e$ ? e0._vnode && tV(e0._vnode, null, null, !0) : ez(e0._vnode || null, e$, e0), Dt(), e0._vnode = e$
        }, tF = {
            p: ez,
            um: tV,
            m: t5,
...
function cl(e$, e0, e8 = !1) {
    ...
    if (P(e2) && P(e3))
        for (let e1 = 0; e1 < e2.length; e1++) {
            let e6 = e2[e1],
                e4 = e3[e1];
            1 & e4.shapeFlag && !e4.dynamicChildren && ((e4.patchFlag <= 0 || 32 === e4.patchFlag) && ((e4 = e3[e1] = Dl(e3[e1])).el = e6.el), e8 || cl(e6, e4))
        }
}
...
const Tl = "__vInternal",
    ...
    Pl = function (e$, e0 = null, e8 = null, e2 = 0, e3 = null, e1 = !1) {
        ...
        if (e6 = e$, M(e6) && "__vccOpts" in e6 && (e$ = e$.__vccOpts), e0) {
            ...
            eV && !V(eV) && (e0.class = m(eV)), N(eN) && (lt(eN) && !P(eN) && (eN = S({}, eN)), e0.style = u(eN))
        }
        let e9 = V(e$) ? 1 : e$.__isSuspense ? 128 : e$.__isTeleport ? 64 : N(e$) ? 4 : M(e$) ? 2 : 0,
            eU = {
                __v_isVNode: !0,
                __v_skip: !0,
                type: e$,
        ...
        if (Nl(eU, e8), 128 & e9) {
            let {
                ...
                return 32 & e0 ? (e2 = Jt(e8.default), e3 = Jt(e8.fallback)) : (e2 = Jt(e8), e3 = Vl(null)), {
                    content: e2,
                    fallback: e3
                }
            }(eU);
...
function Ll(e$, e0, e8 = !1) {
    ...
    return {
        ...
        props: e4,
        key: e4 && El(e4),
        ref: e0 && e0.ref ? e8 && e3 ? P(e3) ? e3.concat(Rl(e0)) : [e3, Rl(e0)] : Rl(e0) : e3,
        scopeId: e$.scopeId,
        children: e6,
        target: e$.target,
...
function Nl(e$, e0) {
    ...
    if (null == e0) e0 = null;
        ...
        if (1 & e2 || 64 & e2) {
            ...
            e8 = 32;
            let e1 = e0._;
            e1 || Tl in e0 ? 3 === e1 && zt && (1024 & zt.vnode.patchFlag ? (e0._ = 2, e$.patchFlag |= 1024) : e0._ = 1) : e0._ctx = zt
        }
    } else M(e0) ? (e0 = {
        default: e0,
        _ctx: zt
    }, e8 = 32) : (e0 = String(e0), 64 & e2 ? (e8 = 16, e0 = [Il(e0)]) : e8 = 8);
...
function Ul(...e$) {
    ...
    for (let e8 = 1; e8 < e$.length; e8++) {
        let e2 = e$[e8];
        for (let e3 in e2)
            if ("class" === e3) e0.class !== e2.class && (e0.class = m([e0.class, e2.class]));
...
function jl(e$, e0, e8 = !1) {
    let e2 = na || zt;
    if (e2) {
        let e3 = null == e2.parent ? e2.vnode.appContext && e2.vnode.appContext.provides : e2.parent.provides;
...
function zl(e$, e0, e8 = [], e2 = [], e3 = [], e1 = !1) {
    ...
    let {
        ...
        errorCaptured: t8,
        expose: t2
    } = e0, t3 = e$.proxy, t1 = e$.ctx, t6 = e$.appContext.mixins;
    if (e1 && eJ && e$.render === k && (e$.render = eJ), e1 || (Fl = !0, Bl("beforeCreate", "bc", e0, e$, t6), Fl = !1, Gl(e$, t6, e8, e2, e3)), e5 && zl(e$, e5, e8, e2, e3, !0), e7 && Gl(e$, e7, e8, e2, e3), eD) {
        if (P(eD))
            for (let t4 = 0; t4 < eD.length; t4++) {
                ...
                for (let t5 in eD) {
                    let tV = eD[t5];
                    N(tV) ? t1[t5] = jl(tV.from || t5, tV.default, !0) : t1[t5] = jl(tV)
                }
    }
    if (e9)
        for (let tN in e9) {
    ...
    if (e1 ? eV && e8.push(eV) : (e8.length && e8.forEach(e0 => Wl(e$, e0, t3)), eV && Wl(e$, eV, t3)), eN)
        for (let tU in eN) {
            let tj = eN[tU],
                tD = da({
    ...
    if (eU && e2.push(eU), !e1 && e2.length && e2.forEach(e$ => {
            for (let e0 in e$) Kl(e$[e0], t1, t3, e0)
        }), ej && e3.push(ej), !e1 && e3.length && e3.forEach(e$ => {
            let e0 = M(e$) ? e$.call(t3) : e$;
            Reflect.ownKeys(e0).forEach(e$ => {
                $l(e$, e0[e$])
            })
        }), e1 && (ez && S(e$.components || (e$.components = S({}, e$.type.components)), ez), eF && S(e$.directives || (e$.directives = S({}, e$.type.directives)), eF)), e1 || Bl("created", "c", e0, e$, t6), eB && gn(eB.bind(t3)), eH && vn(eH.bind(t3)), eZ && xn(eZ.bind(t3)), eG && yn(eG.bind(t3)), eq && Bn(eq.bind(t3), "a", e6), eW && (e4 = eW.bind(t3), Bn(e4, "da", void 0)), t8 && ((e$, e0 = na) => {
            hn("ec", e$, e0)
        })(t8.bind(t3)), t$ && _n(t$.bind(t3)), t0 && Cn(t0.bind(t3)), eX && kn(eX.bind(t3)), eQ && wn(eQ.bind(t3)), P(t2) && !e1) {
        if (t2.length) {
...
function Kl(e$, e0, e8, e2) {
    let e3 = e2.includes(".") ? function (e$, e0) {
        let e8 = e0.split(".");
        return () => {
            let e0 = e$;
...
function Jl(e$, e0, e8) {
    ...
    for (let e6 in e1 && Jl(e$, e1, e8), e3 && e3.forEach(e0 => Jl(e$, e0, e8)), e0) e2 && R(e2, e6) ? e$[e6] = e2[e6](e$[e6], e0[e6], e8.proxy, e6) : e$[e6] = e0[e6]
}
const Xl = e$ => e$ ? sa(e$) ? e$.exposed ? e$.exposed : e$.proxy : Xl(e$.parent) : null,
    Yl = S(Object.create(null), {
        ...
        $options: e$ => (function (e$) {
            ...
            let e6 = {};
            return e1.forEach(e0 => Jl(e6, e0, e$)), Jl(e6, e0, e$), e0.__merged = e6
        })(e$),
    ...
    Zl = {
        get({
            ...
            if ("$" !== e0[0]) {
                ...
                case 2:
                    ...
                    if ((e5 = e$.propsOptions[0]) && R(e5, e0)) return e6[e0] = 2, e1[e0];
            ...
            let eN = Yl[e0],
                e9, eU;
            return eN ? ("$attrs" === e0 && me(e$, 0, e0), eN(e$)) : (e9 = e4.__cssModules) && (e9 = e9[e0]) ? e9 : e8 !== x && R(e8, e0) ? (e6[e0] = 3, e8[e0]) : R(eU = e7.config.globalProperties, e0) ? eU[e0] : void 0
        },
        set({
            _: e$
        }, e0, e8) {
        ...
        has({
            ...
            let e4;
            return void 0 !== e8[e6] || e$ !== x && R(e$, e6) || e0 !== x && R(e0, e6) || (e4 = e1[0]) && R(e4, e6) || R(e2, e6) || R(Yl, e6) || R(e3.config.globalProperties, e6)
        }
    },
    Ql = S({}, Zl, {
        get(e$, e0) {
...
function ia(e$, e0) {
    let e8 = e$.type;
    e$.render || (e$.render = e8.render || k, e$.render._rc && (e$.withProxy = new Proxy(e$.ctx, Ql))), na = e$, pe(), zl(e$, e8), fe(), na = null
}
...
function da(e$) {
    var e0;
    let e8, e2, e3 = (e0 = e$, M(e0) ? (e8 = e0, e2 = k) : (e8 = e0.get, e2 = e0.set), new mt(e8, e2, M(e0) || !e0.set));
    return ca(e3.effect), e3
}

function pa(e$, e0, e8) {
    let e2 = arguments.length;
    return 2 === e2 ? N(e0) && !P(e0) ? Al(e0) ? Pl(e$, null, [e0]) : Pl(e$, e0) : Pl(e$, null, e0) : (e2 > 3 ? e8 = Array.prototype.slice.call(arguments, 2) : 3 === e2 && Al(e8) && (e8 = [e8]), Pl(e$, e0, e8))
}
...
const xa = {
        ...
        createElement: (e$, e0, e8) => e0 ? ba.createElementNS(ha, e$) : ba.createElement(e$, e8 ? {
            is: e8
        } : void 0),
        ...
        insertStaticContent(e$, e0, e8, e2) {
            let e3 = e2 ? va || (va = ba.createElementNS(ha, "svg")) : ga || (ga = ba.createElement("div"));
            e3.innerHTML = e$;
...
function ka(e$, e0, e8) {
    if (P(e8)) e8.forEach(e8 => ka(e$, e0, e8));
        ...
        ya.test(e8) ? e$.setProperty(K(e2), e8.replace(ya, ""), "important") : e$[e2] = e8
    }
}
...
function Pa(e$, e0, e8, e2, e3 = null) {
    ...
    if (e2 && e6) e6.value = e2;
        ...
        let [e4, e7] = function (e$) {
            ...
            if (La.test(e$)) {
                let e8;
                for (e0 = {}; e8 = e$.match(La);) e$ = e$.slice(0, e$.length - e8[0].length), e0[e8[0].toLowerCase()] = !0
            }
            return [K(e$.slice(2)), e0]
        }(e0);
        e2 ? Ra(e$, e4, e1[e0] = function (e$, e0) {
            let e8 = e$ => {
                Aa() >= e8.attached - 1 && bt(function (e$, e0) {
                    if (P(e0)) {
            ...
            return e8.value = e$, e8.attached = Sa || (Ta.then(Ea), Sa = Aa()), e8
        }(e2, e3), e7) : e6 && (! function (e$, e0, e8, e2) {
            e$.removeEventListener(e0, e8, e2)
        }(e$, e4, e6, e7), e1[e0] = void 0)
    }
}
    ...
    let ez = function (e$) {
        ...
        t$ = e$ => (e0, e2) => {
            let e3 = e$ ? eX : eZ,
                e6 = () => eQ(e0, e$, e2);
            e3 && e3(e0, e6), ja(() => {
                $a(e0, e$ ? e7 : e1), Ua(e0, e$ ? eV : e4), e3 && e3.length > 1 || za(e0, e8, eF, e6)
            })
        };
    return S(ej, {
        onBeforeEnter(e$) {
...
function Ua(e$, e0) {
    e0.split(/\s+/).forEach(e0 => e0 && e$.classList.add(e0)), (e$._vtc || (e$._vtc = new Set)).add(e0)
}
...
function Ba(e$, e0) {
    let e8 = window.getComputedStyle(e$),
        ...
        eN = 0,
        e9 = 0;
    return "transition" === e0 ? e6 > 0 && (eV = "transition", eN = e6, e9 = e1.length) : "animation" === e0 ? e5 > 0 && (eV = "animation", eN = e5, e9 = e7.length) : e9 = (eV = (eN = Math.max(e6, e5)) > 0 ? e6 > e5 ? "transition" : "animation" : null) ? "transition" === eV ? e1.length : e7.length : 0, {
        type: eV,
        timeout: eN,
        propCount: e9,
        hasTransform: "transition" === eV && /\b(transform|all)(,|$)/.test(e8.transitionProperty)
    }
}
            ...
            return yn(() => {
                ...
                if (! function (e$, e0, e8) {
                        ...
                        e$._vtc && e$._vtc.forEach(e$ => {
                            e$.split(/\s+/).forEach(e$ => e$ && e2.classList.remove(e$))
                        }), e8.split(/\s+/).forEach(e$ => e$ && e2.classList.add(e$)), e2.style.display = "none";
                    ...
                    }(e3[0].el, e8.vnode.el, e0)) return;
                e3.forEach(Xa), e3.forEach(Ya);
                let e2 = e3.filter(Za);
                Ga(), e2.forEach(e$ => {
                    let e8 = e$.el,
                        e2 = e8.style;
                    Ua(e8, e0), e2.transform = e2.webkitTransform = e2.transitionDuration = "";
                    let e3 = e8._moveCb = e$ => {
                        e$ && e$.target !== e8 || e$ && !/transform$/.test(e$.propertyName) || (e8.removeEventListener("transitionend", e3), e8._moveCb = null, $a(e8, e0))
                    };
                ...
                if (e3)
                    for (let eN = 0; eN < e3.length; eN++) {
                        let e9 = e3[eN];
                        Un(e9, Vn(e9, e4, e2, e8)), Wa.set(e9, e9.el.getBoundingClientRect())
                    }
...
function Za(e$) {
    ...
    if (e2 || e3) {
        let e1 = e$.el.style;
        return e1.transform = e1.webkitTransform = `translate(${e2}px,${e3}px)`, e1.transitionDuration = "0s", e$
    }
}
const Qa = e$ => {
...
function ts(e$) {
    let e0 = e$.target;
    e0.composing && (e0.composing = !1, function (e$, e0) {
...
const ns = {
        created(e$, {
            ...
            }), e0 || (Ra(e$, "compositionstart", es), Ra(e$, "compositionend", ts), Ra(e$, "change", ts))
        },
        mounted(e$, {
            value: e0
        }) {
        ...
        beforeUpdate(e$, {
            ...
            if (e$._assign = Qa(e3), e$.composing || document.activeElement === e$ && (e8 && e$.value.trim() === e0 || (e2 || "number" === e$.type) && ee(e$.value) === e0)) return;
            let e1 = null == e0 ? "" : e0;
...
function as(e$, {
    ...
    e$._modelValue = e0, P(e0) ? e$.checked = b(e0, e2.props.value) > -1 : I(e0) ? e$.checked = e0.has(e2.props.value) : e0 !== e8 && (e$.checked = h(e0, ss(e$, !0)))
}
...
const os = ["ctrl", "shift", "alt", "meta"],
    ...
    ds = {
        beforeMount(e$, {
            ...
            e$._vod = "none" === e$.style.display ? "" : e$.style.display, e8 && e0 ? e8.beforeEnter(e$) : ps(e$, e0)
        },
        mounted(e$, {
            value: e0
        }, {
        ...
        updated(e$, {
            ...
            !e0 != !e8 && (e2 ? e0 ? (e2.beforeEnter(e$), ps(e$, !0), e2.enter(e$)) : e2.leave(e$, () => {
                ps(e$, !1)
            }) : ps(e$, e0))
        },
        beforeUnmount(e$, {
...
const fs = S({
    patchProp(e$, e0, e8, e2, e3 = !1, e1, e6, e4, e7) {
        ...
        case "class":
            ! function (e$, e0, e8) {
                if (null == e0 && (e0 = ""), e8) e$.setAttribute("class", e0);
                    ...
                    let e2 = e$._vtc;
                    e2 && (e0 = (e0 ? [e0, ...e2] : [...e2]).join(" ")), e$.className = e0
                }
            }(e$, e2, e3);
            break;
        case "style":
        ...
        default:
            var e5, eV, eN, e9;
            _(e0) ? A(e0) || Pa(e$, e0, 0, e2, e6) : (e5 = e$, eV = e0, eN = e2, (e9 = e3) ? "innerHTML" === eV || !!(eV in e5 && Ia.test(eV) && M(eN)) : !("spellcheck" === eV || "draggable" === eV || "form" === eV || "list" === eV && "INPUT" === e5.tagName || "type" === eV && "TEXTAREA" === e5.tagName || Ia.test(eV) && V(eN)) && eV in e5) ? function (e$, e0, e8, e2, e3, e1, e6) {
                if ("innerHTML" === e0 || "textContent" === e0) return e2 && e6(e2, e3, e1), void(e$[e0] = null == e8 ? "" : e8);
                if ("value" !== e0 || "PROGRESS" === e$.tagName) {
                    if ("" === e8 || null == e8) {
                        let e4 = typeof e$[e0];
                        if ("" === e8 && "boolean" === e4) return void(e$[e0] = !0);
                        if (null == e8 && "string" === e4) return e$[e0] = "", void e$.removeAttribute(e0);
                        if ("number" === e4) return e$[e0] = 0, void e$.removeAttribute(e0)
                    }
                    try {
                        e$[e0] = e8
                    } catch (e7) {}
            ...
            }(e$, e0, e2, e1, e6, e4, e7) : ("true-value" === e0 ? e$._trueValue = e2 : "false-value" === e0 && (e$._falseValue = e2), function (e$, e0, e8, e2) {
                if (e2 && e0.startsWith("xlink:")) null == e8 ? e$.removeAttributeNS(_a, e0.slice(6, e0.length)) : e$.setAttributeNS(_a, e0, e8);
                else {
                    let e3 = c(e0);
                    null == e8 || e3 && !1 === e8 ? e$.removeAttribute(e0) : e$.setAttribute(e0, e3 ? "" : e8)
                }
            }(e$, e0, e2, e3))
        }
    },
...
var hs, bs = "object" == typeof Reflect ? Reflect : null,
    gs = bs && "function" == typeof bs.apply ? bs.apply : function (e$, e0, e8) {
...
var ys = xs,
    ks = function (e$, e0) {
        return new Promise(function (e8, e2) {
            ...
            function e7() {
                "function" == typeof e$.removeListener && e$.removeListener("error", e4), e8([].slice.call(arguments))
            }
            Ls(e$, e0, e7, {
                once: !0
            }), "error" !== e0 && (e3 = e$, e1 = e4, e6 = {
                once: !0
...
function As(e$, e0, e8, e2) {
    var e3, e1, e6, e4;
    if (Cs(e8), void 0 === (e1 = e$._events) ? (e1 = e$._events = Object.create(null), e$._eventsCount = 0) : (void 0 !== e1.newListener && (e$.emit("newListener", e0, e8.listener ? e8.listener : e8), e1 = e$._events), e6 = e1[e0]), void 0 === e6) e6 = e1[e0] = e8, ++e$._eventsCount;
    else if ("function" == typeof e6 ? e6 = e1[e0] = e2 ? [e8, e6] : [e6, e8] : e2 ? e6.unshift(e8) : e6.push(e8), (e3 = _s(e$)) > 0 && e6.length > e3 && !e6.warned) {
        e6.warned = !0;
        var e7 = Error("Possible EventEmitter memory leak detected. " + e6.length + " " + String(e0) + " listeners added. Use emitter.setMaxListeners() to increase limit");
        e7.name = "MaxListenersExceededWarning", e7.emitter = e$, e7.type = e0, e7.count = e6.length, e4 = e7, console && console.warn && console.warn(e4)
    }
    return e$
}
...
function Es(e$, e0, e8) {
    ...
    if (void 0 === e2) return [];
    var e3 = e2[e0];
    return void 0 === e3 ? [] : "function" == typeof e3 ? e8 ? [e3.listener || e3] : [e3] : e8 ? function (e$) {
        for (var e0 = Array(e$.length), e8 = 0; e8 < e0.length; ++e8) e0[e8] = e$[e8].listener || e$[e8];
        return e0
    }(e3) : Ps(e3, e3.length)
}
...
Object.defineProperty(xs, "defaultMaxListeners", {
    ...
    for (var e0 = [], e8 = 1; e8 < arguments.length; e8++) e0.push(arguments[e8]);
    var e2 = "error" === e$,
        e3 = this._events;
    ...
    if (e2) {
        ...
        var e1, e6 = Error("Unhandled error." + (e1 ? " (" + e1.message + ")" : ""));
...
}, xs.prototype.on = xs.prototype.addListener, xs.prototype.prependListener = function (e$, e0) {
    ...
    var e8, e2, e3, e1, e6;
    if (Cs(e0), void 0 === (e2 = this._events) || void 0 === (e8 = e2[e$])) return this;
    if (e8 === e0 || e8.listener === e0) 0 == --this._eventsCount ? this._events = Object.create(null) : (delete e2[e$], e2.removeListener && this.emit("removeListener", e$, e8.listener || e0));
        ...
        0 === e3 ? e8.shift() : function (e$, e0) {
            for (; e0 + 1 < e$.length; e0++) e$[e0] = e$[e0 + 1];
            e$.pop()
        }(e8, e3), 1 === e8.length && (e2[e$] = e8[0]), void 0 !== e2.removeListener && this.emit("removeListener", e$, e6 || e0)
    }
    return this
    ...
    if (void 0 === e8.removeListener) return 0 === arguments.length ? (this._events = Object.create(null), this._eventsCount = 0) : void 0 !== e8[e$] && (0 == --this._eventsCount ? this._events = Object.create(null) : delete e8[e$]), this;
    if (0 === arguments.length) {
        var e3, e1 = Object.keys(e8);
        for (e2 = 0; e2 < e1.length; ++e2) "removeListener" !== (e3 = e1[e2]) && this.removeAllListeners(e3);
    ...
    return "function" == typeof e$.listenerCount ? e$.listenerCount(e0) : Rs.call(e$, e0)
...
const Os = ["dom", "seg", "ter", "qua", "qui", "sex", "sab"],
    ...
    Vs = ["Janeiro", "Fevereiro", "Mar\xe7o", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro", ],
...
function Us(e$) {
    ...
    return [
        [e0.getDate(), Vs[e0.getMonth()].substr(0, 3), e0.getFullYear() - 2e3].join(" "), Is(e$),
    ]
}
...
function Bs(e$, e0 = "Voc\xea") {
    var e8;
    return e$ === So.identity.phone ? e0 : (null == (e8 = So.contacts.value.find(e0 => e0.phone === e$)) ? void 0 : e8.name) || e$
}
const Hs = new Proxy({}, {
    get: (e$, e0) => Zs(e0)
});
...
var Gs = Object.freeze(Object.defineProperty({
    ...
    unixToLocale: function (e$) {
        ...
        return `${Os[e0.getDay()]}, ${e0.getDate()} de ${Ms[e0.getMonth()]}, ${Is(e$)}`
    },
    unixToRelative: function (e$) {
        let {
            abs: e0,
            floor: e8
        } = Math, e2 = e0(e$ - e8(Date.now() / 1e3));
        return e2 < 60 ? "Agora" : e2 < 3600 ? e8(e2 / 60) + "min" : e2 < 86400 ? e8(e2 / 3600) + "h" : e8(e2 / 86400) + "d"
    },
    ...
    duration: function (e$) {
        let e0 = e$ >= 3600;
        return new Date(1e3 * e$).toISOString().substr(e0 ? 11 : 14, e0 ? 8 : 5)
    },
    fancyMonths: Vs,
    upperMonths: Ds,
    ...
    vdist: function ([e$, e0, e8], [e2, e3, e1], e6 = !1) {
        return Math.round(Math.sqrt((e$ - e2) ** 2 + (e0 - e3) ** 2 + (e6 ? e8 - e1 : 0) ** 2))
    },
    vdist2: function (...e$) {
        let e0 = this.vdist(...e$);
...
function Ws(e$) {
    ...
    return "string" == typeof e8 ? [null, e8] : [null == e8 ? void 0 : e8.name, null == e8 ? void 0 : e8.icon]
}

function Ks(e$, e0, e8, e2, e3) {
    var e1;
    let [e6, e4] = Ws(e$);
    return null != e3 || (e3 = !(null == (e1 = So.settings.disabledApps) ? void 0 : e1.includes(e$))), {
        entry: e$,
        name: null != e6 ? e6 : e8,
        icon: null != e4 ? e4 : e2,
        to: e0,
...
function Ys() {
    ...
    return Xs = [Ks("settings", "/settings", "", e0("settings.png"), !0), Ks("contacts", "/contacts", "", e0("phone.png"), !0), Ks("sms", "/sms", "", e0("sms.webp"), !0), Ks("gallery", "/gallery", "", e0("photos.webp"), !0), Ks("whatsapp", "/whatsapp", "WhatsApp", e0("whatsapp.jpg")), Ks("tor", "/tor", "TOR", e0("tor.jpg")), Ks("instagram", "/instagram/login", "Instagram", e0("instagram.jpg")), Ks("twitter", "/twitter", "Twitter", e0("twitter.png")), Ks("bank", "/bank", Js[So.settings.bankType.replace(/\d/g, "")], e0(So.settings.bankType.toLowerCase() + ".webp")), Ks("paypal", "/paypal", "PayPal", e0("paypal.webp")), Ks("olx", "/olx", "OLX", e0("olx.png")), Ks("tinder", "/tinder", "Tinder", e0("tinder.webp")), Ks("yellowpages", "/yellowpages", "Yellow Pages", e0("yellowpages.webp")), ...Object.keys(null != (e$ = So.settings.customApps) ? e$ : []).map(e$ => Ks(e$, "/custom/" + e$, Fs(e$), e0("settings.png"))), Ks("weazel", "/weazel", "Weazel News", e0("weazel.png")), Ks("casino", "/casino", "Blaze", e0("blaze.webp")), Ks("calculator", "/calculator", "Calculadora", e0("calculator.webp")), Ks("notes", "/notes", "Anota\xe7\xf5es", e0("notes.png")), Ks("minesweeper", "/minesweeper", "Campo Minado", e0("minesweeper.webp")), Ks("truco", "/truco", "Truco", e0("truco.webp")), ].filter(e$ => null == e$ ? void 0 : e$.enabled).map((e$, e0) => s(s({}, e$), {
        bottom: e0 < 4
    }))
}
...
const Qs = {
    ...
    get facetime() {
        var e8;
        return null != (e8 = Ws("facetime")[1]) ? e8 : So.asset("/apps/facetime.webp")
    }
};
...
var to = {
    async upload(e$, e0) {
        ...
        let e2 = So.settings.uploadServer,
            e3 = new FormData;
        e3.append(e2.includes("discord") ? "file" : "webm" == e0 ? "audio" : "image", e$, Date.now() + "." + e0);
        let e1 = await fetch(e2, {
            method: "POST",
            body: e3
        });
        if (404 == e1.status) throw So.alert("uploadServer inv\xe1lido na config.json, o webhook \xe9 inv\xe1lido ou n\xe3o existe mais"), Error("Invalid uploadServer"); {
    ...
    async uploadVideo(e$) {
        ...
        let e8 = await fetch("http://45.40.99.23/smartphone/storage/upload.v2.php", {
                method: "POST",
                body: e0
            }),
            e2 = await e8.json();
...
class lo {
    ...
    createStuff() {
        if (!this.gl) {
            for (let e$ = 0; e$ < 10; e$ += 1) console.log("Voc\xea est\xe1 bugado! N\xe3o poss\xedvel criar o contexto WebGL, este problema n\xe3o tem corre\xe7\xe3o");
            return
        }
        let e0 = this.gl,
            e8 = function (e$) {
                ...
                return e$.bindTexture(e$.TEXTURE_2D, e0), e$.texImage2D(e$.TEXTURE_2D, 0, e$.RGBA, 1, 1, 0, e$.RGBA, e$.UNSIGNED_BYTE, e8), e$.texParameterf(e$.TEXTURE_2D, e$.TEXTURE_MAG_FILTER, e$.NEAREST), e$.texParameterf(e$.TEXTURE_2D, e$.TEXTURE_MIN_FILTER, e$.NEAREST), e$.texParameterf(e$.TEXTURE_2D, e$.TEXTURE_WRAP_S, e$.CLAMP_TO_EDGE), e$.texParameterf(e$.TEXTURE_2D, e$.TEXTURE_WRAP_T, e$.CLAMP_TO_EDGE), e$.texParameterf(e$.TEXTURE_2D, e$.TEXTURE_WRAP_T, e$.MIRRORED_REPEAT), e$.texParameterf(e$.TEXTURE_2D, e$.TEXTURE_WRAP_T, e$.REPEAT), e$.texParameterf(e$.TEXTURE_2D, e$.TEXTURE_WRAP_T, e$.CLAMP_TO_EDGE), e0
            }(e0),
            {
                program: e2,
                vloc: e3,
                ...
                let e0 = no(e$, e$.VERTEX_SHADER, "\n  attribute vec2 a_position;\n  attribute vec2 a_texcoord;\n  uniform mat3 u_matrix;\n  varying vec2 textureCoordinate;\n  void main() {\n    gl_Position = vec4(a_position, 0.0, 1.0);\n    textureCoordinate = a_texcoord;\n  }\n"),
                    e8 = no(e$, e$.FRAGMENT_SHADER, "\nvarying highp vec2 textureCoordinate;\nuniform sampler2D external_texture;\nvoid main()\n{\n  gl_FragColor = texture2D(external_texture, textureCoordinate);\n}\n"),
                    e2 = e$.createProgram();
                return e$.attachShader(e2, e0), e$.attachShader(e2, e8), e$.linkProgram(e2), e$.useProgram(e2), {
                    program: e2,
            ...
            }(e0),
            {
                ...
                e$.bindBuffer(e$.ARRAY_BUFFER, e0), e$.bufferData(e$.ARRAY_BUFFER, new Float32Array([-1, -1, 1, -1, -1, 1, 1, 1]), e$.STATIC_DRAW);
                let e8 = e$.createBuffer();
                return e$.bindBuffer(e$.ARRAY_BUFFER, e8), e$.bufferData(e$.ARRAY_BUFFER, new Float32Array([0, 0, 1, 0, 0, 1, 1, 1]), e$.STATIC_DRAW), {
                    vertexBuff: e0,
                    texBuff: e8
                }
            }(e0);
        e0.useProgram(e2), e0.bindTexture(e0.TEXTURE_2D, e8), e0.uniform1i(e0.getUniformLocation(e2, "external_texture"), 0), e0.bindBuffer(e0.ARRAY_BUFFER, e6), e0.vertexAttribPointer(e3, 2, e0.FLOAT, !1, 0, 0), e0.enableVertexAttribArray(e3), e0.bindBuffer(e0.ARRAY_BUFFER, e4), e0.vertexAttribPointer(e1, 2, e0.FLOAT, !1, 0, 0), e0.enableVertexAttribArray(e1), e0.viewport(0, 0, e0.canvas.width, e0.canvas.height)
    }
    resize(e$, e0) {
        this.gl && (this.gl.viewport(0, 0, e$, e0), this.gl.canvas.width = e$, this.gl.canvas.height = e0)
    }
    render() {
        var e$;
...
var ro = {
    ...
    createBlob: (e$ = .8, e0 = "image/jpeg") => new Promise(e8 => so.canvas.toBlob(e8, e0, e$)),
    createDataURL: (e$ = .8, e0 = "image/jpeg") => so.canvas.toDataURL(e0, e$),
...
const io = Ze({
    ...
    request(e$ = !1, e0 = "/") {
        ...
        }), this.formats = e$ ? ["selfie"] : ["landscape", "portrait", "selfie"], new Promise((e8, e2) => {
                ...
                if (ro.stop(), So.client.open(), e$) {
                    ...
                    this.ondiscard = () => {
                        ...
                        to.upload(e$, "jpg").then(e$ => {
                            ...
                            e2(e$), console.error("Falha ao realizar upload de imagem", e$.message)
...
function vo(e$) {
    return new Proxy({}, {
        get: (e0, e8) => e0[e8] || (e0[e8] = function (...e0) {
            return new Promise((e2, e3) => {
                fetch("http://smartphone/" + e$, {
                    ...
                    e3(e2), console.error("Rejected: " + e$, e8, JSON.stringify(e0), (null == e2 ? void 0 : e2.message) || e2)
                })
            })
        })
    })
...
const Ao = {
    ...
    addNotification(e$, e0, e8) {
        ...
        let e5 = this.notifications,
            eV = {
                id: (null != (e2 = e5.map(e$ => e$.id).sort((e$, e0) => e0 - e$)[0]) ? e2 : 0) + 1,
                icon: null != (e7 = Qs[e6 = e$]) ? e7 : null == (e4 = Ys().find(e$ => e$.entry == e6)) ? void 0 : e4.icon,
                title: e0,
                subtitle: e8
            };
        if (e5.push(eV), setTimeout(() => {
                let e$ = e5.indexOf(eV); - 1 != e$ && e5.splice(e$, 1)
            }, null != (e1 = null == (e3 = this.settings.notificationSpan) ? void 0 : e3[e$]) ? e1 : 5e3), "phone" != e$) {
            let eN = new Audio(this.settings.notificationSound);
            eN.volume = this.getNotificationVolume() / 100, eN.currentTime = 0, eN.play()
        }
    },
    ...
    setNotificationFor(e$, e0) {
        localStorage.setItem(`smartphone@notification_${e$.toLowerCase()}`, JSON.stringify(!!e0))
    },
    created() {
        ...
        }, this.contacts.value.push(...Array(90).fill(0).map((e$, e0) => ({
            id: e0 + 1,
            name: "Fake " + (e0 + 1),
    ...
    ready() {
        this.pusher.on("ADD_CONTACT", () => this.sortContacts()), this.settings.useGameClock ? this.pusher.on("TIME", e$ => this.clock.value = e$) : setInterval(() => {
            let e$ = new Date,
                e0 = this.clock.value;
            e0.hours = String(e$.getHours()).padStart(2, 0), e0.minutes = String(e$.getMinutes()).padStart(2, 0)
        }, 1e3)
    },
    fetchSettings() {
        let e$ = setInterval(() => {
    ...
    async useAnyImage(e$, e0 = !1) {
        ...
        return 0 === e8 ? await co().request(e0, e$) : 1 === e8 ? await fo() : 2 === e8 ? await this.promptImageURL() : void 0
    },
    alert: null,
    prompt: null,
...
To.render = function (e$, e0, e8, e2, e3, e1) {
    return wl(), _l("div", Eo, [e2.android ? (wl(), _l("div", Ro, [Pl("div", Po, g(e2.content), 1), Pl("div", Lo, [Pl("button", {
        onClick: e0[1] || (e0[1] = e$ => e2.alert()),
        class: "p-2 px-8 rounded-lg font-bold text-blue-600"
    }, "OK"), ]), ])) : (wl(), _l("div", Io, [Pl("div", Oo, g(e2.content), 1), Pl("div", Mo, [Pl("button", {
...
Vo.render = function (e$, e0, e8, e2, e3, e1) {
    return wl(), _l("div", Do, [e2.android ? (wl(), _l("div", No, [Pl("div", Uo, g(e8.title), 1), Pl("div", $o, [Pl("button", {
        onClick: e0[1] || (e0[1] = e$ => e8.callback(!1)),
        class: "p-3 text-blue-600"
    }, "CANCELAR"), Pl("button", {
        onClick: e0[2] || (e0[2] = e$ => e8.callback(!0)),
        class: "p-3 text-blue-600"
    }, "SIM"), ]), ])) : (wl(), _l("div", jo, [Pl("div", Fo, g(e8.title), 1), Pl("div", zo, [Pl("button", {
...
const Bo = {
        ...
        setup() {
            let e$ = rt(),
                e0;
            return So.pusher.on("createCustomConfirm", e8 => {
                e$.value = e8, So.addNotification("bank", "Confirma\xe7\xe3o de cobran\xe7a", "Abra seu celular para confirmar"), clearTimeout(e0), e8.timeout && (e0 = setTimeout(() => {
                    e$.value = null
                }, e8.timeout))
            }), {
                data: e$,
...
Bo.render = function (e$, e0, e8, e2, e3, e1) {
    return wl(), _l("div", {
        ...
        default: en(() => [e2.data ? (wl(), _l("div", Ho, [Pl("div", qo, [Pl("div", {
...
Yo.render = function (e$, e0, e8, e2, e3, e1) {
    return wl(), _l("div", Zo, [e2.android ? (wl(), _l("div", Qo, [Pl("div", er, [Pl("label", tr, g(e8.title), 1), Zn(Pl("input", {
        "onUpdate:modelValue": e0[1] || (e0[1] = e$ => e2.content = e$),
        onKeydown: e0[2] || (e0[2] = us(e$ => e2.submit(), ["enter"])),
        maxlength: e8.max,
        ...
        class: "p-4 font-bold text-blue-600"
    }, "OK"), ]), ])) : (wl(), _l("div", lr, [Pl("div", ar, [Pl("label", null, g(e8.title), 1), Zn(Pl("input", {
        onKeydown: e0[5] || (e0[5] = us(e$ => e2.submit(), ["enter"])),
        maxlength: e8.max,
        class: "text-black p-2 rounded-lg w-full",
        "onUpdate:modelValue": e0[6] || (e0[6] = e$ => e2.content = e$)
    }, null, 40, ["maxlength"]), [
        [ns, e2.content]
    ]), ]), Pl("div", sr, [Pl("button", {
...
const or = {
        setup() {
            let {
                state: e$
            } = go(), e0 = rt(0), e8 = rt(33), e2 = So.settings.isAndroid, e3;
            return Tn(e$.request, e$ => {
                e$ && (e8.value = e$.size, e0.value = 0, clearInterval(e3), e3 = setInterval(() => {
                    e0.value < e8.value ? e0.value += e8.value / 33 : clearInterval(e3)
                }, 10))
            }), {
                req: e$.request,
                res: function (e2) {
                    var e1, e6, e4;
                    (null == (e1 = e$.request.value) ? void 0 : e1.emptyAsError) && null == e2 ? null == (e6 = e$.request.value) || e6.reject(e2) : null == (e4 = e$.request.value) || e4.resolve(e2), clearInterval(e3), e3 = setInterval(() => {
                        e0.value > 0 ? e0.value -= e8.value / 33 : (clearInterval(e3), e$.request.value = null)
                    }, 10)
                },
                height: e0,
                max: e8,
...
an();
const ur = rr((e$, e0, e8, e2, e3, e1) => e2.req ? (wl(), _l("div", {
    key: 0,
    container: "",
    ...
    class: "mb-4"
}, [ir]), Pl("ul", cr, [(wl(!0), _l(bl, null, fa(e2.req.options, (e0, e8) => {
    var e3;
    return wl(), _l("li", {
        key: e8,
        ...
        innerHTML: null != (e3 = e0.html) ? e3 : e$.$filters.safeHTML(e0.display)
...
const dr = {
        setup() {
            ...
            function e6() {
                ...
                e$.width = e4, e$.height = e7, e3.filter = e5, e3.drawImage(e8.value, e1, e6, e4, e7, 0, 0, e4, e7)
            }
            return vn(() => {
                var e2;
                let e3 = e0.value.getContext("2d");
                e3 instanceof CanvasRenderingContext2D && (e2 = e$.original, new Promise(e$ => {
                    let e0 = new Image(1920, 1080);
                    e0.onload = () => e$(e0), e0.src = URL.createObjectURL(e2)
                })).then(e$ => {
                    e3.drawImage(e$, 0, 0, 1920, 1080);
                    let e0 = new Image;
                    e0.onload = () => e8.value = e0, e0.src = e3.canvas.toDataURL("image/jpeg", .8)
                })
            }), Tn(e8, () => {
                e1(e$.formats[0])
            }), {
                ...
                copyWithFilter: function (e$) {
                    ...
                    let {
                        ...
                        width: e1,
                        height: e6
                    } = e2, e4 = document.createElement("canvas"), e7 = e4.getContext("2d");
                    return e4.width = e1, e4.height = e6, e7.filter = e$, e7.drawImage(e8.value, e0, e3, e1, e6, 0, 0, e1, e6), e4.toDataURL("image/jpeg", .8)
                },
                discard: function () {
                    var e0;
                ...
                proceed: function () {
                    e0.value.toBlob(e0 => {
                        var e8;
                        null == (e8 = e$.onproceed) || e8.call(e$, e0), e$.original = null
                    }, "image/jpeg", .8)
                }
            }
        }
...
dr.render = function (e$, e0, e8, e2, e3, e1) {
    return wl(), _l("div", pr, [fr, Pl("canvas", mr, null, 512), Pl("div", hr, [br, Pl("div", gr, [e2.formats.includes("landscape") ? (wl(), _l("button", {
        key: 0,
        onClick: e0[1] || (e0[1] = e$ => e2.crop("landscape")),
        class: "text-blue-500 border rounded-xl border-blue-500 px-4 py-2 flex-1"
    }, " Paisagem ")) : Ml("", !0), e2.formats.includes("portrait") ? (wl(), _l("button", {
        key: 1,
        onClick: e0[2] || (e0[2] = e$ => e2.crop("portrait")),
        class: "ml-4 text-blue-500 border rounded-xl border-blue-500 px-4 py-2 flex-1"
    }, " Retrato ")) : Ml("", !0), e2.formats.includes("selfie") ? (wl(), _l("button", {
        key: 2,
        onClick: e0[3] || (e0[3] = e$ => e2.crop("selfie")),
        class: "ml-4 text-blue-500 border rounded-xl border-blue-500 px-4 py-2 flex-1"
    }, " Selfie ")) : Ml("", !0), ]), ]), Pl("div", vr, [xr, Pl("div", yr, [(wl(!0), _l(bl, null, fa(e2.filters, (e$, e0) => (wl(), _l("div", {
    ...
    }, null, 8, ["src"]), Pl("span", kr, g(e0), 1), ], 8, ["onClick"]))), 128)), ]), ]), Pl("div", wr, [Pl("button", {
        class: "px-4 py-2 border border-red-500 text-red-500 rounded-xl",
        onClick: e0[4] || (e0[4] = (...e$) => e2.discard && e2.discard(...e$))
    }, "Descartar"), Pl("button", {
        class: "px-4 py-2 border border-blue-400 text-blue-400 rounded-xl",
        onClick: e0[5] || (e0[5] = (...e$) => e2.proceed && e2.proceed(...e$))
    }, "Salvar"), ]), ])
};
const Cr = {
        props: ["callback"],
        ...
        setup(e$) {
            ...
            let e1, e6, e4, e7 = new lo(e3);

            function e5() {
                e1 = setInterval(() => e8.value += 1, 1e3), e2.value = !0, e8.value = 0;
                let e$ = [e0.value.captureStream(24), So.microphone.value];
                (e6 = new MediaRecorder(new MediaStream(e$.map(e$ => null == e$ ? void 0 : e$.getTracks()).filter(e$ => e$).flat()), {
                    videoBitsPerSecond: 2e6
                })).start(), e0.value.toBlob(e$ => e4 = e$, "image/jpeg", .8)
            }

            function eV() {
                clearInterval(e1), e2.value = !1, e6.ondataavailable = e0 => {
                    e4 && to.uploadVideo(e0.data).then(e$ => [e$, e4]).then(...e$.callback)
                }, e6.stop()
            }
            ...
            return vn(() => {
                e7.onrender = e$ => {
                    let e8 = e0.value;
                    e8.getContext("2d").drawImage(e$, 360, 0, e$.width - 720, e$.height, 0, 0, e8.width, e8.height)
                }
            }), So.client.SetInVideoCall(!0), window.addEventListener("keydown", eN), {
                video: e0,
                duration: e8,
                recording: e2,
                view: e7,
...
an();
const Or = _r((e$, e0, e8, e2, e3, e1) => (wl(), _l("div", Ar, [Sr, Pl("div", Tr, [e2.recording ? (wl(), _l(bl, {
    key: 0
}, [Er, Pl("span", Rr, g(e$.$filters.duration(e2.duration)), 1)], 64)) : Ml("", !0), ]), Pl("canvas", Pr, null, 512), Pl("div", Lr, [e2.recording ? (wl(), _l("button", {
    key: 1,
    onClick: e0[2] || (e0[2] = (...e$) => e2.stop && e2.stop(...e$)),
    class: "absolute mx-auto w-24 h-24 bg-gray-300 rounded-full flex flex-center"
}, [Ir])) : (wl(), _l("button", {
    key: 0,
    onClick: e0[1] || (e0[1] = (...e$) => e2.start && e2.start(...e$)),
...
function Gr(e$, e0, e8 = "/") {
    ...
    return e4 > -1 && (e2 = e0.slice(0, e4), e3 = e$(e1 = e0.slice(e4 + 1, e7 > -1 ? e7 : e0.length))), e7 > -1 && (e2 = e2 || e0.slice(0, e7), e6 = e0.slice(e7, e0.length)), {
        fullPath: (e2 = function (e$, e0) {
            if (e$.startsWith("/")) return e$;
            if (!e$) return e0;
            let e8 = e0.split("/"),
                e2 = e$.split("/"),
                e3, e1, e6 = e8.length - 1;
            for (e3 = 0; e3 < e2.length; e3++)
                if (e1 = e2[e3], 1 !== e6 && "." !== e1) {
                    if (".." !== e1) break;
                    e6--
                } return e8.slice(0, e6).join("/") + "/" + e2.slice(e3 - (e3 === e2.length ? 1 : 0)).join("/")
        }(null != e2 ? e2 : e0, e8)) + (e1 && "?") + e1 + e6,
        path: e2,
        query: e3,
        hash: e6
    }
...
function Wr(e$, e0) {
    return !e0 || e$.toLowerCase().indexOf(e0.toLowerCase()) ? e$ : e$.slice(e0.length) || "/"
}
...
function Jr(e$, e0) {
    ...
    for (let e8 in e$)
        if (!Xr(e$[e8], e0[e8])) return !1;
    return !0
}

function Xr(e$, e0) {
    return Array.isArray(e$) ? Yr(e$, e0) : Array.isArray(e0) ? Yr(e0, e$) : e$ === e0
}

function Yr(e$, e0) {
    return Array.isArray(e0) ? e$.length === e0.length && e$.every((e$, e8) => e$ === e0[e8]) : 1 === e$.length && e$[0] === e0
}
...
function ni(e$) {
    if (!e$) {
        if (Fr) {
            ...
            e$ = (e$ = e0 && e0.getAttribute("href") || "/").replace(/^\w+:\/\/[^\/]+/, "")
        } else e$ = "/"
    }
...
function oi(e$) {
    ...
    if ("el" in e$) {
        let e8 = e$.el,
            ...
            e3 = "string" == typeof e8 ? e2 ? document.getElementById(e8.slice(1)) : document.querySelector(e8) : e8;
        if (!e3) return;
        e0 = function (e$, e0) {
    ...
    "scrollBehavior" in document.documentElement.style ? window.scrollTo(e0) : window.scrollTo(null != e0.left ? e0.left : window.pageXOffset, null != e0.top ? e0.top : window.pageYOffset)
}
...
function di(e$) {
    ...
    function e1(e2, e1, e6) {
        let e4 = e$.indexOf("#"),
            e7 = e4 > -1 ? (e8.host && document.querySelector("base") ? e$ : e$.slice(e4)) + e2 : location.protocol + "//" + location.host + e$ + e2;
        try {
    ...
    return e3.value || e1(e2.value, {
        ...
        push: function (e$, e8) {
            ...
            e1(e6.current, e6, !0), e1(e$, zr({}, ui(e2.value, e$, null), {
                position: e6.position + 1
            }, e8), !1), e2.value = e$
        },
        replace: function (e$, e8) {
            e1(e$, zr({}, e0.state, ui(e3.value.back, e$, e3.value.forward, !0), e8, {
...
function pi(e$) {
    let e0 = di(e$ = ni(e$)),
        e8 = function (e$, e0, e8, e2) {
            let e3 = [],
                ...
                e4 = ({
                    ...
                    let e4 = ci(e$, location),
                        ...
                        eV = 0;
                    if (e1) {
                        if (e8.value = e4, e0.value = e1, e6 && e6 === e7) return void(e6 = null);
            ...
            return window.addEventListener("popstate", e4), window.addEventListener("beforeunload", e7), {
                ...
                destroy: function () {
                    for (let e$ of e1) e$();
                    e1 = [], window.removeEventListener("popstate", e4), window.removeEventListener("beforeunload", e7)
                }
            }
    ...
    return Object.defineProperty(e2, "location", {
...
function wi(e$, e0) {
    ...
    return e$.length < e0.length ? 1 === e$.length && 80 === e$[0] ? -1 : 1 : e$.length > e0.length ? 1 === e0.length && 80 === e0[0] ? 1 : -1 : 0
}
...
function Si(e$, e0, e8) {
    let e2 = function (e$, e0) {
            ...
            for (let e6 of e$) {
                ...
                for (let e7 = 0; e7 < e6.length; e7++) {
                    let e5 = e6[e7],
                        eV = 40 + (e8.sensitive ? .25 : 0);
                    if (0 === e5.type) e7 || (e3 += "/"), e3 += e5.value.replace(ki, "\\$&"), eV += 40;
                    else if (1 === e5.type) {
                        let {
                            value: eN,
                            repeatable: e9,
                        ...
                        if ("[^/]+?" !== eD) {
                            ...
                            try {
                                ...
                                throw Error(`Invalid custom RegExp for param "${eN}" (${eD}): ` + ez.message)
                            }
                        }
                        let eF = e9 ? `((?:${eD})(?:/(?:${eD}))*)` : `(${eD})`;
                        e7 || (eF = eU && e6.length < 2 ? `(?:/${eF})` : "/" + eF), eU && (eF += "?"), e3 += eF, eV += 20, eU && (eV += -8), e9 && (eV += -20), ".*" === eD && (eV += -50)
                    }
                    e4.push(eV)
                }
                e2.push(e4)
            ...
            if (e8.strict && e8.end) {
                let eB = e2.length - 1;
                e2[eB][e2[eB].length - 1] += .7000000000000001
            }
            e8.strict || (e3 += "/?"), e8.end ? e3 += "$" : e8.strict && (e3 += "(?:/|$)");
            ...
            return {
                ...
                stringify: function (e0) {
                    let e8 = "",
                        e2 = !1;
                    for (let e3 of e$)
                        for (let e1 of (e2 && e8.endsWith("/") || (e8 += "/"), e2 = !1, e3))
                        ...
                        let {
                            ...
                            repeatable: e4,
                            optional: e7
                        } = e1, e5 = e6 in e0 ? e0[e6] : "";
                        if (Array.isArray(e5) && !e4) throw Error(`Provided param "${e6}" is an array but it is not repeatable (* or + modifiers)`);
                        let eV = Array.isArray(e5) ? e5.join("/") : e5;
                        if (!eV) {
                            if (!e7) throw Error(`Missing required param "${e6}"`);
                            e3.length < 2 && (e8.endsWith("/") ? e8 = e8.slice(0, -1) : e2 = !0)
                        }
                        e8 += eV
                    }
                    return e8
            ...
            function eN() {
                e5 && (0 === e8 ? e1.push({
                    type: 0,
                    value: e5
                }) : 1 === e8 || 2 === e8 || 3 === e8 ? (e1.length > 1 && ("*" === e4 || "+" === e4) && e0(`A repeatable param (${e5}) must be alone in its segment. eg: '/:ids+.`), e1.push({
                    type: 1,
                    value: e5,
                    regexp: eV,
                    repeatable: "*" === e4 || "+" === e4,
                    optional: "*" === e4 || "?" === e4
                })) : e0("Invalid state to consume buffer"), e5 = "")
            }
            ...
            for (; e7 < e$.length;)
                if ("\\" !== (e4 = e$[e7++]) || 2 === e8) switch (e8) {
                case 0:
                    "/" === e4 ? (e5 && eN(), e6()) : ":" === e4 ? (eN(), e8 = 1) : e9();
                    break;
                case 4:
                    e9(), e8 = e2;
                    break;
                case 1:
                    "(" === e4 ? e8 = 2 : Ai.test(e4) ? e9() : (eN(), e8 = 0, "*" !== e4 && "?" !== e4 && "+" !== e4 && e7--);
                    break;
                case 2:
                    ")" === e4 ? "\\" == eV[eV.length - 1] ? eV = eV.slice(0, -1) + e4 : e8 = 3 : eV += e4;
                    break;
                case 3:
                    eN(), e8 = 0, "*" !== e4 && "?" !== e4 && "+" !== e4 && e7--, eV = "";
                    break;
                default:
                    e0("Unknown state")
                } else e2 = e8, e8 = 4;
            return 2 === e8 && e0(`Unfinished custom RegExp for param "${e5}"`), eN(), e6(), e3
        }(e$.path), e8),
        e3 = zr(e2, {
            record: e$,
            parent: e0,
    ...
    return e0 && !e3.record.aliasOf == !e0.record.aliasOf && e0.children.push(e3), e3
}
...
function Ti(e$, e0) {
    ...
    function e3(e$, e8, e2) {
        ...
        let e7 = !e2,
            e5 = {
                ...
                enterCallbacks: {},
                components: "components" in e4 ? e4.components || {} : {
        ...
        if ("alias" in e$) {
            ...
            for (let eU of e9) eN.push(zr({}, e5, {
        ...
        for (let ez of eN) {
            ...
            if (ej = Si(ez, e8, eV), e2 ? e2.alias.push(ej) : ((eD = eD || ej) !== ej && eD.alias.push(ej), e7 && e$.name && !Ri(ej) && e1(e$.name)), "children" in e5) {
                let eZ = e5.children;
                for (let eG = 0; eG < eZ.length; eG++) e3(eZ[eG], ej, e2 && e2.children[eG])
            }
            e2 = e2 || ej, e6(ej)
        }
        return eD ? () => {
    ...
    function e1(e$) {
        if (fi(e$)) {
            let e0 = e2.get(e$);
            e0 && (e2.delete(e$), e8.splice(e8.indexOf(e0), 1), e0.children.forEach(e1), e0.alias.forEach(e1))
        } else {
            let e3 = e8.indexOf(e$);
            e3 > -1 && (e8.splice(e3, 1), e$.record.name && e2.delete(e$.record.name), e$.children.forEach(e1), e$.alias.forEach(e1))
        }
    }
    ...
    function e6(e$) {
        ...
        e8.splice(e0, 0, e$), e$.record.name && !Ri(e$) && e2.set(e$.record.name, e$)
    }
    return e0 = Li({
        strict: !1,
        end: !0,
        ...
        resolve: function (e$, e0) {
            let e3, e1, e6, e4 = {};
            if ("name" in e$ && e$.name) {
                if (!(e3 = e2.get(e$.name))) throw vi(1, {
                    location: e$
                });
                e6 = e3.record.name, e4 = zr(function (e$, e0) {
                    let e8 = {};
                    for (let e2 of e0) e2 in e$ && (e8[e2] = e$[e2]);
                    return e8
                }(e0.params, e3.keys.filter(e$ => !e$.optional).map(e$ => e$.name)), e$.params), e1 = e3.stringify(e4)
            } else if ("path" in e$) e1 = e$.path, (e3 = e8.find(e$ => e$.re.test(e1))) && (e4 = e3.parse(e1), e6 = e3.record.name);
            else {
                if (!(e3 = e0.name ? e2.get(e0.name) : e8.find(e$ => e$.re.test(e0.path)))) throw vi(1, {
                    location: e$,
                    currentLocation: e0
                });
                e6 = e3.record.name, e4 = zr({}, e0.params, e$.params), e1 = e3.stringify(e4)
            }
            let e7 = [],
                e5 = e3;
...
function Ki(e$) {
    var e0;
    return Gi(e0 = e$).replace(Ii, "%23").replace(Di, "%3F").replace(Mi, "%2F")
}
...
function Yi(e$) {
    ...
    for (let e8 in e$) {
        ...
        for (let e1 = 0; e1 < e3.length; e1++) e0 += (e1 ? "&" : "") + e8, null != e3[e1] && (e0 += "=" + e3[e1])
    }
    return e0
}
...
function Zi(e$) {
    ...
    for (let e8 in e$) {
        let e2 = e$[e8];
        void 0 !== e2 && (e0[e8] = Array.isArray(e2) ? e2.map(e$ => null == e$ ? null : "" + e$) : null == e2 ? e2 : "" + e2)
    }
    return e0
}
...
function ec(e$, e0, e8, e2, e3) {
    ...
    return () => new Promise((e6, e4) => {
        let e7 = e$ => {
                var e7;
                !1 === e$ ? e4(vi(4, {
                    from: e8,
                    to: e0
                })) : e$ instanceof Error ? e4(e$) : "string" == typeof (e7 = e$) || e7 && "object" == typeof e7 ? e4(vi(2, {
                    from: e0,
                    to: e$
                })) : (e1 && e2.enterCallbacks[e3] === e1 && "function" == typeof e$ && e1.push(e$), e6())
            },
    ...
    for (let e6 of e$)
        for (let e4 in e6.components) {
            ...
            if ("beforeRouteEnter" === e0 || e6.instances[e4]) {
                if ("object" == typeof (e3 = e7) || "displayName" in e3 || "props" in e3 || "__vccOpts" in e3) {
                    let e5 = (e7.__vccOpts || e7)[e0];
                    e5 && e1.push(ec(e5, e8, e2, e6, e4))
                } else {
                    let eV = e7();
                    eV = eV.catch(console.error), e1.push(() => eV.then(e$ => {
                        var e3;
                        if (!e$) return Promise.reject(Error(`Couldn't resolve component "${e4}" at "${e6.path}"`));
                        let e1 = (e3 = e$).__esModule || Mr && "Module" === e3[Symbol.toStringTag] ? e$.default : e$;
                        e6.components[e4] = e1;
    ...
    let e0 = jl(Ur),
        ...
        e3 = da(() => {
            let {
                ...
                length: e0
            } = e$, e3 = e$[e0 - 1], e1 = e8.matched;
            if (!e3 || !e1.length) return -1;
            let e6 = e1.findIndex(Kr.bind(null, e3));
            if (e6 > -1) return e6;
            let e4 = ac(e$[e0 - 2]);
            return e0 > 1 && ac(e3) === e4 && e1[e1.length - 1].path !== e4 ? e1.findIndex(Kr.bind(null, e$[e0 - 2])) : e6
        }),
        e1 = da(() => e3.value > -1 && function (e$, e0) {
            for (let e8 in e0) {
                let e2 = e0[e8],
                    e3 = e$[e8];
                if ("string" == typeof e2) {
                    if (e2 !== e3) return !1
                } else if (!Array.isArray(e3) || e3.length !== e2.length || e2.some((e$, e0) => e$ !== e3[e0])) return !1
            }
            return !0
        }(e8.params, e2.value.params)),
        e6 = da(() => e3.value > -1 && e3.value === e8.matched.length - 1 && Jr(e8.params, e2.value.params));
    return {
        route: e2,
        ...
        navigate: function (e8 = {}) {
            ...
            }(e8) ? Promise.resolve() : e0[ut(e$.replace) ? "replace" : "push"](ut(e$.to))
        }
    }
}
const lc = ll({
    ...
    setup(e$, {
        ...
        let e2 = Ze(nc(e$)),
            ...
            e1 = da(() => ({
                [sc(e$.activeClass, e3.linkActiveClass, "router-link-active")]: e2.isActive,
                [sc(e$.exactActiveClass, e3.linkExactActiveClass, "router-link-exact-active")]: e2.isExactActive
            }));
        return () => {
            let e3 = e0.default && e0.default(e2);
            return e$.custom ? e3 : pa("a", zr({
...
const rc = ll({
    ...
    setup(e$, {
        ...
        let e4 = rt();
        return Tn(() => [e4.value, e6.value, e$.name], ([e$, e0, e8], [e2, e3, e1]) => {
            e0 && (e0.instances[e8] = e$, e3 && e3 !== e0 && e$ && e$ === e2 && (e0.leaveGuards.size || (e0.leaveGuards = e3.leaveGuards), e0.updateGuards.size || (e0.updateGuards = e3.updateGuards))), !e$ || !e0 || e3 && Kr(e0, e3) && e2 || (e0.enterCallbacks[e8] || []).forEach(e0 => e0(e$))
        }, {
            flush: "post"
        }), () => {
            let e2 = e3.value,
                ...
                e5 = e$.name;
            if (!e7) return oc(e8.default, {
                Component: e7,
                route: e2
            });
            let eV = e1.props[e$.name],
                eN = eV ? !0 === eV ? e2.params : "function" == typeof eV ? eV(e2) : eV : null,
                e9 = pa(e7, zr({}, eN, e0, {
                    onVnodeUnmounted(e$) {
...
const pc = new lo(dc);
pc.running = !1, So.pusher.on("REQUEST_SCREENSHOT", (e$, e0, e8 = "image/jpeg", e2 = .9) => {
    pc.running = !0, pc.onrender = function (e3) {
        this.running = !1, e3.toBlob(e2 => {
            let e3 = new FormData;
            e3.append(e0, e2, "image." + e8.split("/")[1].replace("jpeg", "jpg")), fetch(e$, {
                method: "POST",
                body: e3
            }).catch(() => {})
        }, e8, e2)
...
const fc = {
        setup() {
            let e$ = cc(),
                e0 = setInterval(() => {
                    So.identity.phone && (clearInterval(e0), e$.replace("/home"), So.ready())
                }, 500)
        }
    },
...
an();
const Ac = yc((e$, e0, e8, e2, e3, e1) => (wl(), _l("div", {
...
}, [e2.settings.isAndroid ? (wl(), _l("div", kc, [Pl("p", null, g(e2.clock.hours), 1), Pl("p", null, g(e2.clock.minutes), 1), Pl("p", wc, g(e2.fancyDate), 1), ])) : Ml("", !0), Pl("div", {
    class: ["p-5 grid grid-cols-4 gap-0 absolute inset-x-4", {
        "bottom-48": e2.settings.isAndroid
    }, ]
}, [(wl(!0), _l(bl, null, fa(e2.top, e0 => (wl(), _l("div", {
    key: e0.name,
    app: "",
    ...
    src: e0.icon,
    alt: ""
}, null, 8, ["src"]), Pl("span", Cc, g(e0.name), 1), ], 8, ["onClick"]))), 128)), ], 2), Pl("div", {
    class: ["absolute bottom-4 inset-x-3 h-36", {
        "bottom-apps": !e2.settings.isAndroid
    }, ]
}, [Pl("div", _c, [(wl(!0), _l(bl, null, fa(e2.bottom, e0 => (wl(), _l("div", {
    key: e0.name,
    app: "",
    onClick: e8 => e$.$router.push(e0.to),
    ...
    Ec = {
        setup() {
            ...
            let {
                ...
                identity: e4,
                settings: e7
            } = So, e5 = Object.fromEntries([75, 80, 90, 100, 110, 120, 125, 133, 150, 166, 175, 200, 225, 233, 250, ].map(e$ => [e$, e$ + "%"])), {
                volume: eV,
                doNotDisturb: eN,
                darkTheme: e9,
                anonymousCall: eU
            ...
            Tn(eF, e$ => {
                So.backgroundURL = e$, e$ === e7.backgroundURL ? localStorage.removeItem("smartphone@background") : localStorage.setItem("smartphone@background", e$)
            });
            let eB = So.settings.forceBackground,
                eH = rt(So.backgroundURL === e7.backgroundURL ? "default" : null != (e0 = (e8 = So.backgroundURL, null == (e2 = Object.entries(Sc).find(e$ => e$[1].url === e8)) ? void 0 : e2[0])) ? e0 : "custom");
            return Tn(eH, e$ => {
                var e0;
                eF.value = "default" === e$ ? e7.backgroundURL || So.backgroundURL : "custom" !== e$ ? null == (e0 = Sc[e$]) ? void 0 : e0.url : "Link da imagem"
            }), Tn(e9, e$ => e3(e$)), Tn(() => e7.zoom, e$ => {
                ...
                reset: function () {
                    eV.value = 50, eN.value = !1, localStorage.setItem("smartphone@zoom", "100"), e7.zoom = 100, So.updateZoom()
                },
                zoomOptions: e5,
                storage: e6,
                volume: eV,
...
Ec.render = function (e$, e0, e8, e2, e3, e1) {
    ...
    return wl(), _l("div", Rc, [Pl("div", Pc, [Pl("button", {
    ...
    }, [e2.settings.isAndroid ? (wl(), _l("i", Lc)) : (wl(), _l("i", Ic))]), Pl("h1", {
        class: ["font-bold", [e2.settings.isAndroid ? "ml-16" : "text-center"], ]
    }, "Configura\xe7\xf5es", 2), ]), Pl("div", Oc, [Pl("div", {
        class: ["p-5 shadow-lg rounded-2xl flex", [e2.darkTheme ? "bg-gray-900" : "bg-gray-200"], ]
    }, [Mc, Pl("div", Vc, [Pl("h1", null, g(e2.identity.name + " " + e2.identity.firstname), 1), Pl("h1", null, g(e2.identity.phone), 1), ]), ], 2), e2.forceBackground ? Ml("", !0) : (wl(), _l("div", Dc, [Nc, Pl(e6, {
        options: e2.WallpapersOptions,
        class: "text-3xl bg-theme border-theme",
        modelValue: e2.backgroundType,
        "onUpdate:modelValue": e0[2] || (e0[2] = e$ => e2.backgroundType = e$)
    }, null, 8, ["options", "modelValue"]), ])), "custom" === e2.backgroundType ? (wl(), _l("div", Uc, [$c, Pl(e4, {
        class: "text-3xl bg-theme border-theme",
        modelValue: e2.backgroundURL,
        "onUpdate:modelValue": e0[3] || (e0[3] = e$ => e2.backgroundURL = e$)
    }, null, 8, ["modelValue"]), ])) : Ml("", !0), Pl("div", jc, [Fc, Pl(e6, {
        class: "text-3xl bg-theme border-theme",
        modelValue: e2.settings.zoom,
        "onUpdate:modelValue": e0[4] || (e0[4] = e$ => e2.settings.zoom = e$),
        options: e2.zoomOptions
    }, null, 8, ["modelValue", "options"]), ]), Pl("div", zc, [Bc, Zn(Pl("input", {
        "onUpdate:modelValue": e0[5] || (e0[5] = e$ => e2.volume = e$),
        type: "range",
        min: "0",
        max: "100",
        class: "block w-full"
        ...
        [ns, e2.volume]
    ]), ]), Hc, Pl("div", qc, [Gc, Pl(e7, {
        modelValue: e2.darkTheme,
        "onUpdate:modelValue": e0[6] || (e0[6] = e$ => e2.darkTheme = e$)
    }, null, 8, ["modelValue"]), ]), Pl("div", Wc, [Kc, Pl(e7, {
        modelValue: e2.doNotDisturb,
        "onUpdate:modelValue": e0[7] || (e0[7] = e$ => e2.doNotDisturb = e$)
    }, null, 8, ["modelValue"]), ]), Pl("div", Jc, [Xc, Pl(e7, {
        modelValue: e2.anonymousCall,
        "onUpdate:modelValue": e0[8] || (e0[8] = e$ => e2.anonymousCall = e$)
    }, null, 8, ["modelValue"]), ]), Pl("button", {
        class: "absolute bottom-8 text-red-500",
        onClick: e0[9] || (e0[9] = (...e$) => e2.reset && e2.reset(...e$))
    }, " Restaurar configura\xe7\xf5es "), e2.microphone ? Ml("", !0) : (wl(), _l("button", {
        key: 2,
        class: "absolute bottom-8 right-8 text-red-500",
        onClick: e0[10] || (e0[10] = (...e$) => e2.askForMicrophone && e2.askForMicrophone(...e$))
    }, [Yc])), ]), ])
};
const Zc = {
        props: {
...
Zc.render = function (e$, e0, e8, e2, e3, e1) {
    return wl(), _l("div", Qc, [Pl("span", eu, g(e8.name), 1), Zt(e$.$slots, "default")])
};
const tu = {
        setup: () => ({
            hasServices: da(() => {
...
tu.render = function (e$, e0, e8, e2, e3, e1) {
    ...
    }, [lu, au], 2), e2.hasServices ? (wl(), _l("button", {
        key: 0,
        class: ["text-center p-5", {
            "text-blue-500": "/contacts/services" == e$.$route.path
        }, ],
        onClick: e0[2] || (e0[2] = e0 => e$.$router.replace("/contacts/services"))
    }, [su, ou], 2)) : Ml("", !0), Pl("button", {
        class: ["text-center p-5", {
            "text-blue-500": "/contacts/dial" == e$.$route.path
        }, ],
        onClick: e0[3] || (e0[3] = e0 => e$.$router.replace("/contacts/dial"))
    }, [ru, iu], 2), Pl("button", {
        class: ["text-center p-5", {
            "text-blue-500": "/contacts/history" == e$.$route.path
        }, ],
        onClick: e0[4] || (e0[4] = e0 => e$.$router.replace("/contacts/history"))
    }, [cu, uu], 2), Pl("button", {
        class: ["text-center p-5", {
            "text-blue-500": "/contacts/blocks" == e$.$route.path
        }, ],
        onClick: e0[5] || (e0[5] = e0 => e$.$router.replace("/contacts/blocks"))
    }, [du, pu], 2), ])
};
const fu = {
        components: {
        ...
        setup() {
            ...
            let e$ = rt("main"),
                ...
                e3 = da(() => So.contacts.value.filter(e$ => !e0.value || e$.name.toLowerCase().includes(e0.value.toLowerCase()) || e$.phone.includes(e0.value)).map(e$ => (e$.blocked = So.settings.blocks.includes(e$.phone), e$)));
            return {
                query: e0,
                myPhone: e8,
                view: e$,
                ...
                removeContact: function (e$) {
                    So.backend.removeContact(e$.id), So.contacts.value = So.contacts.value.filter(e0 => e0.id != e$.id)
                },
...
fu.render = function (e$, e0, e8, e2, e3, e1) {
    let e6 = dl("Header"),
        e4 = dl("Footer");
    return wl(), _l("div", mu, [Pl(e6, null, {
        default: en(() => [Pl("button", {
            onClick: e0[1] || (e0[1] = e0 => e$.$router.push("/contacts/create")),
        ...
        [ns, e2.query]
    ]), ]), Pl("div", gu, [Pl("ul", null, [(wl(!0), _l(bl, null, fa(e2.contacts, e0 => (wl(), _l("li", {
        key: e0.id,
        class: "flex mt-3 border-b border-theme last:border-b-0"
    }, [Pl("div", vu, [Pl("div", xu, [Pl("h2", yu, g(e0.name), 1), Pl("h3", ku, g(e0.phone), 1), ]), Pl("button", {
        onClick: e8 => e$.$router.push("/whatsapp/" + e0.phone)
    }, [wu], 8, ["onClick"]), Pl("button", {
        onClick: e$ => e2.createCall(e0)
    }, [Cu], 8, ["onClick"]), e2.supportsVideoCall ? (wl(), _l("button", {
        key: 0,
        onClick: e$ => e2.createCall(e0, !0)
    }, [_u], 8, ["onClick"])) : Ml("", !0), Pl("button", {
        onClick: e8 => e$.$router.push("/contacts/" + e0.id)
    }, [Au], 8, ["onClick"]), e0.blocked ? Ml("", !0) : (wl(), _l("button", {
        key: 1,
        onClick: e$ => e2.blockContact(e0)
    }, [Su], 8, ["onClick"])), Pl("button", {
        onClick: e$ => e2.removeContact(e0)
    }, [Tu], 8, ["onClick"]), ]), ]))), 128)), ]), ]), Pl(e4), ])
};
const Eu = {
        components: {
            Header: Zc
        ...
        setup() {
            ...
            return {
                contact: e8,
                save: function () {
                    return e8.phone === So.identity.phone ? e0("Voc\xea n\xe3o pode adicionar a si mesmo") : e8.phone ? e8.name ? void So.backend.addContact(e8.phone, e8.name).then(e8 => {
                        e8 instanceof Object ? (So.contacts.value.push(e8), e$.back(), So.pusher.emit("ADD_CONTACT", e8)) : e0("Este telefone n\xe3o existe!")
                    }) : e0("Preencha o nome do contato") : e0("Preencha o n\xfamero de telefone")
                }
            }
        }
    },
...
Eu.render = function (e$, e0, e8, e2, e3, e1) {
    let e6 = dl("Header");
    return wl(), _l("div", Ru, [Pl(e6, null, {
        default: en(() => [Pl("button", {
        ...
        type: "text",
        "onUpdate:modelValue": e0[2] || (e0[2] = e$ => e2.contact.name = e$),
        maxlength: "128",
        ...
        type: "text",
        "onUpdate:modelValue": e0[3] || (e0[3] = e$ => e2.contact.phone = e$),
        maxlength: "12",
        class: "w-full p-3 rounded-lg bg-theme border border-theme focus:border-blue-400"
    }, null, 512), [
        [ns, e2.contact.phone]
...
const Vu = {
        ...
        setup() {
            ...
            return Object.assign(e2, e3), e3 || e$.back(), {
                contact: e2,
                save: function () {
                    return e2.phone === So.identity.phone ? e8("Voc\xea n\xe3o pode adicionar a si mesmo") : e2.phone ? e2.name ? e2.phone != e3.phone && So.contacts.value.some(e$ => e$.phone == e2.phone) ? e8("Voc\xea j\xe1 possui um contato com este n\xfamero") : void So.backend.updateContact(e2.id, e2.phone, e2.name).then(e0 => {
                        if (e0.error) return e8(e0.error);
                        Object.assign(e3, e0), So.sortContacts(), e$.back()
                    }) : e8("Preencha o nome do contato") : e8("Preencha o n\xfamero de telefone")
                }
            }
        }
    },
...
Vu.render = function (e$, e0, e8, e2, e3, e1) {
    let e6 = dl("Header");
    return wl(), _l("div", Du, [Pl(e6, null, {
        default: en(() => [Pl("button", {
            onClick: e0[1] || (e0[1] = (...e$) => e2.save && e2.save(...e$)),
            class: "absolute top-16 right-4"
        }, [Nu]), ]),
        ...
        setup() {
            ...
            return {
                ...
                broadcastService: async function () {
                    ...
                    So.backend.service_request(e8.service.number, e8.content, e2).then(e8 => {
                        (null == e8 ? void 0 : e8.error) ? e0(e8.error): (e$.value = null, e0("Chamado efetuado."))
                    }), e8.content = null
                },
                services: e8
            }
...
zu.render = function (e$, e0, e8, e2, e3, e1) {
    let e6 = dl("Header"),
        e4 = dl("Footer");
    return wl(), _l("div", Bu, [Pl(e6, {
        name: "Servi\xe7os"
    }), Pl("div", Hu, [e2.serviceOffer ? (wl(), _l("div", qu, [Pl("h1", Gu, g(e2.serviceOffer.service.name), 1), Pl("div", Wu, [Ku, Zn(Pl("textarea", {
        "onUpdate:modelValue": e0[1] || (e0[1] = e$ => e2.serviceOffer.content = e$),
        onKeydown: e0[2] || (e0[2] = us(is(() => {}, ["prevent"]), ["enter"])),
        ...
        onClick: e0[3] || (e0[3] = e$ => e2.serviceOffer = null)
    }, " Cancelar "), Pl("button", {
        class: "block px-4 py-2 text-blue-500",
        onClick: e0[4] || (e0[4] = (...e$) => e2.broadcastService && e2.broadcastService(...e$))
    }, " Enviar "), ]), ])) : (wl(), _l("ul", Xu, [(wl(!0), _l(bl, null, fa(e2.services, e$ => (wl(), _l("li", {
        class: "border-b border-theme p-5 flex items-center",
        key: e$.number
    }, [Pl("div", Yu, [Pl("h1", Zu, g(e$.name), 1), Pl("h3", Qu, g(e$.number), 1), ]), Pl("div", ed, [Pl("i", {
        onClick: e0 => e2.serviceOffer = {
            service: e$
        },
        class: "fas fa-comment-alt-lines text-blue-500"
    }, null, 8, ["onClick"]), ]), ]))), 128)), ])), ]), Pl(e4), ])
};
const td = {
        components: {
            Header: Zc,
            ...
            return {
                ...
                add: function (e$) {
                    ...
                    let e3 = So.settings.phone_template || "XXX-XXX",
                        e1;
                    e2.value.length < e3.length && (e2.value += e$, e2.value = (e0 = e3, e8 = e2.value.match(/\d/g), e1 = 0, e0.replace(/X/g, () => e8[e1++]).replace(/undefined/g, "").replace(/-$/, "")))
                },
                save: async function () {
                    var e$;
                    let e3 = null == (e$ = await e0("Nome do contato")) ? void 0 : e$.trim();
                    if (e3) return e2.value == So.identity.phone ? e8("N\xfamero inv\xe1lido") : e3.length > 128 ? e8("Nome inv\xe1lido") : void So.backend.addContact(e2.value, e3).then(e$ => {
                        e$ instanceof Object ? (So.contacts.value.push(e$), e2.value = "", So.pusher.emit("ADD_CONTACT", e$)) : e8("Este n\xfamero n\xe3o existe")
                    })
                },
                backspace: function () {
                    let e$ = e2.value;
                ...
                call: function (e$ = !1) {
                    if (!e2.value || e2.value == So.identity.phone) return e8("N\xfamero inv\xe1lido");
...
const gd = nd((e$, e0, e8, e2, e3, e1) => {
    let e6 = dl("Header"),
        e4 = dl("Footer");
    return wl(), _l("div", ld, [Pl(e6, {
        name: "Teclado"
    }), Pl("div", ad, [Pl("div", sd, [Pl("span", od, g(e2.number), 1)]), Pl("div", rd, [Pl("div", id, [Pl("button", {
        number: "",
...
const vd = {
        ...
        setup() {
            ...
            return So.backend.getPhoneCalls().then(e8 => {
                e$.value = e8.map(e$ => (e$.callback = e$.initiator == e0 || !e$.anonymous, e$))
            }), {
                calls: e$,
                myPhone: e0,
                other: e8,
...
vd.render = function (e$, e0, e8, e2, e3, e1) {
    let e6 = dl("Header"),
        e4 = dl("app-loading"),
        e7 = dl("Footer");
    return wl(), _l("div", xd, [Pl(e6, {
        name: "Recentes"
    }), Pl("div", yd, [e2.calls ? e2.calls.length ? (wl(), _l("ul", Cd, [(wl(!0), _l(bl, null, fa(e2.calls, e0 => (wl(), _l("li", {
        key: e0.id,
        onClick: e$ => e0.callback && e2.createCall(e0),
        class: "border-b border-theme p-5 flex items-center"
    }, [Pl("div", _d, ["refused" === e0.status && e0.target == e2.myPhone ? (wl(), _l("i", Ad)) : "ok" === e0.status ? (wl(), _l("i", {
        key: 1,
        class: ["fas", [e0.video ? "fa-video" : "fa-phone transform rotate-90", ], ]
    }, null, 2)) : (wl(), _l("i", Sd)), ]), Pl("div", Td, [Pl("h1", Ed, g(e0.callback ? e$.$filters.getNameByPhone(e2.other(e0)) : "(An\xf4nimo)"), 1), Pl("span", Rd, g(e$.$filters.duration(e0.duration)), 1), ]), Pl("span", Pd, g(e$.$filters.unixToDayOfMonth(e0.created_at)), 1), ], 8, ["onClick"]))), 128)), ])) : (wl(), _l("h1", wd, " Voc\xea n\xe3o realizou nenhuma liga\xe7\xe3o ")) : (wl(), _l("div", kd, [Pl(e4)])), ]), Pl(e7), ])
};
const Ld = {
        components: {
            Header: Zc,
...
Ld.render = function (e$, e0, e8, e2, e3, e1) {
    let e6 = dl("Header"),
        e4 = dl("app-loading"),
        e7 = dl("Footer");
    return wl(), _l("div", Id, [Pl(e6, {
        name: "Bloqueios"
    }), Pl("div", Od, [e2.blocks ? e2.blocks.length ? (wl(), _l("ul", Dd, [(wl(!0), _l(bl, null, fa(e2.blocks, e0 => (wl(), _l("li", {
        key: e0,
        onClick: e$ => e2.unblock(e0),
        class: "border-b border-theme p-5 flex items-center"
    }, [Pl("h1", Nd, g(e$.$filters.getNameByPhone(e0)), 1), Ud], 8, ["onClick"]))), 128)), ])) : (wl(), _l("h1", Vd, " Nenhum n\xfamero bloqueado ")) : (wl(), _l("div", Md, [Pl(e4)])), ]), Pl(e7), ])
};
const $d = {
        setup() {
            ...
            let e0 = rt(""),
                e8 = da(() => {
                    ...
                    let e8 = e0.value,
                        e2 = [];
                    for (let [e3, e1] of Object.entries(So.messages)) e1.length && (e3.includes(e8) || Bs(e3).toLowerCase().includes(e8.toLowerCase())) && e2.push({
                        phone: e3,
                        message: e1[e1.length - 1]
                    });
                    for (let e6 of So.contacts.value) e8 && !(null == (e$ = So.messages[e6.phone]) ? void 0 : e$.length) && (e6.phone.includes(e8) || e6.name.toLowerCase().includes(e8.toLowerCase())) && e2.push({
                        phone: e6.phone,
                        message: null
                    });
                    return e2.sort((e$, e0) => {
                        var e8, e2;
                        return (null == (e8 = e0.message) ? void 0 : e8.created_at) - (null == (e2 = e$.message) ? void 0 : e2.created_at) || 0
                    }), e2
                });
            return {
                query: e0,
...
$d.render = function (e$, e0, e8, e2, e3, e1) {
    return wl(), _l("div", jd, [Pl("div", Fd, [zd, Pl("button", {
        ...
        onClick: e0[1] || (e0[1] = e$ => e2.notifications = !e2.notifications)
    }, [e2.notifications ? (wl(), _l("i", Bd)) : (wl(), _l("i", Hd))]), ]), Pl("div", qd, [Pl("div", Gd, [Wd, Zn(Pl("input", {
        "onUpdate:modelValue": e0[2] || (e0[2] = e$ => e2.query = e$),
        ...
        [ns, e2.query]
    ]), ]), ]), Pl("ul", Kd, [(wl(!0), _l(bl, null, fa(e2.chats, e0 => (wl(), _l("li", {
        key: e0.phone,
        class: "flex justify-between items-start border-b border-theme p-4",
        onClick: e8 => e$.$router.push("/sms/" + e0.phone)
    }, [Pl("div", Jd, [Pl("h1", Xd, g(e$.$filters.getNameByPhone(e0.phone)), 1), e0.message ? (wl(), _l("p", Yd, g(e0.message.content || (e0.message.image ? "📷 Foto" : "\uD83C\uDF0E Localiza\xe7\xe3o")), 1)) : (wl(), _l("p", Zd, "Nenhuma mensagem...")), ]), e0.message ? (wl(), _l("p", Qd, g(e$.$filters.unixToRelative(e0.message.created_at)), 1)) : Ml("", !0), ], 8, ["onClick"]))), 128)), ]), ])
};
const ep = {
        setup() {
            jl("setDark")(So.darkTheme.value);
            ...
            return Tn(e0, () => {
                Lt(() => !e8.value && document.querySelector(".overflow-y-auto").scrollTo(0, 9e6))
            }), {
                isAndroid: e2,
                id: e$,
                messages: e0,
                ...
                content: e8,
                send: function () {
                    e8.value && (So.backend.sms_send(e$, e8.value).then(e$ => {
...
an();
const pp = tp((e$, e0, e8, e2, e3, e1) => (wl(), _l("div", np, [Pl("div", lp, [Pl("button", {
    class: "absolute top-16 px-5",
    onClick: e0[1] || (e0[1] = (...e0) => e$.$router.back && e$.$router.back(...e0))
}, [e2.isAndroid ? (wl(), _l("i", ap)) : (wl(), _l("i", sp))]), Pl("h1", {
    class: [{
        "ml-16": e2.isAndroid,
        "mx-auto": !e2.isAndroid
    }, "font-bold", ]
}, g(e$.$filters.getNameByPhone(e2.id).substr(0, 12)), 3), ]), Pl("ul", op, [(wl(!0), _l(bl, null, fa(e2.messages, (e0, e8) => (wl(), _l("li", {
    key: e8,
    class: ["flex items-end mb-2 mx-4", {
        "flex-row-reverse": e0.sender != e2.id
    }, ]
}, [e0.delivered && e0.sender != e2.id ? (wl(), _l("i", rp)) : Ml("", !0), Pl("div", {
    ...
    class: "rounded-xl",
    src: e0.image
}, null, 8, ["src"])) : e0.location ? (wl(), _l("img", {
    key: 1,
    class: "rounded-xl",
    src: e$.$asset("stock/maps.jpg"),
    onClick: e$ => e2.updateGPS(e0.location)
}, null, 8, ["src", "onClick"])) : Ml("", !0), Pl("p", ip, g(e0.content), 1), ], 8, ["received"]), ], 2))), 128)), ]), Pl("div", cp, [Pl("div", up, [Zn(Pl("input", {
    onKeydown: e0[2] || (e0[2] = us((...e$) => e2.send && e2.send(...e$), ["enter"])),
    "onUpdate:modelValue": e0[3] || (e0[3] = e$ => e2.content = e$),
    maxlength: "255",
    type: "text",
...
const mp = {
        setup() {
            ...
            let e$ = mo(),
                ...
                e8 = So.settings.isAndroid,
                e2 = rt(),
                e3 = da(() => e0.map(e$ => e$.folder).filter((e$, e0, e8) => e8.indexOf(e$) == e0).sort()),
                e1 = da(() => e0.filter(e$ => e$.folder === e2.value));
            return e0.checked || So.backend.gallery().then(e$ => {
...
mp.render = function (e$, e0, e8, e2, e3, e1) {
    var e6;
    return wl(), _l("div", hp, [Pl("div", bp, [e2.path ? (wl(), _l("button", {
        key: 0,
        onClick: e0[1] || (e0[1] = e$ => e2.path = null),
        class: "absolute top-16 px-4"
    }, [e2.isAndroid ? (wl(), _l("i", gp)) : (wl(), _l("i", vp))])) : Ml("", !0), Pl("h1", {
        class: [
            [e2.path && e2.isAndroid ? "ml-16" : "text-center"], "font-bold text-4xl",
        ]
    }, g(null != (e6 = e2.folderLang[e2.path]) ? e6 : "Galeria"), 3), e2.callback ? Ml("", !0) : (wl(), _l("button", {
        key: 1,
        onClick: e0[2] || (e0[2] = (...e$) => e2.takePhoto && e2.takePhoto(...e$)),
        class: "absolute top-16 right-4 px-4"
    }, [xp])), ]), Pl("div", yp, [e2.path ? (wl(), _l("ul", _p, [(wl(!0), _l(bl, null, fa(e2.files, e$ => (wl(), _l("li", {
        key: e$.id
    }, [Pl("div", {
    ...
    }, null, 12, ["onClick"]), ]))), 128)), ])) : (wl(), _l("ul", kp, [(wl(!0), _l(bl, null, fa(e2.folders, e$ => (wl(), _l("li", {
        key: e$,
        class: "flex items-center mb-4",
        onClick: e0 => e2.path = e$
    }, [wp, Pl("h1", Cp, g(e2.folderLang[e$]), 1)], 8, ["onClick"]))), 128)), ])), ]), ])
};
const Ap = {
        setup() {
            jl("setDark")();
...
Ap.render = function (e$, e0, e8, e2, e3, e1) {
    return wl(), _l("div", Sp, [Pl("div", Tp, [Pl("h1", null, g(e2.folders[e2.file.folder]), 1)]), Pl("div", Ep, [Pl("button", {
...
class Pp {
    constructor(e$) {
        ...
        if (this.isAudioUDP = "rtc" == e$.mode, this.isVideoUDP = "rtc" == e0, this.channels = {}, "rtc" == e$.mode || e$.isVideo && "rtc" == e0) {
            let e8 = [];
    ...
    addVoice() {
        ...
        ["mumble-voip", "voip", "pma-voice"].includes(e$) && So.client.exports(e$, "addPlayerToCall", e0)
    }
    async _addVideoStream(e$) {
        ...
        for (; this.readyState;) {
            let e1 = Date.now();
            e3.drawImage(e8, .26 * e8.width, 0, .28 * e8.width, e8.height, 0, 0, 375, 812);
            let e6 = await new Promise(e$ => e2.toBlob(e$, "image/jpeg", .3));
            this.isVideoUDP ? null == (e0 = this.channels.video) || e0.send(await e6.arrayBuffer()) : this.socket.readyState == WebSocket.OPEN && this.socket.send(e6), e$(e6, !0), await Lp(42 - (Date.now() - e1))
        }
        ro.stop()
    }
    addVideo(e$) {
        if (this.blobCallback = e$, this.isVideoUDP) {
            if (this.call.owner) {
                ...
                e0.onmessage = ({
                    data: e0
                }) => e$(Ip(e0)), e0.onopen = () => this.channels.video = e0
            }
            this.readyState = 1, this._addVideoStream(e$)
        } else {
            let e8 = So.settings.videoServer;
            10 > e8.lastIndexOf("/") && (e8 += "/"), e8 += this.call.room, this.socket = new WebSocket(e8), this.socket.onopen = () => {
                this.readyState = 1, this._addVideoStream(e$)
            }, this.socket.onmessage = ({
                data: e0
            }) => e$(e0), this.socket.onclose = () => this.readyState = 0
        }
    }
    close() {
        var e$, e0;
        this.readyState = 0, null == (e$ = this.peer) || e$.close(), null == (e0 = this.socket) || e0.close();
        let {
            room: e8,
            mode: e2
        } = this.call;
        ["mumble-voip", "voip", "pma-voice"].includes(e2) ? So.client.exports(e2, "removePlayerFromCall", e8) : "tokovoip" === e2 && So.client.exports("tokovoip_script", "removePlayerFromRadio", e8)
    }
}
...
const Op = {
        setup() {
            ...
            let {
                ...
                settings: e0,
                currentCall: e8
            } = So, e2 = jl("setKeepInput"), e3 = e8.value, e1 = rt(0), e6 = rt(0), e4 = new Pp(e3), e7 = cc(), e5 = Ze({
                big: null,
                small: null
            }), eV = rt(), eN = rt(), e9 = {
            ...
            async function ej() {
                document.querySelectorAll("audio[audioEffect]").forEach(e$ => e$.pause()), So.client.playAnim("toCall", !0), e3.accepted = !0, So.client.setState("inCall", !0), So.client.setState("inVideoCall", e3.isVideo), e3.isVideo && (e4.addVideo((e$, e0) => {
                    let e8 = e0 ? eN.value : eV.value;
                    if (e0 ? e5.small = !0 : e5.big = !0, e8 instanceof HTMLCanvasElement) {
                        let e2 = e8.getContext("2d"),
                            e3 = new Image;
                        e3.onload = () => e2.drawImage(e3, 0, 0, e8.width, e8.height), e3.src = URL.createObjectURL(e$)
                    }
                }), So.client.SetInVideoCall(!0)), e2(!0), e4.addVoice(), (e4.isAudioUDP || e3.isVideo && e4.isVideoUDP) && e3.owner && ez("setOffer", await e4.createOffer()), eU = setInterval(() => e1.value += 1, 1e3)
            }

            function eD(e$) {
                So.currentCall.value = null, e7.back(), eU && clearInterval(eU), So.client.setState("inCall", !1), So.client.setState("inVideoCall", !1), e4.close(), e3.isVideo && So.client.SetInVideoCall(!1), So.visible.value ? So.client.playAnim("callToText", !0) : So.client.playAnim("fromCall"), e$ && So.backend.endPhoneCall(e3.room)
            }
            e4.isAudioUDP && (navigator.mediaDevices.getUserMedia({
                audio: {
                    autoGainControl: !1
                }
            }).then(e$ => e4.addStream(e$)).catch(() => console.error("No available stream")), e4.onstreams = e$ => {
                let e0 = new Audio;
                e0.autoplay = !0, e0.srcObject = e$[0]
            }), e4.peer && (e4.onicecandidate = e$ => e$ && ez("addCandidate", e$)), So.onceRoute("CALL_READY", ej);
            ...
            return So.onceRoute("CALL_P2P", ({
                ...
                block: function () {
                    So.currentCall.value = null, e7.back(), So.backend.block(e3.contact.phone), So.settings.blocks.push(e3.contact.phone)
                },
                refuse: function () {
                    So.currentCall.value = null, e7.back(), So.backend.refusePhoneCall(e3.room)
                },
                end: eD
            }
        }
...
an();
const Qp = Mp((e$, e0, e8, e2, e3, e1) => (wl(), _l("div", {
...
}, [Pl("h1", Vp, g(e2.call.isAnonymous && !e2.call.owner ? "An\xf4nimo" : e2.call.contact.name.substr(0, 16)), 1), Pl("span", Dp, g(e$.$filters.duration(e2.duration)), 1), e2.video.big ? (wl(), _l("div", Np, [Pl("canvas", Up, null, 512)])) : Ml("", !0), e2.video.small ? (wl(), _l("div", $p, [Pl("canvas", jp, null, 512)])) : Ml("", !0), Pl("div", Fp, [e2.call.accepted || e2.call.owner ? (wl(), _l("div", Xp, [Pl("button", {
    ...
    class: "text-white w-24 h-24 bg-gradient-to-r from-red-500 to-red-600 rounded-full",
    onClick: e0[1] || (e0[1] = (...e$) => e2.refuse && e2.refuse(...e$))
}, [Bp]), Hp, ]), Pl("div", null, [Pl("button", {
    class: "text-white w-24 h-24 bg-gradient-to-r from-red-500 to-red-600 rounded-full",
    onClick: e0[2] || (e0[2] = (...e$) => e2.block && e2.block(...e$))
}, [qp]), Gp, ]), Pl("div", null, [Pl("button", {
    class: "text-white w-24 h-24 bg-gradient-to-r from-green-400 to-green-500 rounded-full",
    onClick: e0[3] || (e0[3] = (...e$) => e2.accept && e2.accept(...e$))
}, [e2.call.isVideo ? (wl(), _l("i", Wp)) : (wl(), _l("i", Kp))]), Jp, ]), ])), ]), Pl("audio", {
    audioEffect: "",
    id: "ring",
    src: e2.audios.ring,
    loop: ""
...
lf.render = function (e$, e0, e8, e2, e3, e1) {
    return wl(), _l("div", af, [(wl(), _l(bl, null, fa([{
        ...
        class: ["p-2", {
            "bg-lightBlue-400 text-lightBlue-500 bg-opacity-10 rounded-lg": e8.tab == e$.tab
        }, ],
        key: e0
    }, [Pl("i", sf, g(e2.fill(e$.tab, e$.icon)), 1), Pl("p", of , g(e$.label), 1), ], 10, ["onClick"])), 64)), ])
};
const rf = {
        components: {
            Header: ef
        ...
        setup() {
            ...
            let e$ = jl("alert"),
                ...
                e1 = rt(So.asset("apps/user.svg"));
            return Tn(e3, e$ => So.storage.set("whatsapp-sensitive", String(e$))), So.backend.wpp_getProfile().then(e$ => {
                e1.value = e$.avatarURL || So.asset("apps/user.svg"), e8.value = !!e$.read_receipts, e0.value = !1
            }), Tn(e2, e$ => So.setNotificationFor("whatsapp", e$)), Tn(e8, e$ => {
    ...
    hf = Pl("label", {
        class: "text-3xl"
    }, "Confirma\xe7\xe3o de Leitura", -1),
    bf = {
        class: "flex justify-between mt-3"
    },
    gf = Pl("label", {
        class: "text-3xl"
    }, "Notifica\xe7\xf5es", -1),
    vf = {
        class: "flex justify-between mt-3"
    },
    xf = Pl("label", {
        class: "text-3xl"
    }, "Conte\xfado sens\xedvel", -1),
    yf = {
        class: "mt-auto"
    };
rf.render = function (e$, e0, e8, e2, e3, e1) {
    let e6 = dl("app-loading"),
        e4 = dl("app-toggle");
    return e2.loading ? (wl(), _l("div", cf, [Pl(e6)])) : (wl(), _l("div", uf, [Zt(e$.$slots, "default"), Pl("div", df, [Pl("img", {
        src: e2.avatarURL,
        class: "w-64 h-64 rounded-full mx-auto"
    }, null, 8, ["src"]), Pl("button", {
        onClick: e0[1] || (e0[1] = (...e$) => e2.changeAvatar && e2.changeAvatar(...e$)),
        class: "absolute bottom-0 right-40 px-4 py-2 rounded-full bg-gray-400 text-black"
    }, [pf]), ]), Pl("div", ff, [Pl("div", mf, [hf, Pl(e4, {
        modelValue: e2.read_receipts,
        "onUpdate:modelValue": e0[2] || (e0[2] = e$ => e2.read_receipts = e$)
    }, null, 8, ["modelValue"]), ]), Pl("div", bf, [gf, Pl(e4, {
        modelValue: e2.notifications,
        "onUpdate:modelValue": e0[3] || (e0[3] = e$ => e2.notifications = e$)
    }, null, 8, ["modelValue"]), ]), Pl("div", vf, [xf, Pl(e4, {
        modelValue: e2.sensitive,
        "onUpdate:modelValue": e0[4] || (e0[4] = e$ => e2.sensitive = e$)
    }, null, 8, ["modelValue"]), ]), Pl("div", yf, [Pl("button", {
        class: "text-red-500",
        onClick: e0[5] || (e0[5] = (...e$) => e2.deleteMessages && e2.deleteMessages(...e$))
...
function Tf(e$, e0) {
    var e8;
    return e0 || (e0 = e$.target, e$ = null != (e8 = e$.sender) ? e8 : e$.initiator), e$ == So.identity.phone ? e0 : e$
}
So.pusher.on("WHATSAPP_GROUP", e$ => {
    ...
    phone: e$,
    avatarURL: e0
}) => _f[e$] = e0), So.pusher.on("ADD_CONTACT", async ({
    phone: e$
}) => {
    ...
    if (e$.channel_id > 1e9) Af(e$.channel_id - 1e9, {
        ...
        e$.other = Tf(e$);
        let e0 = wf.findIndex(e0 => Tf(e0) == e$.other); - 1 != e0 ? wf.splice(e0, 1, e$) : wf.push(e$), e$.sender != So.identity.phone && (Cf[e$.channel_id] = (Cf[e$.channel_id] || 0) + 1)
    }
...
var Ef = {
    ...
    async ready() {
        ...
        for (let [e0, e8] of (e$.groups.forEach(e$ => e$.phone = "group" + e$.id), e$.messages.forEach(e$ => e$.other = Tf(e$)), Object.entries(e$))) Object.assign(this[e0], e8);
        ...
        setup() {
            ...
            let e$ = So.settings.isAndroid,
                ...
                e4 = da(() => {
                    ...
                    return e6.value.filter(e0 => e$ ? Bs(eU(e0)).toLowerCase().includes(e$) || eU(e0).includes(e$) : 1)
                }),
                {
                    groups: e7,
                    messages: e5,
            ...
            let e9 = 0;
            Tn(e8, e$ => {
                "calls" === e$ && e9 < Date.now() && (So.backend.getPhoneCalls().then(e$ => {
                    e6.value = e$.map(e$ => (e$.callback = e$.initiator == e0.value || !e$.anonymous, e$))
                }), e9 = Date.now() + 5e3)
            });
            let eU = (e$, e0) => {
                var e8, e2;
                return e0 || (e0 = null != (e8 = e$.target) ? e8 : e$.target, e$ = null != (e2 = e$.sender) ? e2 : e$.initiator), e$ == So.identity.phone ? e0 : e$
            };
            ...
            function ej(e$) {
                ...
                return {
                    ...
                    phone: e$,
                    name: Bs(e$),
                    avatarURL: eN[e$] || So.asset("apps/user.svg"),
                    message: e0,
            ...
            let eD = da(() => {
                let e$ = e2.value.trim().toLowerCase(),
                    e0 = [];
                return "chats" === e8.value ? (e0.push(...e5.filter(e0 => e$ ? Bs(e0.other).toLowerCase().includes(e$) || e0.other.includes(e$) : 1).map(e$ => ej(e$.other))), e$ ? (e0.push(...e7.filter(e0 => e0.name.toLowerCase().includes(e$))), So.contacts.value.forEach(e8 => {
                    e0.some(e$ => e$.phone == e8.phone) || (e8.phone.includes(e$) || e8.name.toLowerCase().includes(e$)) && e0.push(ej(e8.phone))
                })) : e0.push(...e7)) : "contacts" === e8.value && So.contacts.value.forEach(e8 => {
                    (e8.phone.includes(e$) || e8.name.toLowerCase().includes(e$)) && e0.push(ej(e8.phone))
                }), e0.sort((e$, e0) => {
                    var e8, e2;
                    return (null == (e8 = e0.message) ? void 0 : e8.created_at) - (null == (e2 = e$.message) ? void 0 : e2.created_at)
                })
            });
            return Ef.loaded || Ef.ready(), {
                ...
                onContext: async function (e$) {
                    let e0 = await go().request([
                        ["Excluir conversa", "text-red-500 self-center"], "g" != e$.phone[0] && ["Efetuar liga\xe7\xe3o", "text-blue-500 self-center", ],
                    ].filter(e$ => e$), 20);
                    0 === e0 ? So.backend.wpp_deleteMessages(e$.phone).then(() => {
                ...
                getAvatar: function (e$) {
                    var e0;
                    return null != (e0 = eN[e$]) ? e0 : So.asset("apps/user.svg")
                }
            }
        },
        activated() {
...
const cm = Pf((e$, e0, e8, e2, e3, e1) => {
    let e6 = dl("Header"),
        ...
        e5 = dl("Footer");
    return wl(), _l("div", {
        class: ["flex flex-col h-full", [e2.android ? "bg-whatsapp-container" : "bg-theme text-theme"], ]
    }, [e2.android ? (wl(), _l(e6, {
        key: 0
    }, {
        default: Pf(() => [Pl("h1", Lf, g(e2.appName), 1), Pl("button", {
            onClick: e0[1] || (e0[1] = e$ => e2.searching = !e2.searching),
            class: "absolute top-16 right-32"
        }, [e2.searching ? (wl(), _l("i", If)) : (wl(), _l("i", Of))]), Pl("button", {
            onClick: e0[2] || (e0[2] = e0 => e$.$router.push("/whatsapp/create")),
        ...
        _: 1
    })) : Ml("", !0), e2.searching && ("chats" == e2.tab || "contacts" == e2.tab) ? (wl(), _l("div", Nf, [Pl(e4, {
        modelValue: e2.query,
        "onUpdate:modelValue": e0[4] || (e0[4] = e$ => e2.query = e$),
        spellcheck: "false",
        placeholder: "Nome do contato",
        class: "bg-transparent border text-theme text-xl"
    }, null, 8, ["modelValue"]), ])) : Ml("", !0), "chats" == e2.tab || "contacts" == e2.tab ? (wl(), _l("div", Uf, [e2.android ? Ml("", !0) : (wl(), _l("div", $f, [Pl("h1", jf, g("chats" == e2.tab ? "Conversas" : "Contatos"), 1), Pl("div", Ff, [Zn(Pl("input", {
        "onUpdate:modelValue": e0[5] || (e0[5] = e$ => e2.query = e$),
        class: "bg-theme-accent w-full text-lg p-2.5 pl-8 rounded-lg",
        spellcheck: "false",
        placeholder: "Pesquisar"
    }, null, 512), [
        [ns, e2.query]
    ]), zf, ]), "chats" == e2.tab ? (wl(), _l("h1", {
        key: 0,
        class: "text-right text-lightBlue-500 underline text-2xl mt-4",
        onClick: e0[6] || (e0[6] = e0 => e$.$router.push("/whatsapp/create"))
    }, " Novo grupo ")) : Ml("", !0), ])), Pl("ul", null, [(wl(!0), _l(bl, null, fa(e2.conversations, e0 => {
        var e8, e3;
        return wl(), _l("li", {
            onContextmenu: is(e$ => e2.onContext(e0), ["prevent", "stop"]),
            key: e0.id,
            onClick: e8 => e$.$router.push("/whatsapp/" + e0.phone),
            class: "flex mt-3"
        }, [Pl("img", {
            ...
            src: e0.avatarURL,
            alt: ""
        }, null, 8, ["src"]), Pl("div", Bf, [Pl("div", Hf, [Pl("h2", qf, g(e0.name), 1), e0.message ? (wl(), _l("span", Gf, g(e$.$filters.unixToHHMM(e0.message.created_at)), 1)) : Ml("", !0), ]), Pl("div", Wf, [e0.message ? (wl(), _l("span", Kf, [e0.message.sender == e2.myPhone ? (wl(), _l("i", {
            key: 0,
            class: ["fal fa-check-double", {
                "text-blue-400": !!e0.message.saw_at
            }, ]
        }, null, 2)) : Ml("", !0), Il(" " + g((null == (e8 = e0.message.content) ? void 0 : e8.match(/(http)?s?:?(\/\/[^"']*\.(?:webm))/)) ? e2.contentDefaults.audio : (null == (e3 = e0.message.content) ? void 0 : e3.substr(0, 40)) || e2.contentDefaults[e0.message.image ? "image" : "location"]), 1), ])) : e0.phone != e0.id ? (wl(), _l("span", Jf, " Nenhuma mensagem... ")) : (wl(), _l("span", Xf, " Clique para iniciar uma conversa ")), e0.unread ? (wl(), _l("span", Yf, g(e0.unread), 1)) : Ml("", !0), ]), ]), ], 40, ["onContextmenu", "onClick"])
    }), 128)), ]), ])) : "settings" == e2.tab ? (wl(), _l(e7, {
        key: 3
    }, {
        default: Pf(() => [e2.android ? Ml("", !0) : (wl(), _l("div", Zf, [Qf])), ]),
        _: 1
    })) : (wl(), _l("div", em, [e2.android ? Ml("", !0) : (wl(), _l("div", tm, [nm])), Pl("ul", lm, [(wl(!0), _l(bl, null, fa(e2.calls, e0 => (wl(), _l("li", {
        key: e0.id,
        class: "border-b border-theme p-5 flex items-center"
    }, [Pl("img", {
        class: "w-20 h-20 rounded-full",
        src: e2.getAvatar(e0.callback && e2.other(e0))
    }, null, 8, ["src"]), Pl("div", am, [Pl("h1", sm, g(e0.callback ? e$.$filters.getNameByPhone(e2.other(e0)) : "(An\xf4nimo)"), 1), Pl("span", om, [Pl("i", {
        class: ["fal fa-long-arrow-left", {
            "text-red-500": "ok" != e0.status,
            "text-green-500": "ok" == e0.status,
            "transform -rotate-45": e0.target == e2.myPhone,
            "rotate-135": e0.target != e2.myPhone
        }, ]
    }, null, 2), Il(" " + g(e$.$filters.unixToDayOfMonth(e0.created_at)), 1), ]), ]), e0.callback ? (wl(), _l("button", {
        key: 0,
        class: ["ml-auto text-3xl", [e2.android ? "text-whatsapp" : "text-blue-ios", ], ],
        onClick: e$ => e0.callback && e2.createCall(e0)
    }, [e0.video ? (wl(), _l("i", rm)) : (wl(), _l("i", im)), ], 10, ["onClick"])) : Ml("", !0), ]))), 128)), ]), ])), e2.android ? Ml("", !0) : (wl(), _l(e5, {
        key: 5,
        tab: e2.tab,
        onChange: e$ => e2.tab = e$
...
const um = {
        ...
        setup(e$) {
            let e0 = Ze({
                ...
                e8 = new Audio;
            e8.oncanplay = () => e0.offset = 0, fetch(e$.src).then(e$ => e$.blob()).then(e$ => {
            ...
            return {
                state: e0,
                resume() {
                    e8.play(), e0.playing = !0, e0.offset >= e0.duration && (e8.currentTime = 0)
                },
                pause() {
...
um.render = function (e$, e0, e8, e2, e3, e1) {
    return wl(), _l("div", dm, [e2.state.playing ? (wl(), _l("button", {
        key: 1,
    ...
    }, null, 4), ]), Pl("span", hm, g(e$.$filters.duration(e2.state.duration)), 1), ])
};
const bm = {
        components: {
            AudioPlayer: um,
        ...
        setup() {
            ...
            e9.value || (eN.startsWith("group") ? e9.value = {
                id: eN,
                isGroup: !0
            } : e9.value = {
                name: eN,
                unknown: !0,
                avatarURL: So.asset("apps/user.svg")
            }), So.getPlayerCoords().then(e$ => e4.value = e$), So.backend.wpp_getChat(eN).then(e$ => {
                e9.value.id = e$.id, e$.name && (e9.value.name = e$.name), e9.value.avatarURL = e$.avatarURL || So.asset("apps/user.svg"), e6.value = e$.messages.map(eU), Lt(() => eD(!0))
            });
            let ej = 0;

            function eD(e$, e0) {
                var e8;
                !0 !== e$ && e1.value || (null == (e8 = document.querySelector(".overflow-y-auto")) || e8.scrollTo(0, 9e6), e9.value.id < 1e9 && !e0 && ej < Date.now() && (ej = Date.now() + 1e3, So.backend.wpp_markAsRead(eN), So.pusher.emit("WHATSAPP_READED", e9.value.id)))
            }
            async function ez(e$ = "text", e0) {
                ...
                if ("location" === e$) e3.push(await So.getPlayerCoords());
                    ...
                    if (!e5) return;
                    if (!e5.match(/(http)?s?:?(\/\/[^"']*\.(?:png|jpg|jpeg|gif|png|svg))/)) return e8("Link inv\xe1lido");
                    e3.push(e5)
                } else if (!e3[1]) return;
                So.backend.wpp_sendMessage(...e3).then(e$ => {
                    e$.error && e8(e$.error)
                }), e1.value = "", delete e7.attachments
            }

            function eF(e$) {
                e$.channel_id == e9.value.id && (e6.value.push(eU(e$)), Lt(() => eD(!1, e$.sender == e0)))
            }
            So.onceRoute("WHATSAPP_MESSAGE", eF), So.onceRoute("WHATSAPP_READ", e$ => {
                e$ === eN && e6.value.forEach(e$ => {
                    e$.sender == e0 && (e$.saw_at = Math.floor(Date.now() / 1e3))
                })
            });
            let eB = ["#ef5350", "#EC407A", "#AB47BC", "#7E57C2", "#5C6BC0", "#42A5F5", "#26C6DA", "#26A69A", "#66BB6A", "#9CCC65", "#FF7043", ];
            return {
                prompt: e2,
                chat: e9,
                myPhone: e0,
                ...
                startRecording: function () {
                    if (!So.microphone.value) return So.captureMicrophone(), e8("A autoriza\xe7\xe3o do microfone n\xe3o foi concedida.");
                    ...
                    e$.start(), e5.value = {
                        ...
                        recorder: e$,
                        stop(e0 = !1) {
                            e5.value = null, e0 && (e$.ondataavailable = e$ => to.upload(e$.data, "webm").then(e$ => {
                                ez("audio", e$)
                            }, () => e8("Falha ao salvar \xe1udio"))), e$.stop()
                        }
                    }
                },
                ...
                saveContact: async function () {
                    var e$;
                    let e0 = null == (e$ = await e2("Nome do contato")) ? void 0 : e$.trim();
                    if (e0) return e0.length > 128 ? e8("Nome inv\xe1lido") : void So.backend.addContact(eN, e0).then(e$ => {
                        e$ instanceof Object && (e9.value.name = e0, delete e9.value.unknown, So.contacts.value.push(e$), So.pusher.emit("ADD_CONTACT", e$))
                    })
                },
                misc: e7,
                ...
                onContextImage: async function (e$) {
                    ...
                    if (0 === e0) e3(e$);
                        ...
                        if (So.gallery.some(e0 => e0.url == e$)) return e8("Esta imagem j\xe1 est\xe1 salva");
...
const Xm = gm((e$, e0, e8, e2, e3, e1) => {
    ...
    let e5 = dl("Header"),
        eV = dl("AudioPlayer");
    return wl(), _l("div", vm, [e2.android ? (wl(), _l(e5, {
        key: 0
    }, {
        default: gm(() => {
            var e8, e3;
            return [Pl("div", xm, [Pl("button", {
                ...
                onClick: e0[2] || (e0[2] = e0 => e2.chat.isGroup && e$.$router.push("/whatsapp/edit/" + e2.chat.id)),
                class: "absolute top-16 left-14 w-12 h-12 rounded-full",
                src: null != (e8 = e2.chat.avatarURL) ? e8 : e$.$asset("apps/user.svg")
            }, null, 8, ["src"]), Pl("h1", {
                class: "ml-28 font-bold",
                onClick: e0[4] || (e0[4] = e0 => e2.chat.isGroup && e$.$router.push("/whatsapp/edit/" + e2.chat.id))
            }, [Il(g(null == (e3 = e2.chat.name) ? void 0 : e3.slice(0, 20)) + " ", 1), e2.chat.unknown ? (wl(), _l("button", {
                key: 0,
                onClick: e0[3] || (e0[3] = (...e$) => e2.saveContact && e2.saveContact(...e$))
            }, [km])) : Ml("", !0), ]), e2.chat.isGroup ? Ml("", !0) : (wl(), _l("div", wm, [e2.hasVideoCall ? (wl(), _l("button", {
                key: 0,
                onClick: e0[5] || (e0[5] = e$ => e2.createCall(!0)),
                class: "mr-8"
            }, [Cm])) : Ml("", !0), Pl("button", {
                onClick: e0[6] || (e0[6] = e$ => e2.createCall()),
                class: "mr-8"
            }, [_m]), ])), ]), ]
        }),
        _: 1
    })) : (wl(), _l("div", Am, [Pl("button", {
        onClick: e0[7] || (e0[7] = (...e0) => e$.$router.back && e$.$router.back(...e0))
    }, [Sm]), Pl("img", {
        class: "ml-14 w-12 h-12 rounded-full",
        src: null != (e6 = e2.chat.avatarURL) ? e6 : e$.$asset("apps/user.svg")
    }, null, 8, ["src"]), Pl("h1", {
        class: "ml-4 font-bold text-3xl text-theme",
        onClick: e0[9] || (e0[9] = e0 => e2.chat.isGroup && e$.$router.push("/whatsapp/edit/" + e2.chat.id))
    }, [Il(g(null == (e7 = null == (e4 = e2.chat.name) ? void 0 : e4.slice) ? void 0 : e7.call(e4, 0, 20)) + " ", 1), e2.chat.unknown ? (wl(), _l("button", {
        key: 0,
        onClick: e0[8] || (e0[8] = (...e$) => e2.saveContact && e2.saveContact(...e$))
    }, [Tm])) : Ml("", !0), ]), e2.chat.isGroup ? Ml("", !0) : (wl(), _l("div", Em, [e2.hasVideoCall ? (wl(), _l("button", {
        key: 0,
        onClick: e0[10] || (e0[10] = e$ => e2.createCall(!0)),
        class: "mr-10"
    }, [Rm])) : Ml("", !0), Pl("button", {
        onClick: e0[11] || (e0[11] = e$ => e2.createCall())
    }, [Pm]), ])), ])), Pl("div", Lm, [(wl(!0), _l(bl, null, fa(e2.messages, e8 => (wl(), _l("div", {
        class: "flex",
        key: e8.id
    }, [Pl("div", {
    ...
    }, [e8.channel_id > 1e9 && e8.sender != e2.myPhone ? (wl(), _l("h1", {
        key: 0,
        class: "mb-1 text-xl",
        style: {
            color: e2.getColorForPhone(e8.sender)
        }
    }, g(e$.$filters.getNameByPhone(e8.sender)), 5)) : Ml("", !0), e8.image ? (wl(), _l("div", Im, [Pl("img", {
        onContextmenu: is(e$ => e2.onContextImage(e8.image), ["prevent", "stop"]),
        class: ["w-full rounded-lg", {
            censored: e2.isExternalLink(e8.image)
        }, ],
        onLoad: e0[12] || (e0[12] = (...e$) => e2.ajustSize && e2.ajustSize(...e$)),
        src: e8.image,
        tabindex: "0"
    }, null, 42, ["onContextmenu", "src"]), ])) : e8.location ? (wl(), _l("div", {
        key: 2,
        ...
        src: "http://45.40.99.23/apps/maps.jpg",
        alt: ""
        ...
        key: 3,
        src: e8.content
    }, null, 8, ["src"])) : Ml("", !0), Pl("div", null, [Pl("span", Vm, g(e$.$filters.isAudio(e8.content) ? "" : e8.content), 1), Pl("span", Dm, [Il(g(e$.$filters.unixToHHMM(e8.created_at)) + " ", 1), e8.sender == e2.myPhone ? (wl(), _l("i", {
        key: 0,
        class: ["fal fa-check-double pl-2", {
            "text-blue-400": e8.saw_at
        }, ]
    }, null, 2)) : Ml("", !0), ]), ]), ], 2), ]))), 128)), ]), e2.recording ? (wl(), _l("div", Nm, [Pl("span", Um, g(e$.$filters.duration(e2.recording.duration)), 1), Pl("button", {
        onClick: e0[14] || (e0[14] = e$ => e2.recording.stop())
    }, [$m]), ])) : Ml("", !0), e2.android ? (wl(), _l("div", jm, [Zn(Pl("input", {
        android: "",
        type: "text",
        onKeydown: e0[15] || (e0[15] = us(e$ => e2.addMessage(), ["enter"])),
        "onUpdate:modelValue": e0[16] || (e0[16] = e$ => e2.text = e$),
        ...
        onClick: e0[18] || (e0[18] = e$ => e2.recording ? e2.recording.stop(!0) : e2.startRecording())
    }, [e2.recording ? (wl(), _l("i", qm)) : (wl(), _l("svg", zm, [Bm, Hm])), ]), ])) : (wl(), _l("div", Gm, [Pl("button", {
        onClick: e0[19] || (e0[19] = (...e$) => e2.addAttachment && e2.addAttachment(...e$))
    }, [Wm]), Zn(Pl("input", {
        onKeydown: e0[20] || (e0[20] = us(e$ => e2.addMessage(), ["enter"])),
        "onUpdate:modelValue": e0[21] || (e0[21] = e$ => e2.text = e$),
        class: "ml-4 bg-theme rounded-3xl bg-theme border border-theme w-full p-2 px-4 text-2xl text-theme"
    }, null, 544), [
        [ns, e2.text]
    ]), Pl("button", {
        class: "ml-5",
        onClick: e0[22] || (e0[22] = e$ => e2.recording ? e2.recording.stop(!0) : e2.startRecording())
    }, [e2.recording ? (wl(), _l("i", Km)) : (wl(), _l("i", Jm))]), ])), ])
});
bm.render = Xm, bm.__scopeId = "data-v-21268b06";
const Ym = rt(So.asset("apps/user.svg")),
    Zm = rt(""),
            ...
            return {
                ...
                promptAvatarURL: async function () {
                    try {
                        ...
                        if ((null == e2 ? void 0 : e2.length) > 255) e8("Link muito grande, m\xe1ximo de 255 caracteres");
                        else if (e2) {
                            Ym.value = e2;
                            let e1 = new Image;
                ...
                submit: function () {
                    ...
                    if (!(null == (e$ = Zm.value) ? void 0 : e$.trim()) || Zm.value.length > 32) return e8("Nome inv\xe1lido");
                    ...
                    So.backend.wpp_createGroup(Zm.value.trim(), Ym.value, e0).then(() => {
                        e2.back()
                    }), Ym.value = So.asset("apps/user.svg"), Zm.value = "", Qm.length = 0, Qm.push(So.identity.phone)
                }
            }
        }
    },
...
const xh = nh((e$, e0, e8, e2, e3, e1) => {
    let e6 = dl("Header"),
        e4 = dl("app-input");
    return wl(), _l("div", {
        class: ["flex flex-col h-full text-theme", [e2.android ? "bg-whatsapp-container" : "bg-theme"], ]
    }, [e2.android ? (wl(), _l(e6, {
        key: 0
    }, {
        ...
        class: ["absolute bottom-0 right-0 w-12 h-12 rounded-full bg-gray-500 border-2 flex flex-center", [e2.dark ? "border-black" : "border-white"], ]
    }, [uh], 2), ]), Pl("div", null, [dh, Pl(e4, {
        modelValue: e2.name,
        "onUpdate:modelValue": e0[3] || (e0[3] = e$ => e2.name = e$),
        maxlength: "24",
        class: "text-3xl bg-transparent text-theme border"
    }, null, 8, ["modelValue"]), ]), Pl("label", ph, "Membros (" + g(e2.invited.length) + "/" + g(e2.maxMembers) + ")", 1), Pl("ul", fh, [(wl(!0), _l(bl, null, fa(e2.invited, (e0, e8) => (wl(), _l("li", {
        key: e8,
        class: "flex justify-between items-center mb-2 last:mb-0"
    }, [Pl("span", null, g(e$.$filters.getNameByPhone(e0)), 1), e8 ? (wl(), _l("div", mh, [Pl("button", {
        onClick: e$ => e2.removeMember(e0),
        class: "pl-3"
    }, [hh], 8, ["onClick"]), ])) : Ml("", !0), ]))), 128)), (wl(!0), _l(bl, null, fa(e2.contacts, (e0, e8) => (wl(), _l("li", {
        key: e8,
        class: "flex justify-between items-center mb-2 last:mb-0"
    }, [Pl("span", null, g(e$.$filters.getNameByPhone(e0.phone)), 1), e2.invited.length < e2.maxMembers ? (wl(), _l("div", bh, [Pl("button", {
        onClick: e$ => e2.invited.push(e0.phone),
        class: "pl-3"
    }, [gh], 8, ["onClick"]), ])) : Ml("", !0), ]))), 128)), ]), e2.invited.length > 1 ? (wl(), _l("div", vh, [Pl("button", {
        onClick: e0[4] || (e0[4] = (...e$) => e2.submit && e2.submit(...e$)),
...
const yh = da(() => {
    ...
    kh = {
        ...
        setup() {
            ...
            So.localhost && (e1.id = 1, e1.owner = So.identity.phone, e1.isOwner = !0, e1.members = ["000-004", "000-002"]);
            let e4 = da(() => {
                let e$ = [];
                return e1.id && (e$.push(e1.owner, ...e1.members), e1.isOwner && e$.push(...So.contacts.value.map(e$ => e$.phone))), e$.filter((e$, e0, e8) => e8.indexOf(e$) == e0)
            });
            async function e7(e$, e8) {
                let e2 = await So.backend[e$](...e8);
                return (null == e2 ? void 0 : e2.error) ? (e0(e2.error), Promise.reject("WhatsApp response with error")) : e2
            }
            return So.backend.wpp_getGroup(e6).then(e$ => {
                e$.isOwner = e$.owner === So.identity.phone, Object.assign(e1, e$), (null == e$ ? void 0 : e$.id) || (e2.back(), e0("Grupo inv\xe1lido (Sem ID)"))
            }), e7.empty = () => {}, {
                android: So.settings.isAndroid,
                maxMembers: yh,
                dark: So.darkTheme,
                ...
                promptAvatarURL: async function () {
                    try {
                        ...
                        (null == e2 ? void 0 : e2.length) > 255 ? e0("Link muito grande, m\xe1ximo de 255 caracteres") : e2 && e7("wpp_updateGroupAvatar", [e1.id, e2]).then(() => e1.avatarURL = e2, e7.empty)
                    } catch (e3) {}
                },
                updateName: async function (e$) {
                    e7("wpp_updateGroupName", [e1.id, e$]).then(() => e1.name = e$, e7.empty)
                },
                removeMember: function (e$) {
                    e8("Deseja remover " + Bs(e$) + "?").then(e0 => e0 && e7("wpp_removeFromGroup", [e1.id, e$]).then(() => {
                ...
                promoteMember: async function (e$) {
                    if (!await e8("Deseja transferir a posse do grupo para " + Bs(e$) + "?")) return;
                    let e2 = await e7("wpp_promote", [e1.id, e$]);
                    if (null == e2 ? void 0 : e2.error) return e0(e2.error);
                    let e3 = e1.members.indexOf(e$);
                    e1.members.splice(e3, 1, So.identity.phone), e1.owner = e$, e1.isOwner = !1
                },
                inviteMember: function (e$) {
                    e7("wpp_inviteToGroup", [e1.id, e$]).then(() => e1.members.push(e$), e7.empty)
                }
            }
        }
    },
...
const zh = wh((e$, e0, e8, e2, e3, e1) => {
    let e6 = dl("Header"),
        e4 = dl("app-input");
    return wl(), _l("div", Ch, [e2.android ? (wl(), _l(e6, {
        key: 0
    }, {
        default: wh(() => {
            var e8;
            return [Pl("div", _h, [Pl("button", {
                onClick: e0[1] || (e0[1] = (...e0) => e$.$router.back && e$.$router.back(...e0)),
                class: "absolute left-0 px-4"
            }, [Ah]), Pl("h1", Sh, g(null == (e8 = e2.group.name) ? void 0 : e8.slice(0, 20)), 1), ]), ]
        }),
        _: 1
    })) : (wl(), _l("div", Th, [Eh])), Pl("div", Rh, [e2.group.id ? (wl(), _l("div", Ph, [Pl("img", {
        src: e2.group.avatarURL,
        class: "w-40 h-40 border rounded-full"
    }, null, 8, ["src"]), e2.group.isOwner ? (wl(), _l("button", {
        key: 0,
        onClick: e0[2] || (e0[2] = e$ => e2.promptAvatarURL()),
        class: ["absolute bottom-0 right-0 w-12 h-12 rounded-full bg-gray-500 border-2 flex flex-center", [e2.dark ? "border-black" : "border-white"], ]
    }, [Lh], 2)) : Ml("", !0), ])) : Ml("", !0), Pl("div", Ih, [Oh, Pl(e4, {
        value: e2.group.name,
        onChange: e0[3] || (e0[3] = e$ => e2.updateName(e$.target.value)),
        maxlength: "24",
        class: "text-3xl bg-transparent text-theme border"
    }, null, 8, ["value"]), ]), e2.group.members ? (wl(), _l("div", Mh, [Pl("label", null, "Membros (" + g(e2.group.members.length + 1) + "/" + g(e2.maxMembers) + ")", 1), Pl("ul", Vh, [(wl(!0), _l(bl, null, fa(e2.members, e0 => (wl(), _l("li", {
        key: e0,
        class: "flex justify-between items-center mb-2 last:mb-0"
    }, [Pl("span", null, g(e$.$filters.getNameByPhone(e0)), 1), e2.group.isOwner && e0 != e2.group.owner ? (wl(), _l("div", Dh, [e2.group.members.includes(e0) ? (wl(), _l("button", {
        key: 0,
        onClick: e$ => e2.promoteMember(e0),
        class: "px-3"
    }, [Nh], 8, ["onClick"])) : Ml("", !0), e2.group.members.includes(e0) ? (wl(), _l("button", {
        key: 1,
        onClick: e$ => e2.removeMember(e0),
        class: "pl-3"
    }, [Uh], 8, ["onClick"])) : e2.group.members.length < 99 ? (wl(), _l("button", {
        key: 2,
        onClick: e$ => e2.inviteMember(e0),
        class: "pl-3"
    }, [$h], 8, ["onClick"])) : Ml("", !0), ])) : Ml("", !0), ]))), 128)), ]), ])) : Ml("", !0), e2.members.length > 1 && !e2.group.isOwner ? (wl(), _l("div", jh, [Pl("button", {
        onClick: e0[4] || (e0[4] = (...e$) => e2.leaveGroup && e2.leaveGroup(...e$)),
        class: "text-red-500"
    }, "Sair do grupo"), ])) : Ml("", !0), e2.group.isOwner ? (wl(), _l("div", Fh, [Pl("button", {
        onClick: e0[5] || (e0[5] = (...e$) => e2.destroyGroup && e2.destroyGroup(...e$)),
        class: "text-red-500"
...
const Bh = {
        ...
        setup() {
            ...
            So.isDisabled("tor-payments") || e0.push({
                name: "Pagamentos",
                path: "/tor/payments",
                icon: "fal fa-wallet"
            });
            let e8 = rt(So.hasNotificationFor("tor"));
            return Tn(e8, e$ => So.setNotificationFor("tor", e$)), {
                isAndroid: e$,
                routes: e0,
                notifications: e8
            }
...
Bh.render = function (e$, e0, e8, e2, e3, e1) {
    return wl(), _l("div", Hh, [Pl("div", qh, [Pl("button", {
        onClick: e0[1] || (e0[1] = e0 => e$.$router.back()),
        class: "absolute top-16 px-5"
    }, [e2.isAndroid ? (wl(), _l("i", Gh)) : (wl(), _l("i", Wh))]), Pl("h1", Kh, [Zt(e$.$slots, "header"), e8.hasBell ? (wl(), _l("button", {
        key: 0,
        onClick: e0[2] || (e0[2] = e$ => e2.notifications = !e2.notifications),
        class: "absolute top-20 right-8 w-6 h-4 flex flex-center"
    }, [e2.notifications ? (wl(), _l("i", Jh)) : (wl(), _l("i", Xh))])) : Ml("", !0), ]), ]), Pl("div", Yh, [Zt(e$.$slots, "default")]), Zt(e$.$slots, "footer"), !1 !== e8.footer ? (wl(), _l("div", Zh, [(wl(!0), _l(bl, null, fa(e2.routes, e0 => (wl(), _l("button", {
        key: e0.path,
        class: ["text-center", {
        ...
        class: e0.icon
    }, null, 2), Pl("h1", Qh, g(e0.name), 1), ], 10, ["onClick"]))), 128)), ])) : Ml("", !0), ])
};
const eb = Ze({
    id: "0",
    is(e$) {
    ...
    getNickname(e$) {
        var e0;
        return null != (e0 = localStorage.getItem("tor:nickname:" + e$)) ? e0 : "Usu\xe1rio " + e$
    },
    setNickname(e$, e0) {
...
An(() => So.backend.tor_subscribe(eb.groups)), So.pusher.on("TOR_MESSAGE", e$ => {
    ...
    e0 != eb.id && e$.channel.startsWith("dm:") && !eb.direct.includes(e0) && eb.direct.unshift(e0)
});
const tb = {
        components: {
            Page: Bh
        ...
        setup() {
            let e$ = cc(),
                e0 = rt([]);
            return So.backend.tor_blocked().then(e0 => {
                e0 && (e$.replace("/home"), So.alert(e0))
            }), So.backend.tor_resume(eb.direct).then(e$ => {
                e0.value = Object.entries(e$).map(([e$, e0]) => ({
                    id: e$,
                    name: eb.getNickname(e$),
                    avatarURL: `https://avatars.dicebear.com/api/identicon/${e$}.svg`,
                    message: e0
                })).sort((e$, e0) => e$.message && e0.message ? e$.message.created_at > e0.message.created_at ? -1 : 1 : e$.message == e0.message ? 0 : e$.message ? -1 : 1)
                ...
                search: function () {
                    So.prompt("Digite o id do usu\xe1rio").then(e0 => {
                        (e0 = null == e0 ? void 0 : e0.trim()) && (e0.match(/^\d+$/) ? e$.push("/tor/" + e0) : So.alert("Usu\xe1rio inv\xe1lido"))
                    })
                }
            }
        }
...
tb.render = function (e$, e0, e8, e2, e3, e1) {
    ...
    return wl(), _l(e6, {
        ...
        header: en(() => [nb]),
        default: en(() => [Pl("ul", null, [(wl(!0), _l(bl, null, fa(e2.users, e0 => (wl(), _l("li", {
            key: e0.id,
            ...
            src: e0.avatarURL
        }, null, 8, ["src"]), Pl("div", lb, [Pl("div", ab, [Pl("h1", sb, g(e0.name), 1), e0.message ? (wl(), _l("h1", ob, g(e$.$filters.unixToRelative(e0.message.created_at)), 1)) : Ml("", !0), ]), e0.message ? (wl(), _l("p", rb, [e0.message.location ? (wl(), _l("span", ib, "\uD83C\uDF0E Localiza\xe7\xe3o")) : e0.message.image ? (wl(), _l("span", cb, "📷 Foto")) : (wl(), _l("span", ub, g(e0.message.content), 1)), ])) : (wl(), _l("p", db, "Nenhuma mensagem...")), ]), ], 8, ["onClick"]))), 128)), ]), Pl("button", {
            onClick: e0[1] || (e0[1] = (...e$) => e2.search && e2.search(...e$)),
            ...
            return So.backend.tor_resume(eb.groups, !0).then(e$ => {
                ...
                search: function () {
                    So.prompt("Digite o nome do grupo").then(e0 => {
                        (e0 = null == e0 ? void 0 : e0.trim()) && (e0.match(/^[\w-.]+$/) ? e$.push("/tor/" + e0) : So.alert("Grupo inv\xe1lido"))
                    })
                }
            }
        }
...
fb.render = function (e$, e0, e8, e2, e3, e1) {
    ...
    return wl(), _l(e6, {
        ...
        header: en(() => [mb]),
        default: en(() => [Pl("ul", null, [(wl(!0), _l(bl, null, fa(e2.groups, e0 => (wl(), _l("li", {
            key: e0,
            onClick: e8 => e$.$router.push("/tor/" + e0.id),
            class: "p-5 flex items-start text-white hover:bg-gray-900"
        }, [hb, Pl("div", bb, [Pl("div", gb, [Pl("h1", vb, "#" + g(e0.id), 1), e0.message ? (wl(), _l("h1", xb, g(e$.$filters.unixToRelative(e0.message.created_at)), 1)) : Ml("", !0), ]), e0.message ? (wl(), _l("p", yb, [e0.message.location ? (wl(), _l("span", kb, "\uD83C\uDF0E Localiza\xe7\xe3o")) : e0.message.image ? (wl(), _l("span", wb, "📷 Foto")) : (wl(), _l("span", Cb, g(e0.message.content), 1)), ])) : (wl(), _l("p", _b, "Nenhuma mensagem...")), ]), ], 8, ["onClick"]))), 128)), ]), Pl("button", {
            onClick: e0[1] || (e0[1] = (...e$) => e2.search && e2.search(...e$)),
            class: "absolute bottom-40 right-8 w-24 h-24 bg-tor text-white rounded-full"
        }, [Ab]), ]),
        _: 1
...
const Sb = {
        ...
        setup() {
            let e$ = uc(),
                ...
                e3 = da(() => e8 ? eb.groups.includes(e0.value) : eb.direct.includes(e0.value)),
                e1 = e$.params.id,
                e6 = rt(""),
                e4 = rt([]),
                e7 = da(() => {
                    let e$ = [],
                        e0;
                    for (let e8 of e4.value)(null == e0 ? void 0 : e0[0].sender) != e8.sender ? e$.push(e0 = [e8]) : e0.push(e8);
                    return e$
                });

            function e5(e$) {
                var e0;
                !0 !== e$ && e6.value || null == (e0 = document.querySelector(".overflow-y-auto")) || e0.scrollTo({
                    top: 9e6,
                    behavior: e$ ? "auto" : "smooth"
                })
            }
            async function eV(e$, e0) {
                (e$ || e0 || e6.value) && (So.backend.tor_send(e8 ? e1 : parseInt(e1), e6.value, e$, e0), e6.value = "")
            }
            return So.backend.tor_messages(e8 ? e1 : parseInt(e1)).then(e$ => {
                for (let e0 of e$) try {
                ...
                e4.value.find(e0 => e0.id == e$.id) || e8 && e$.channel != e0.value || (e8 || e$.sender == e0.value || e$.sender == eb.id) && (e4.value.push(e$), Lt(e5))
            }), {
                state: eb,
                input: e6,
                messages: e4,
                ...
                addAttachment: async function () {
                    let e$ = ["camera", "gallery", "location"];
                    So.settings.allowUnsafeURL && e$.splice(2, 0, "image"), e8 || So.isDisabled("tor-payments") || e$.push("payment");
                    let e2 = await go().request([
                        ...
                        ["Localiza\xe7\xe3o", "text-blue-500 text-center"], e$.includes("payment") && ["Pagamento", "text-blue-500 text-center", ],
                    ], 7 * e$.length);
                    try {
                        switch (e$[e2]) {
                        case "camera":
                        ...
                        case "payment":
                            ...
                            e1 > 0 && So.lockAndProceed(() => So.backend.tor_pay(parseInt(e0.value), e1).then(e$ => {
                ...
                changeNickname: function () {
                    So.prompt("Insira o apelido", 12).then(e$ => {
                        ...
                        e8 && e8.length <= 12 && (eb.setNickname(e0.value, e8), e2.value = e8)
                    })
                }
            }
        }
...
const zb = Tb((e$, e0, e8, e2, e3, e1) => {
    ...
    return wl(), _l(e6, {
        ...
        header: Tb(() => [Pl("div", Eb, [e2.isGroup ? (wl(), _l("div", Rb, [Pb])) : (wl(), _l("img", {
            key: 1,
            class: "w-12 h-12 bg-white rounded-full mr-4",
            src: `https://avatars.dicebear.com/api/identicon/${e$.$route.params.id}.svg`
        }, null, 8, ["src"])), Pl("h1", null, g(e2.nickname), 1), Pl("div", Lb, [e2.isGroup ? Ml("", !0) : (wl(), _l("button", {
            key: 0,
            class: "mr-2 px-2",
            onClick: e0[1] || (e0[1] = (...e$) => e2.changeNickname && e2.changeNickname(...e$))
        }, [Ib])), Pl("button", {
            class: "mr-4 px-2",
            onClick: e0[2] || (e0[2] = (...e$) => e2.togglePinned && e2.togglePinned(...e$))
        }, [e2.isPinned ? (wl(), _l("i", Ob)) : (wl(), _l("i", Mb))]), ]), ]), ]),
        footer: Tb(() => [Pl("div", $b, [Zn(Pl("input", {
            "onUpdate:modelValue": e0[5] || (e0[5] = e$ => e2.input = e$),
            onKeydown: e0[6] || (e0[6] = us(e$ => e2.addMessage(), ["enter"])),
        ...
        ]), e2.input ? (wl(), _l("button", {
            key: 0,
            onClick: e0[7] || (e0[7] = e$ => e2.addMessage()),
            class: "p-4 text-gray-500"
        }, [jb])) : (wl(), _l("button", {
            key: 1,
            onClick: e0[8] || (e0[8] = (...e$) => e2.addAttachment && e2.addAttachment(...e$)),
            class: "p-4 text-gray-500"
        }, [Fb])), ]), ]),
        default: Tb(() => [(wl(!0), _l(bl, null, fa(e2.blocks, (e8, e3) => (wl(), _l("ul", {
            key: e3,
            class: "p-4"
        }, [Pl("li", {
            class: ["flex", {
        ...
        }, [e2.state.is(e8[0]) ? Ml("", !0) : (wl(), _l("img", {
            key: 0,
            class: "w-16 h-16 bg-white rounded-full",
            src: `https://avatars.dicebear.com/api/identicon/${e8[0].sender}.svg`
        }, null, 8, ["src"])), Pl("ul", {
            class: ["flex flex-col items-start w-full", e8[0].sender == e2.state.id ? "mr-4" : "ml-4", ]
        }, [!e2.state.is(e8[0]) && e2.isGroup ? (wl(), _l("li", Vb, [Pl("button", {
            onClick: e0 => e$.$router.push("/tor/" + e8[0].sender)
        }, "Usu\xe1rio " + g(e8[0].sender), 9, ["onClick"]), ])) : Ml("", !0), (wl(!0), _l(bl, null, fa(e8, e8 => {
            var e3;
            return wl(), _l("li", {
                key: e8.id,
                class: ["message p-2 rounded text-3xl text-white mb-1.5", [e8.sender == e2.state.id ? "ml-auto bg-tor" : "bg-gray-800", ], ]
            }, [e8.image ? (wl(), _l("img", {
                key: 0,
                class: "w-full rounded",
                onLoad: e0[3] || (e0[3] = (...e$) => e2.ajustSize && e2.ajustSize(...e$)),
                src: e8.image
            }, null, 40, ["src"])) : e8.location ? (wl(), _l("img", {
                key: 1,
...
const Bb = {
        ...
        setup() {
            let e$ = cc(),
                ...
                e2 = jl("useImageFocus");
            return So.backend.tor_ads().then(e$ => e0.value = e$), {
                state: eb,
                create: function () {
...
Bb.render = function (e$, e0, e8, e2, e3, e1) {
    let e6 = dl("Page");
    return wl(), _l(e6, null, {
        header: en(() => [Hb]),
        default: en(() => [Pl("ul", qb, [(wl(!0), _l(bl, null, fa(e2.ads, e0 => (wl(), _l("li", {
            key: e0.id,
            ...
            alt: ""
        }, null, 8, ["src"]), Pl("div", Gb, [Pl("div", Wb, [Pl("h1", Kb, g(e0.title), 1), e2.moderator || e2.state.id == e0.anom_id ? (wl(), _l("button", {
            key: 0,
            onClick: e$ => e2.destroy(e0.id)
        }, [Jb], 8, ["onClick"])) : Ml("", !0), ]), Pl("p", Xb, g(e0.description), 1), e0.image ? (wl(), _l("img", {
            key: 0,
            class: "h-64 mb-4 mx-auto",
            onClick: e$ => e2.focusImage(e0.image),
            src: e0.image
        }, null, 8, ["onClick", "src"])) : Ml("", !0), Pl("p", Yb, "Autor: " + g(e0.anom_id), 1), Pl("button", {
            onClick: e8 => e$.$router.push(`/tor/${e0.anom_id}`),
            class: "font-bold"
        }, [Zb, Qb], 8, ["onClick"]), ]), ]))), 128)), ]), Pl("button", {
            onClick: e0[1] || (e0[1] = (...e$) => e2.create && e2.create(...e$)),
            class: "absolute bottom-40 right-8 w-24 h-24 bg-tor text-white rounded-full"
        }, [eg]), ]),
        _: 1
    })
...
const ug = lg((e$, e0, e8, e2, e3, e1) => {
    ...
    return wl(), _l(e6, {
        ...
        default: lg(() => [Pl("div", sg, [og, Zn(Pl("input", {
            "onUpdate:modelValue": e0[1] || (e0[1] = e$ => e2.form.title = e$),
            tabindex: "1"
        }, null, 512), [
            [ns, e2.form.title, void 0, {
                trim: !0
            }]
        ]), rg, Zn(Pl("input", {
            "onUpdate:modelValue": e0[2] || (e0[2] = e$ => e2.form.description = e$),
            tabindex: "1"
        }, null, 512), [
            [ns, e2.form.description, void 0, {
                trim: !0
            }]
        ]), ig, e2.form.image ? (wl(), _l("img", {
            key: 0,
...
const dg = {
        ...
        setup() {
            let e$ = rt([]);
            return So.backend.tor_payments().then(e0 => {
                e0.forEach(e$ => {
...
dg.render = function (e$, e0, e8, e2, e3, e1) {
    ...
    return wl(), _l(e6, null, {
        header: en(() => [pg]),
        default: en(() => [Pl("ul", fg, [(wl(!0), _l(bl, null, fa(e2.payments, e0 => (wl(), _l("li", {
            key: e0.id,
            class: ["flex items-start text-white text-xl mb-4", [e0.sending ? "flex-row-reverse" : ""], ]
        }, [Pl("img", {
            class: "w-14 h-14 rounded-full bg-white",
            src: `https://avatars.dicebear.com/api/identicon/${e0.sending?e0.target:e0.sender}.svg`,
            alt: ""
        }, null, 8, ["src"]), Pl("div", {
            class: ["rounded flex-1 p-3", [e0.sending ? "bg-tor mr-4" : "bg-gray-800 ml-4"], ]
        }, [Pl("h1", mg, [e0.sending ? (wl(), _l("span", hg, "Voc\xea enviou " + g(e$.$filters.intToMoney(e0.amount)) + " para @" + g(e0.target), 1)) : (wl(), _l("span", bg, "Voc\xea recebeu " + g(e$.$filters.intToMoney(e0.amount)) + " de @" + g(e0.sender), 1)), ]), ], 2), ], 2))), 128)), ]), ]),
        _: 1
    })
};
const gg = {
    profile: Ze(So.localhost ? {
        ...
        verified: 1,
        avatarURL: "http://45.40.99.23/apps/0af557b7-83c5-4c8d-894e-30a0d224df21.jpg"
    } : {}),
    stories: rt([]),
    storiesSeen: {},
    addStory(e$) {
    ...
    remStory(e$) {
        ...
        e8 && (e0.splice(e0.indexOf(e8), 1), delete this.storiesSeen[e8.author.username], this.sortStory())
    },
    showProfileMap(e$) {
        go().clearAndRequest(Object.entries(e$).map(([e$, e0]) => ({
            key: e$,
            html: `
    ...
    sortStory() {
        this.stories.value.sort((e$, e0) => {
            ...
            return e$.author.username == e0.author.username ? 0 : e$.author.username == this.profile.username ? -1 : e0.author.username == this.profile.username ? 1 : e8 != e2 ? e8 ? 1 : -1 : e$.author.username.localeCompare(e0.author.username)
        })
    },
    async loadStories() {
...
vg.render = function (e$, e0, e8, e2, e3, e1) {
    return wl(), _l("div", xg, [Pl("img", {
        ...
        class: ["far", e2.notifications ? "fa-bell" : "fa-bell-slash", "w-12", ]
    }, null, 2), ]), ])
};
const kg = {
        setup() {
...
kg.render = function (e$, e0, e8, e2, e3, e1) {
    ...
    return wl(), _l(bl, null, [wg, Pl("div", Cg, [Pl("button", {
        onClick: e0[1] || (e0[1] = e0 => e$.$router.replace("/instagram"))
    }, [_g, "/instagram" === e$.$route.path ? (wl(), _l("div", Ag)) : Ml("", !0), ]), Pl("button", {
        onClick: e0[2] || (e0[2] = e0 => e$.$router.replace("/instagram/search"))
    }, [Sg, "/instagram/search" === e$.$route.path ? (wl(), _l("div", Tg)) : Ml("", !0), ]), Pl("button", {
        onClick: e0[3] || (e0[3] = (...e$) => e2.createPost && e2.createPost(...e$))
    }, [Eg, "/instagram/create" === e$.$route.path ? (wl(), _l("div", Rg)) : Ml("", !0), ]), Pl("button", {
        onClick: e0[4] || (e0[4] = e0 => e$.$router.replace("/instagram/notifications"))
    }, [Pg, "/instagram/notifications" === e$.$route.path ? (wl(), _l("div", Lg)) : Ml("", !0), ]), Pl("button", {
        onClick: e0[5] || (e0[5] = e0 => e$.$router.replace("/instagram/profiles/" + e2.profile.username)),
        class: "mx-auto"
    }, [Pl("img", {
...
Ig.render = function (e$, e0, e8, e2, e3, e1) {
    let e6 = dl("Header"),
        e4 = dl("app-input"),
        e7 = dl("Bottom");
    return wl(), _l(bl, null, [Pl(e6), Pl("div", Og, [e2.image ? (wl(), _l("div", Mg, [Pl("img", {
        class: "max-h-96 rounded-xl mx-auto",
        src: e2.image
    }, null, 8, ["src"]), Pl("div", Vg, [Dg, Pl(e4, {
        ...
        onClick: e0[2] || (e0[2] = (...e$) => e2.publish && e2.publish(...e$)),
        class: "mt-5 bg-blue-500 p-3 text-white w-full rounded-xl"
    }, " Publicar "), ]), ])) : Ml("", !0), ]), Pl(e7), ], 64)
};
const Ug = {
        props: ["post"],
        setup(e$) {
            let e0 = e$.post,
                ...
                e7 = da(() => gg.stories.value.some(e$ => e$.author.username == e0.author.username));

            function e5() {
                e5.lastLike > Date.now() || (e5.lastLike = Date.now() + 667, So.backend.ig_setLike(e0.id, !e0.likes.includes(e2.id)))
            }
            return e5.lastLike = 0, e4 ? (Tn(e0.comments, () => Lt(() => {
                ...
                e$ == e0.id && (e2 ? e0.likes.push(e8) : e0.likes = e0.likes.filter(e$ => e$ != e8))
                ...
                reply: function () {
                    var e$;
                    (null == (e$ = e8.value) ? void 0 : e$.trim()) && (So.backend.ig_reply(e0.id, e8.value), e8.value = "")
                },
                like: e5,
                showOptions: async function () {
                    let e$ = {};
                    (e0.profile_id == e2.id || So.identity.moderator) && (e$.delete = "Excluir publica\xe7\xe3o"), e0.profile_id != e2.id && (!So.localhost && await So.backend.ig_isFollowing(e0.profile_id) ? e$.unfollow = "Deixar de seguir" : e$.follow = "Seguir"), e0.likes.includes(e2.id) ? e$.dislike = "Descurtir" : e$.like = "Curtir", e$.likes = "Ver curtidas", go().request(e$, 33).then(e$ => {
                        switch (e$) {
                        case "delete":
                            So.backend.ig_deletePost(e0.id);
                            break;
                        case "likes":
                            So.backend.ig_getLikes(e0.id).then(e$ => gg.showProfileMap(e$));
                            break;
                        case "like":
...
const ov = $g((e$, e0, e8, e2, e3, e1) => {
    ...
    return wl(), _l("div", jg, [Pl("div", Fg, [Pl("div", {
        ...
        class: "ml-5",
        onClick: e0[1] || (e0[1] = e0 => e$.$router.replace("/instagram/profiles/" + e8.post.author.username))
    }, g(null != (e6 = e8.post.author.name) ? e6 : e8.post.author.username), 1), (null == (e4 = e8.post.author) ? void 0 : e4.verified) ? (wl(), _l(e7, {
        key: 0,
        class: "ml-3 w-8 h-8"
    })) : Ml("", !0), Pl("button", {
        ...
        onClick: e0[3] || (e0[3] = (...e$) => e2.handleImageClick && e2.handleImageClick(...e$)),
        loading: "lazy",
        src: e8.post.image,
        alt: ""
    }, null, 8, ["src"]), Pl("div", Bg, [Pl("button", {
        onClick: e0[4] || (e0[4] = e$ => e2.like(e8.post.id))
    }, [e8.post.likes.includes(e2.profile.id) ? (wl(), _l("i", qg)) : (wl(), _l("i", Hg)), Il(" " + g(e8.post.likes.length.toLocaleString("pt-BR")), 1), ]), Pl("button", {
        class: "ml-5",
        onClick: e0[5] || (e0[5] = e0 => e$.$router.push("/instagram/posts/" + e8.post.id))
    }, [Gg, Array.isArray(e8.post.comments) ? (wl(), _l("span", Wg, g(e8.post.comments.length.toLocaleString("pt-BR")), 1)) : (wl(), _l("span", Kg, g(e8.post.comments.toLocaleString("pt-BR")), 1)), ]), Pl("span", Jg, g(e$.$filters.unixToDayOfMonth(e8.post.created_at)), 1), ]), Array.isArray(e8.post.comments) ? (wl(), _l("ul", Xg, [e8.post.content ? (wl(), _l("li", Yg, [Pl("b", Zg, g(e8.post.author.username), 1), Pl("span", Qg, g(e8.post.content), 1), ])) : Ml("", !0), (wl(!0), _l(bl, null, fa(e8.post.comments, (e$, e0) => (wl(), _l("li", {
        key: e0
    }, [Pl("b", ev, g(e$.author.username), 1), Pl("span", tv, g(e$.content), 1), ]))), 128)), ])) : e8.post.content ? (wl(), _l("div", nv, [Pl("b", lv, g(e8.post.author.username), 1), Pl("span", av, g(e8.post.content), 1), ])) : Ml("", !0), Array.isArray(e8.post.comments) ? (wl(), _l("div", sv, [Zn(Pl("input", {
        type: "text",
        maxlength: "255",
        class: "w-full bg-theme pr-5",
        "onUpdate:modelValue": e0[6] || (e0[6] = e$ => e2.comment = e$),
        onKeydown: e0[7] || (e0[7] = us((...e$) => e2.reply && e2.reply(...e$), ["enter"])),
        placeholder: "Adicione um coment\xe1rio"
    }, null, 544), [
        [ns, e2.comment]
    ]), Pl("button", {
        class: [e2.comment ? "text-blue-500" : "text-blue-200"],
        onClick: e0[8] || (e0[8] = (...e$) => e2.reply && e2.reply(...e$))
    }, "Post", 2), ])) : Ml("", !0), ])
});
...
const rv = {
        setup() {
            let e$ = cc(),
                ...
                e8 = rt(0),
                e2 = rt(e0.params.id),
                e3 = da(() => gg.stories.value.filter(e$ => e$.author.username == e2.value)),
                e1 = da(() => e3.value[e8.value]),
                e6 = gg.stories.value.map(e$ => e$.author.username).filter(qs),
                e4 = da(() => e2.value === gg.profile.username || So.identity.moderator);
            ...
            return Tn(e2, e0 => e$.replace("/instagram/stories/" + e0)), {
                index: e8,
                stories: e3,
                current: e1,
                next: function (e$ = 1) {
                    if (e$ < 0) return function () {
                        if (0 == e8.value) {
                            let e$ = e6.indexOf(e2.value) - 1; - 1 != e$ && e7(e6[e$])
                        } else e8.value -= 1
                    }();
                ...
                destroy: async function () {
                    ...
                    e1 && So.backend.ig_deleteStory(e1.id).then(() => {
                        (1 == e2 || e0 >= e2 - 1) && e5()
                    })
                },
                canDestroy: e4
...
const gv = iv((e$, e0, e8, e2, e3, e1) => {
    ...
    }, [uv]), Pl("span", dv, [Il(g(e$.$route.params.id.substr(0, 16)) + " ", 1), (null == (e6 = e2.stories[e2.index]) ? void 0 : e6.author.verified) ? (wl(), _l(e5, {
        key: 0,
        class: "inline w-8 h-8"
    })) : Ml("", !0), ]), e2.canDestroy ? (wl(), _l("button", {
        key: 0,
        onClick: e0[2] || (e0[2] = (...e$) => e2.destroy && e2.destroy(...e$)),
    ...
    }, null, 4), e2.current.video ? (wl(), _l("video", {
        key: 0,
    ...
    }), (null == (e4 = e2.stories[e2.index]) ? void 0 : e4.content) ? (wl(), _l("h1", fv, g(null == (e7 = e2.stories[e2.index]) ? void 0 : e7.content), 1)) : Ml("", !0), Pl("div", mv, [(wl(!0), _l(bl, null, fa(e2.stories, (e$, e0) => (wl(), _l("div", {
        key: e0,
        class: "mr-2 last:mr-0"
    }, [e0 == e2.index ? (wl(), _l("div", hv)) : (wl(), _l("div", bv)), ]))), 128)), ]), ])
});
...
const vv = {
        ...
        setup() {
            ...
            return Tn(e6, e$ => So.setNotificationFor("instagram", e$)), So.backend.ig_getTimeline().then(e$ => {
                ...
                let e0 = e8.findIndex(e0 => e0.id == e$); - 1 != e0 && e8.splice(e0, 1)
                ...
                createStory: async function () {
                    try {
                        let e8 = await go().request([
                            ...
                            e2, e1 = "";
                        0 == e8 ? ([e2, thumbnail] = await e0(), e1 = await to.upload(thumbnail, "jpg")) : e1 = 1 == e8 ? await e3.request(!1, "/instagram") : 2 == e8 ? await fo() : await So.promptImageURL();
...
vv.render = function (e$, e0, e8, e2, e3, e1) {
    let e6 = dl("Header"),
        e4 = dl("Post"),
        e7 = dl("NavBar");
    return wl(), _l("div", xv, [Pl(e6), Pl("div", yv, [Pl("ul", kv, [e2.stories[e2.profile.username] ? Ml("", !0) : (wl(), _l("li", wv, [Pl("div", Cv, [Pl("img", {
        class: "w-28 h-28 p-1 rounded-full",
        src: e2.profile.avatarURL
    }, null, 8, ["src"]), Pl("button", {
        onClick: e0[1] || (e0[1] = is((...e$) => e2.createStory && e2.createStory(...e$), ["stop"])),
        class: [e2.dark ? "border-black" : "border-white", "absolute bottom-1 right-1 border-2 bg-lightBlue-600 w-8 h-8 rounded-full text-white flex flex-center", ]
    }, [_v], 2), ]), Av, ])), (wl(!0), _l(bl, null, fa(e2.stories, (e8, e3) => (wl(), _l("li", {
        class: "ml-1 last:pr-1 flex-shrink-0",
        key: e3
    }, [Pl("div", {
        class: ["w-28 flex flex-center rounded-full relative", {
            "bg-instagram": !e8.seen || e2.profile.username == e3
        }, ],
        onClick: e0 => e$.$router.push("/instagram/stories/" + e3)
    }, [Pl("img", {
        class: "w-28 h-28 p-1 rounded-full",
        src: e8[0].image
    }, null, 8, ["src"]), e2.profile.username == e3 ? (wl(), _l("button", {
        key: 0,
        class: [e2.dark ? "border-black" : "border-white", "absolute bottom-1 right-1 border-2 bg-lightBlue-600 w-8 h-8 rounded-full text-white flex flex-center", ],
        onClick: e0[2] || (e0[2] = is((...e$) => e2.createStory && e2.createStory(...e$), ["stop"]))
    }, [Sv], 2)) : Ml("", !0), ], 10, ["onClick"]), Pl("h1", Tv, g(e2.profile.username == e3 ? "Seu story" : e3), 1), ]))), 128)), ]), Pl("ul", null, [(wl(!0), _l(bl, null, fa(e2.posts, e$ => (wl(), _l("li", {
        postid: e$.id,
        key: e$.id
    }, [Pl(e4, {
        post: e$
    }, null, 8, ["post"])], 8, ["postid"]))), 128)), ]), ]), Pl(e7), ])
};
const Ev = {
        setup() {
            jl("setDark")();
            ...
            return So.backend.ig_accounts().then(async e2 => {
                e8.value = e2, e0.value = await So.backend.ig_max_accounts(), e$.value = !1
                ...
                login: async function (e$) {
                    ...
                    e0 && (Object.assign(gg.profile, e0), gg.loadStories(), VO.replace("/instagram"))
                },
                isLoading: e$
            }
        }
...
Ev.render = function (e$, e0, e8, e2, e3, e1) {
    return e2.isLoading ? (wl(), _l("div", Rv)) : (wl(), _l("div", Pv, [Pl("div", Lv, [Pl("img", {
        class: "h-16 mx-auto",
        src: e2.logo,
        style: {
            filter: "invert(" + (e2.dark ? 1 : 0) + ")"
        }
    }, null, 12, ["src"]), ]), Pl("ul", Iv, [(wl(!0), _l(bl, null, fa(e2.accounts, e$ => {
        var e0;
        return wl(), _l("li", {
            ...
            src: e$.avatarURL
        }, null, 8, ["src"]), Pl("div", Ov, [Pl("h1", Mv, g(null != (e0 = e$.name) ? e0 : e$.username), 1), Pl("h3", Vv, "@" + g(e$.username), 1), ]), Pl("button", {
            onClick: e0 => e2.login(e$.id),
            class: "ml-auto bg-blue-500 rounded-xl text-white text-lg p-2 px-4"
        }, "Login", 8, ["onClick"]), ])
    }), 128)), ]), e2.max > e2.accounts.length ? (wl(), _l("div", {
        key: 0,
        class: ["text-center", {
            "my-auto": !e2.accounts.length
        }]
    }, [Pl("button", {
        onClick: e0[1] || (e0[1] = e0 => e$.$router.replace("/instagram/register")),
        ...
        setup() {
            ...
            return {
                ...
                createAccount: function () {
                    var e0;
                    if (["register", "search", "create", "liked", "stories"].includes(null == (e0 = Uv.value) ? void 0 : e0.toLowerCase())) return e$("Este nome n\xe3o pode ser utilizado");
                    Dv.value ? So.backend.ig_register(Nv.value, Uv.value, $v.value, Dv.value).then(e0 => {
                        if (e0.error) e$(e0.error);
                        else
                            for (let e8 of (VO.replace("/instagram/login"), [Dv, Nv, Uv, $v])) e8.value = ""
...
jv.render = function (e$, e0, e8, e2, e3, e1) {
    ...
    return wl(), _l("div", Fv, [Pl("div", zv, [Pl("img", {
        ...
        onClick: e0[1] || (e0[1] = (...e$) => e2.takeSelfie && e2.takeSelfie(...e$)),
        class: "rounded-full w-64 h-64 p-1",
        src: e2.avatarURL || e$.$asset("stock/user.jpg")
    }, null, 8, ["src"]), ]), Hv, e2.avatarURL ? (wl(), _l("div", qv, [Pl("div", Gv, [Wv, Pl(e6, {
        maxlength: "32",
        modelValue: e2.name,
        "onUpdate:modelValue": e0[2] || (e0[2] = e$ => e2.name = e$),
        class: "text-3xl bg-theme border-theme"
    }, null, 8, ["modelValue"]), ]), Pl("div", Kv, [Jv, Pl(e6, {
        maxlength: "24",
        modelValue: e2.username,
        "onUpdate:modelValue": e0[3] || (e0[3] = e$ => e2.username = e$),
        class: "text-3xl bg-theme border-theme"
    }, null, 8, ["modelValue"]), ]), Pl("div", Xv, [Yv, Pl(e6, {
        maxlength: "255",
        modelValue: e2.bio,
        "onUpdate:modelValue": e0[4] || (e0[4] = e$ => e2.bio = e$),
        class: "text-3xl bg-theme border-theme"
    }, null, 8, ["modelValue"]), ]), Pl("div", Zv, [Pl("button", {
        onClick: e0[5] || (e0[5] = (...e$) => e2.createAccount && e2.createAccount(...e$)),
...
Qv.render = function (e$, e0, e8, e2, e3, e1) {
    let e6 = dl("Header"),
        ...
        e7 = dl("app-verified"),
        e5 = dl("nav-bar");
    return wl(), _l("div", ex, [Pl(e6), Pl("div", tx, [Pl("div", nx, [lx, Pl(e4, {
        class: "bg-theme text-2xl border-theme pl-12",
        modelValue: e2.query,
        "onUpdate:modelValue": e0[1] || (e0[1] = e$ => e2.query = e$),
        placeholder: "Nome de usu\xe1rio"
    }, null, 8, ["modelValue"]), ]), ]), e2.query && !e2.profiles ? (wl(), _l("h1", ax, "Nenhum resultado encontrado")) : (wl(), _l("ul", sx, [(wl(!0), _l(bl, null, fa(e2.profiles, e0 => (wl(), _l("li", {
        key: e0.id,
        onClick: e8 => e$.$router.push("/instagram/profiles/" + e0.username),
        class: "flex items-center mb-2 last:mb-0"
    }, [Pl("div", ox, [Pl("img", {
        src: e0.avatarURL,
        class: "p-0.5 w-24 h-24 rounded-full"
    }, null, 8, ["src"]), ]), Pl("span", null, g(e0.username), 1), e0.verified ? (wl(), _l(e7, {
        key: 0,
        class: "w-8 h-8 ml-3 mt-2"
    })) : Ml("", !0), ], 8, ["onClick"]))), 128)), ])), Pl(e5), ])
};
const rx = {
        components: {
            Header: vg,
        ...
        setup() {
            ...
            let e$ = rt(!1),
                e0 = rt([]);
            return So.backend.ig_notifications().then(e8 => {
...
rx.render = function (e$, e0, e8, e2, e3, e1) {
    let e6 = dl("Header"),
        e4 = dl("app-loading"),
        e7 = dl("nav-bar");
    return wl(), _l("div", ix, [Pl(e6), e2.loading ? (wl(), _l("div", cx, [Pl(e4, {
        style: {
            filter: "invert(1)"
        }
    })])) : e2.notifications.length ? (wl(), _l("ul", dx, [(wl(!0), _l(bl, null, fa(e2.notifications, e0 => {
        var e8;
        return wl(), _l("li", {
            key: e0.id,
            ...
            src: null != (e8 = e0.avatarURL) ? e8 : e$.$asset("apps/user.svg")
        }, null, 8, ["src"]), Pl("p", px, [Il(g(e0.content) + " ", 1), Pl("span", fx, g(e$.$filters.unixToRelative(e0.created_at)), 1), ]), ])
    }), 128)), ])) : (wl(), _l("h1", ux, "Nenhuma notifica\xe7\xe3o")), Pl(e7), ])
};
const mx = {
        components: {
            Header: vg,
        ...
        setup() {
            ...
            return {
                ...
                changeAvatar: async function () {
                    try {
                        let e$ = await So.useAnyImage("/instagram", !0);
                        e0.avatarURL = e8.avatarURL = e$, gg.profile.avatarURL = e$, So.backend.ig_changeAvatar(e$)
                    } catch (e2) {}
                },
                hasChanges: e2,
                save: function () {
                    So.backend.ig_updateProfile({
                        ...
                        if (null == e2 ? void 0 : e2.error) e$(e2.error);
                            ...
                            for (let e3 of gg.stories.value) e3.author.username == e0.username && (e3.author.username = e8.username);
                            gg.sortStory(), Object.assign(e0, e8), Object.assign(gg.profile, e8)
                        }
                    })
                }
            }
...
mx.render = function (e$, e0, e8, e2, e3, e1) {
    let e6 = dl("Header"),
        e4 = dl("Bottom");
    return wl(), _l("div", hx, [Pl(e6), Pl("div", bx, [Pl("img", {
        ...
        "onUpdate:modelValue": e0[2] || (e0[2] = e$ => e2.profile.name = e$),
        maxlength: "32",
        class: "block w-full bg-transparent p-1 border-b border-theme"
    }, null, 512), [
        [ns, e2.profile.name]
    ]), ]), Pl("div", xx, [yx, Zn(Pl("input", {
        "onUpdate:modelValue": e0[3] || (e0[3] = e$ => e2.profile.username = e$),
        maxlength: "24",
        class: "block w-full bg-transparent p-1 border-b border-theme"
    }, null, 512), [
        ...
        maxlength: "255",
        "onUpdate:modelValue": e0[4] || (e0[4] = e$ => e2.profile.bio = e$),
        class: "block w-full bg-transparent p-1 border-b border-theme"
    }, null, 512), [
        [ns, e2.profile.bio]
    ]), ]), e2.hasChanges ? (wl(), _l("button", {
        key: 0,
...
const Ax = {
        ...
        setup() {
            ...
            function e2(e$) {
                e2.last > Date.now() || (e2.last = Date.now() + 1e3, So.backend.ig_setFollow(e0.value.id, e$).then(() => {
                    e0.value.isFollowed = e$, e0.value.followers += e$ ? 1 : -1
                }))
            }
            return So.backend.ig_getProfile(e$.params.id).then(e$ => {
                e$ ? (e$.profile.isYou = e$.profile.id == gg.profile.id, e0.value = e$.profile, e0.value.hasStory = gg.stories.value.some(e0 => e0.author.username == e$.profile.username), e8.push(...e$.posts)) : e0.value = !1
            }), e2.last = 0, So.onceRoute("INSTAGRAM_DESTROY", e$ => {
                let e0 = e8.findIndex(e0 => e0.id == e$); - 1 != e0 && e8.splice(e0, 1)
            }), {
                profile: e0,
                posts: e8,
                ...
                getFollowers: function () {
                    So.backend.ig_getFollowers(e0.value.id).then(e$ => gg.showProfileMap(e$))
                },
                getFollowing: function () {
                    So.backend.ig_getFollowing(e0.value.id).then(e$ => gg.showProfileMap(e$))
                }
            }
        }
    },
...
Ax.render = function (e$, e0, e8, e2, e3, e1) {
    ...
    let e4 = dl("Header"),
        e7 = dl("app-verified"),
        e5 = dl("Bottom");
    return wl(), _l("div", Sx, [Pl(e4), !1 === e2.profile ? (wl(), _l("h1", Tx, "Perfil n\xe3o encontrado")) : e2.profile ? (wl(), _l("div", Ex, [Pl("div", Rx, [Pl("div", Px, [Pl("div", {
        class: ["w-28 h-28", {
    ...
    }, null, 8, ["src"]), ], 2), Pl("div", Lx, [Pl("div", Ix, [Pl("span", Ox, g(e2.profile.posts || 0), 1), Mx, ]), Pl("div", {
        class: "text-center text-2xl",
        onClick: e0[1] || (e0[1] = (...e$) => e2.getFollowers && e2.getFollowers(...e$))
    }, [Pl("span", Vx, g(e2.profile.followers || 0), 1), Dx]), Pl("div", {
        class: "text-center text-2xl",
        onClick: e0[2] || (e0[2] = (...e$) => e2.getFollowing && e2.getFollowing(...e$))
    }, [Pl("span", Nx, g(e2.profile.following || 0), 1), Ux]), ]), ]), Pl("div", $x, [Pl("h1", jx, [Il(g(null != (e6 = e2.profile.name) ? e6 : e2.profile.username) + " ", 1), e2.profile.verified ? (wl(), _l(e7, {
        key: 0,
        class: "inline ml-1 mb-0.5 w-6 h-6"
    })) : Ml("", !0), ]), Pl("p", null, g(e2.profile.bio), 1), ]), Pl("div", Fx, [e2.profile.isYou ? (wl(), _l("button", {
        key: 0,
        onClick: e0[3] || (e0[3] = e0 => e$.$router.push("/instagram/edit")),
        class: "block w-full border border-theme p-1 rounded-xl"
    }, " Editar perfil ")) : (wl(), _l("button", {
        key: 1,
        onClick: e0[4] || (e0[4] = e$ => e2.setFollow(!e2.profile.isFollowed)),
        class: "block w-full bg-blue-500 p-1 text-white rounded-xl"
    }, g(e2.profile.isFollowed ? "Deixar de seguir" : "Seguir"), 1)), ]), ]), ])) : Ml("", !0), Pl("ul", zx, [(wl(!0), _l(bl, null, fa(e2.posts, e0 => (wl(), _l("li", {
        key: e0.id,
    ...
    }, null, 4), ], 8, ["onClick"]))), 128)), ]), e2.profile && !e2.posts.length ? (wl(), _l("h3", Bx, "Este usu\xe1rio n\xe3o tem publica\xe7\xf5es")) : Ml("", !0), Pl(e5), ])
};
const Hx = {
        components: {
            Header: vg,
        ...
        setup() {
            let e$ = rt(!0),
                ...
                e8 = cc(),
                e2 = uc();
            return So.backend.ig_getPost(e2.params.id).then(e8 => {
                e0.value = e8, e$.value = !1
            }), So.onceRoute("INSTAGRAM_DESTROY", e$ => {
                var e2;
...
Hx.render = function (e$, e0, e8, e2, e3, e1) {
    let e6 = dl("Header"),
        e4 = dl("Post");
    return wl(), _l("div", qx, [Pl(e6, {
        back: "Voltar"
    }), e2.loading ? (wl(), _l("div", Gx)) : e2.post ? (wl(), _l(e4, {
        key: 1,
        post: e2.post
    }, null, 8, ["post"])) : (wl(), _l("h1", Wx, "Post n\xe3o encontrado")), ])
};
const Kx = rt(),
    Jx = {
        setup() {
...
Jx.render = function (e$, e0, e8, e2, e3, e1) {
    return wl(), _l("div", Xx, [Pl("img", {
        onClick: e0[1] || (e0[1] = e0 => {
            var e8;
            return e$.$router.push("/twitter/profiles/" + (null == (e8 = e2.profile) ? void 0 : e8.id))
        }),
        class: "absolute left-8 w-12 h-12 rounded-full",
        src: e2.profile.avatarURL
    }, null, 8, ["src"]), e2.logo ? (wl(), _l("img", {
        key: 0,
        class: "w-12 h-12",
        src: e2.logo
    }, null, 8, ["src", ])) : (wl(), _l("i", {
        key: 1,
        onClick: e0[2] || (e0[2] = (...e$) => e2.scrollTop && e2.scrollTop(...e$)),
...
const Yx = {
        ...
        setup(e$, e0) {
            ...
            return {
                ...
                retweet() {
                    So.backend["twitter_" + (e2.retweeted ? "unretweet" : "retweet")](e3).then(e$ => {
                        e0.emit("setRetweet", e3, e$)
                    })
                },
                like() {
                    So.backend["twitter_" + (e2.liked ? "dislike" : "like")](e3).then(e$ => {
                        e0.emit("setLike", e3, e$)
                    })
                },
                showOptions() {
                    let e$ = {};
                    (e2.author.id === Kx.value.id || So.identity.moderator) && (e$.delete = "Excluir tweet"), e$.view = "Ver tweet", go().request(e$, 25, !0).then(e$ => {
                        "delete" === e$ ? So.backend.twitter_destroy(e3) : "view" === e$ && this.redirect()
                    }, () => {})
                }
            }
        }
...
Yx.render = function (e$, e0, e8, e2, e3, e1) {
    ...
    return wl(), _l(fl(e8.tag), {
        class: "p-3 border-b border-theme text-theme"
    }, {
        default: en(() => {
            var e3;
            return [e8.post.retweeted_by ? (wl(), _l("p", Zx, [Qx, Il(" " + g(e8.post.retweeted_by) + " retweetou ", 1), ])) : Ml("", !0), Pl("div", ey, [Pl("img", {
                onClick: e0[1] || (e0[1] = e0 => e$.$router.push("/twitter/profiles/" + e8.post.author.id)),
                class: "w-20 h-20 rounded-full",
                src: e8.post.author.avatarURL,
                alt: ""
            }, null, 8, ["src"]), Pl("div", ty, [Pl("div", ny, [Pl("span", ly, g(e8.post.author.name), 1), e8.post.author.verified ? (wl(), _l(e6, {
                key: 0,
                class: "mr-2 w-5 h-5"
            })) : Ml("", !0), Pl("span", ay, " @" + g(e8.post.author.username) + " \xb7 " + g(e$.$filters.unixToRelative(null != (e3 = e8.post.created_at) ? e3 : 0)), 1), Pl("button", {
                class: "ml-auto px-4",
                onClick: e0[2] || (e0[2] = (...e$) => e2.showOptions && e2.showOptions(...e$))
            }, [sy]), ]), Pl("p", oy, g(e8.post.content), 1), Pl("div", ry, [Pl("button", {
                onClick: e0[3] || (e0[3] = (...e$) => e2.redirect && e2.redirect(...e$))
            }, [iy, Pl("span", null, g(e8.post.comments), 1)]), Pl("button", {
                onClick: e0[4] || (e0[4] = (...e$) => e2.retweet && e2.retweet(...e$)),
                class: {
                    "text-green-400": e8.post.retweeted
                }
            }, [cy, Pl("span", null, g(e8.post.retweets), 1)], 2), Pl("button", {
                onClick: e0[5] || (e0[5] = (...e$) => e2.like && e2.like(...e$)),
                class: {
            ...
            }, null, 2), Pl("span", null, g(e8.post.likes), 1), ], 2), ]), ]), ]), ]
        }),
        _: 1
    })
};
const uy = {
    ...
    setup(e$) {
        ...
        So.onceRoute("TWITTER_DESTROY", e$ => {
            let e8 = 0;
            for (; - 1 != (e8 = e0.findIndex(e0 => e0.id == e$ || e0.tweet_id == e$));) e0.splice(e8, 1)
        });
        let e8 = (e$, e8, e2 = 1) => So.onceRoute(e$, e$ => {
            e0.filter(e0 => e0.id == e$ || e0.tweet_id == e$ && e0.retweeted_by).forEach(e$ => {
                e$[e8] += e2
            })
        });
        return e8("TWITTER_LIKE", "likes"), e8("TWITTER_DISLIKE", "likes", -1), e8("TWITTER_REPLY", "comments"), e8("TWITTER_RETWEET", "retweets"), e8("TWITTER_UNRETWEET", "retweets", -1), {
            ...
            setRetweet: function (e$, e8) {
                e0.filter(e0 => e0.id == e$ || e0.tweet_id == e$ && e0.retweeted_by).forEach(e$ => e$.retweeted = e8);
...
uy.render = function (e$, e0, e8, e2, e3, e1) {
    let e6 = dl("Post");
    return wl(), _l("ul", null, [(wl(!0), _l(bl, null, fa(e8.all, e$ => (wl(), _l(e6, {
        tag: "li",
        key: e$.id,
        post: e$,
...
const dy = {
        ...
        setup() {
            ...
            if (So.localhost) {
                ...
                for (let e0 = 0; e0 < 100; e0 += 1) e$.push({
                    id: e0 + 1,
                    author: {
                        name: "John Doe",
                        username: "johndoe",
            ...
            return So.backend.twitter().then(e0 => {
                e0 ? (Kx.value = e0, So.backend.twitter_timeline().then(e0 => {
                    Object.assign(e$, e0), So.onceRoute("TWITTER_TWEET", e0 => e$.unshift(e0))
...
dy.render = function (e$, e0, e8, e2, e3, e1) {
    let e6 = dl("Header"),
        e4 = dl("Timeline");
    return e2.profile ? (wl(), _l("div", py, [Pl(e6), Pl(e4, {
...
const my = {
        setup() {
            ...
            let e0 = jl("alert"),
                e8 = rt({}),
                e2 = null != (e$ = So.settings.twitterLogo) ? e$ : globalThis.twitterLogo;
            return {
                form: e8,
                register: function () {
...
an();
const ky = hy((e$, e0, e8, e2, e3, e1) => (wl(), _l("div", by, [Pl("div", gy, [Pl("span", {
    onClick: e0[1] || (e0[1] = (...e0) => e$.$router.back && e$.$router.back(...e0)),
    class: "absolute left-4 text-3xl text-twitter"
}, "Cancelar"), e2.logo ? (wl(), _l("img", {
    key: 0,
    class: "w-12 h-12",
    src: e2.logo
}, null, 8, ["src", ])) : (wl(), _l("i", vy)), ]), Pl("div", xy, [Zn(Pl("input", {
    "onUpdate:modelValue": e0[2] || (e0[2] = e$ => e2.form.name = e$),
    maxlength: "24",
    ...
    "onUpdate:modelValue": e0[3] || (e0[3] = e$ => e2.form.username = e$),
    maxlength: "16",
    ...
    "onUpdate:modelValue": e0[4] || (e0[4] = e$ => e2.form.bio = e$),
    maxlength: "255",
    class: "mt-8 border-b border-theme w-full text-3xl p-2 bg-theme",
    ...
    onClick: e0[5] || (e0[5] = (...e$) => e2.register && e2.register(...e$)),
...
an();
const Ty = Cy((e$, e0, e8, e2, e3, e1) => (wl(), _l("div", _y, [Pl("div", Ay, [Pl("i", {
    onClick: e0[1] || (e0[1] = (...e0) => e$.$router.back && e$.$router.back(...e0)),
    class: "fal fa-times text-twitter text-4xl"
}), Pl("button", {
    onClick: e0[2] || (e0[2] = (...e$) => e2.submit && e2.submit(...e$)),
    ...
    "onUpdate:modelValue": e0[3] || (e0[3] = e$ => e2.form.content = e$),
    maxlength: "280",
        ...
        setup() {
            ...
            return So.localhost && (e2.value = {
                ...
                e$.params.id && So.backend.twitter_view(e$.params.id).then(e$ => {
                    e2.value = e$.tweet, e3.length = 0, Object.assign(e3, e$.comments);
                    let [e0, e8] = Us(e$.tweet.created_at);
                    e6.value = e0, e1.value = e8
                })
            }), vn(() => {
                let e$ = (e$, e0) => So.onceRoute(e$, e$ => e$ == e2.value.id && e0());
                So.onceRoute("TWITTER_DESTROY", e$ => {
                    if (e2.value.id != e$) {
                ...
                }), e$("TWITTER_LIKE", () => e2.value.likes++), e$("TWITTER_RETWEET", () => e2.value.retweets++), e$("TWITTER_DISLIKE", () => e2.value.likes--), e$("TWITTER_UNRETWEET", () => e2.value.retweets--)
            }), {
                content: e4,
                createReply: function () {
                    let e$ = e4.value.trim();
                    e$ && So.backend.twitter_reply(parseInt(e2.value.id), e$).then(e$ => {
                ...
                comments: e3,
                like: function () {
                    So.backend["twitter_" + (e2.value.liked ? "dislike" : "like")](e2.value.id).then(e$ => {
                        e2.value.liked = e$
                    })
                },
                retweet: function () {
                    So.backend["twitter_" + (e2.value.retweeted ? "unretweet" : "retweet")](e2.value.id).then(e$ => {
...
Ey.render = function (e$, e0, e8, e2, e3, e1) {
    ...
    let e4 = dl("app-verified"),
        e7 = dl("Timeline");
    return wl(), _l("div", Ry, [Py, Pl("div", Ly, [(null == (e6 = e2.tweet) ? void 0 : e6.id) ? (wl(), _l("div", Iy, [Pl("div", Oy, [Pl("img", {
        onClick: e0[1] || (e0[1] = e0 => e$.$router.push("/twitter/profiles/" + e2.tweet.author.id)),
        class: "w-24 h-24 rounded-full",
        ...
        key: 0,
        class: "ml-2 w-6 h-6"
    })) : Ml("", !0), ]), Pl("h1", Dy, "@" + g(e2.tweet.author.username), 1), ]), ]), Pl("p", Ny, g(e2.tweet.content), 1), Pl("p", Uy, g(e2.hour) + " \xb7 " + g(e2.date) + " \xb7 Twitter for " + g(e2.android ? "Foxzinoid" : "FoxzinOS"), 1), Pl("div", $y, [Pl("p", jy, [Pl("b", Fy, g(e2.tweet.retweets), 1), zy]), Pl("p", By, [Pl("b", Hy, g(e2.tweet.likes), 1), qy]), ]), ])) : Ml("", !0), Pl("div", Gy, [Pl("button", {
    ...
    }, null, 2), ], 2), ]), null != e2.content ? (wl(), _l("div", Jy, [Pl("div", Xy, [Pl("p", Yy, [Zy, Qy, Pl("span", ek, "@" + g(e2.tweet.author.username), 1), ]), Pl("button", {
        onClick: e0[5] || (e0[5] = (...e$) => e2.createReply && e2.createReply(...e$)),
        class: "bg-twitter px-6 py-2 text-xl text-white rounded-full"
    }, "Responder"), ]), Pl("div", tk, [Pl("img", {
        class: "w-20 h-20 rounded-full",
        src: e2.mine.avatarURL
    }, null, 8, ["src"]), Zn(Pl("textarea", {
        onKeydown: e0[6] || (e0[6] = us(is((...e$) => e2.createReply && e2.createReply(...e$), ["prevent"]), ["enter"])),
        class: "ml-3 mt-5 w-full h-36 bg-transparent text-theme resize-none hide-scroll",
        "onUpdate:modelValue": e0[7] || (e0[7] = e$ => e2.content = e$),
...
const nk = {
        ...
        setup() {
            ...
            return So.localhost && (e0.value = {
                ...
                e0.value = null == e$ ? void 0 : e$.profile, Object.assign(e8, null == e$ ? void 0 : e$.posts)
            }), {
                dark: So.darkTheme,
                profile: e0,
                posts: e8,
                ...
                follow: async function () {
                    await So.backend.twitter_follow(e$.params.id) && (e0.value.followers += 1, e0.value.isFollowed = !0)
                },
                unfollow: async function () {
                    await So.backend.twitter_unfollow(e$.params.id) && (e0.value.followers -= 1, e0.value.isFollowed = !1)
                }
            }
        }
    },
...
nk.render = function (e$, e0, e8, e2, e3, e1) {
    ...
    let eV = dl("app-verified"),
        eN = dl("Timeline");
    return wl(), _l("div", lk, [ak, e2.profile ? (wl(), _l("div", sk, [Pl("div", ok, [Pl("img", {
        class: "w-full h-56",
        src: e2.profile.bannerURL
    }, null, 8, ["src"]), Pl("img", {
        class: ["absolute left-8 top-36 w-36 h-36 rounded-full border-4", [e2.dark ? "border-black" : "border-white"], ],
        src: null == (e6 = e2.profile) ? void 0 : e6.avatarURL,
        alt: ""
    }, null, 10, ["src"]), ]), Pl("div", rk, [(null == (e4 = e2.mine) ? void 0 : e4.id) == e2.profile.id ? (wl(), _l("button", {
        key: 0,
        onClick: e0[1] || (e0[1] = e0 => e$.$router.push("/twitter/settings")),
        class: "mr-4 px-6 rounded-full text-twitter border border-twitter"
    }, "Editar perfil")) : e2.profile.isFollowed ? (wl(), _l("button", {
        key: 1,
        onClick: e0[2] || (e0[2] = (...e$) => e2.unfollow && e2.unfollow(...e$)),
        class: "mr-4 px-6 rounded-full text-twitter border border-twitter"
    }, "Deixar de seguir")) : (wl(), _l("button", {
        key: 2,
        onClick: e0[3] || (e0[3] = (...e$) => e2.follow && e2.follow(...e$)),
        class: "mr-4 px-6 rounded-full text-twitter border border-twitter"
    }, "Seguir")), ]), Pl("div", ik, [Pl("div", ck, [Pl("h1", uk, g(e2.profile.name), 1), e2.profile.verified ? (wl(), _l(eV, {
        key: 0,
        class: "ml-2 w-6 h-6"
    })) : Ml("", !0), ]), Pl("h3", dk, "@" + g(e2.profile.username), 1), Pl("p", pk, g(e2.profile.bio), 1), Pl("div", fk, [Pl("p", null, [Pl("b", null, g(null != (e7 = e2.profile.following) ? e7 : 0), 1), mk, hk, ]), Pl("p", bk, [Pl("b", null, g(null != (e5 = e2.profile.followers) ? e5 : 0), 1), gk, vk, ]), ]), ]), Pl(eN, {
        all: e2.posts
    }, null, 8, ["all"]), ])) : Ml("", !0), ])
};
const xk = Ze({}),
...
const Uk = kk((e$, e0, e8, e2, e3, e1) => {
    ...
    return wl(), _l("div", wk, [Pl("div", Ck, [Pl("button", {
    ...
    }, [_k]), Ak, e2.hasChanges ? (wl(), _l("button", {
        key: 0,
        onClick: e0[2] || (e0[2] = (...e$) => e2.save && e2.save(...e$)),
        class: "ml-auto text-twitter text-2xl px-5"
    }, "Salvar")) : Ml("", !0), ]), Pl("div", Sk, [Pl("div", Tk, [Pl("button", {
        onClick: e0[3] || (e0[3] = (...e$) => e2.changeBanner && e2.changeBanner(...e$)),
        ...
        onClick: e0[4] || (e0[4] = (...e$) => e2.changeAvatar && e2.changeAvatar(...e$)),
        class: "absolute inset-0 w-full rounded-full text-center text-white"
    }, [Pk]), Pl("img", {
        class: ["w-36 h-36 rounded-full border-4", [e2.dark ? "border-black" : "border-white"], ],
        src: e2.form.avatarURL,
        alt: ""
    }, null, 10, ["src"]), ]), ]), Pl("div", Lk, [Pl("div", Ik, [Ok, Zn(Pl("input", {
        maxlength: "24",
        "onUpdate:modelValue": e0[5] || (e0[5] = e$ => e2.form.name = e$),
        class: "border-b border-theme p-1"
    }, null, 512), [
        [ns, e2.form.name]
    ]), ]), Pl("div", Mk, [Vk, Zn(Pl("input", {
        maxlength: "16",
        "onUpdate:modelValue": e0[6] || (e0[6] = e$ => e2.form.username = e$),
        class: "border-b border-theme p-1"
    }, null, 512), [
        [ns, e2.form.username]
    ]), ]), Pl("div", Dk, [Nk, Zn(Pl("input", {
        maxlength: "255",
        "onUpdate:modelValue": e0[7] || (e0[7] = e$ => e2.form.bio = e$),
        class: "border-b border-theme p-1"
    }, null, 512), [
        [ns, e2.form.bio]
    ]), ]), ]), ])
...
function jk(e$, e0) {
    let e8, e2;
    Array.isArray(e$) ? [e8, e2] = e$ : (e8 = () => e$.value, e2 = e0 => e$.value = e0);
    let e3 = [],
        e1 = Math.floor((e8() - e0) / 23);
    0 == e1 && e2(e0);
    for (let e6 = 25; e6 <= 600; e6 += 25) e3.push(setTimeout(() => {
...
const Fk = {
    setup() {
        ...
        return {
            container: e$,
            down: function (e3) {
                e2 = !0, e0 = e3.pageX - e$.value.offsetLeft, e8 = e$.value.scrollLeft
            },
            up: function () {
                e2 = !1
            },
            move: function (e3) {
                if (!e2) return;
                e3.preventDefault();
                let e1 = .75 * (e3.pageX - e$.value.offsetLeft - e0);
...
Fk.render = function (e$, e0, e8, e2, e3, e1) {
    return wl(), _l("div", {
        ...
        ref: "container",
        onMousedown: e0[1] || (e0[1] = is((...e$) => e2.down && e2.down(...e$), ["stop", "prevent"])),
...
Bk.render = function (e$, e0, e8, e2, e3, e1) {
    ...
    }, [null != e8.header ? (wl(), _l("div", Hk)) : Ml("", !0), e8.header ? (wl(), _l("div", qk, [e2.bankLogo ? (wl(), _l("img", {
        key: 0,
        class: "h-20 mx-auto",
        src: e2.bankLogo
    ...
    }, null, 8, ["src"])) : "picpay" == e2.bankType ? (wl(), _l("img", {
        key: 7,
        class: "h-14 mt-2 mx-auto",
        src: e$.$asset("stock/picpay.svg")
    }, null, 8, ["src"])) : "bdc" == e2.bankType ? (wl(), _l("img", {
        key: 8,
        class: "h-24 mx-auto",
        src: e$.$asset("apps/bdc.svg")
    }, null, 8, ["src"])) : "itau" == e2.bankType ? (wl(), _l("img", Zk)) : "bb" == e2.bankType ? (wl(), _l("img", Qk)) : Ml("", !0), ])) : Ml("", !0), Zt(e$.$slots, "default"), "/bank" == e$.$route.path ? (wl(), _l(e6, {
        key: 2,
        class: "mt-auto flex flex-shrink-0 flex-no-shrink h-52 py-5 mx-5 text-4xl"
    }, {
        default: en(() => [e2.pix ? (wl(), _l("div", {
            key: 0,
            onClick: e0[1] || (e0[1] = e0 => e$.$router.push("/bank/pix")),
            class: "w-40 p-4 flex flex-col justify-between text-white bank-light rounded-lg mr-6"
        }, [ew, tw])) : Ml("", !0), Pl("div", {
            onClick: e0[2] || (e0[2] = e0 => e$.$router.push("/bank/transfer")),
            class: "w-40 p-4 flex flex-col justify-between text-white bank-light rounded-lg mr-6"
        }, [nw, lw]), Pl("div", {
            onClick: e0[3] || (e0[3] = e0 => e$.$router.push("/bank/statements")),
            class: "w-40 p-4 flex flex-col justify-between text-white bank-light rounded-lg mr-6"
        }, [aw, sw]), e2.hasInvoices ? (wl(), _l("div", {
            key: 1,
            onClick: e0[4] || (e0[4] = e0 => e$.$router.push("/bank/invoices/create")),
            class: "w-40 p-4 flex flex-col justify-between text-white bank-light rounded-lg mr-6"
        }, [ow, rw])) : Ml("", !0), e2.hasInvoices ? (wl(), _l("div", {
            key: 2,
            onClick: e0[5] || (e0[5] = e0 => e$.$router.push("/bank/invoices")),
            class: "w-40 p-4 flex flex-col justify-between text-white bank-light rounded-lg mr-6"
        }, [iw, cw])) : Ml("", !0), e2.hasFines ? (wl(), _l("div", {
            key: 3,
            onClick: e0[6] || (e0[6] = e0 => e$.$router.push("/bank/fines")),
            class: "w-40 p-4 flex flex-col justify-between text-white bank-light rounded-lg mr-6"
        }, [uw, dw])) : Ml("", !0), ]),
        _: 1
    })) : Ml("", !0), ], 8, ["bankType"])
...
const pw = {
        ...
        setup() {
            ...
            return So.backend.bank_index().then(e$ => {
                e8.value = e$.balance, e3.value = e$.fines, e2.value = e$.invoices
            }), Tn(e1, e$ => So.setNotificationFor("bank", e$)), So.onceRoute("BANK", ({
                value: e$
            }) => jk(e8, e8.value + e$)), {
                identity: e$,
                notifications: e1,
                ...
                isEnabled: function (e$) {
                    var e0;
                    return !(null == (e0 = So.settings.disabledApps) ? void 0 : e0.includes(e$))
                }
            }
        }
    },
...
pw.render = function (e$, e0, e8, e2, e3, e1) {
    let e6 = dl("Page");
    return wl(), _l(e6, null, {
        default: en(() => [Pl("div", fw, [Pl("div", mw, [Pl("h1", hw, "Ol\xe1, " + g(e2.identity.name), 1), Pl("div", bw, [Pl("button", {
            onClick: e0[1] || (e0[1] = e$ => e2.notifications = !e2.notifications),
            class: "text-white bank-light w-16 h-16 flex flex-center rounded-full mr-2"
        }, [Pl("i", {
            class: ["far", e2.notifications ? "fa-bell" : "fa-bell-slash", ]
        }, null, 2), ]), Pl("button", {
            onClick: e0[2] || (e0[2] = e$ => e2.visible = !e2.visible),
            class: "text-white bank-light w-16 h-16 flex flex-center rounded-full"
        }, [Pl("i", {
            class: ["far", e2.visible ? "fa-eye" : "fa-eye-slash"]
        }, null, 2), ]), ]), ]), Pl("div", null, [Pl("div", gw, [vw, xw, e2.visible ? (wl(), _l("h3", yw, g(e$.$filters.intToMoney(e2.balance)), 1)) : (wl(), _l("div", kw)), ]), e2.isEnabled("invoice") ? (wl(), _l("div", ww, [Cw, _w, e2.visible ? (wl(), _l("h3", Aw, g(e$.$filters.intToMoney(e2.invoices)), 1)) : (wl(), _l("div", Sw)), ])) : Ml("", !0), e2.isEnabled("fines") ? (wl(), _l("div", Tw, [Ew, Rw, e2.visible ? (wl(), _l("h3", Pw, g(e$.$filters.intToMoney(e2.fines)), 1)) : (wl(), _l("div", Lw)), ])) : Ml("", !0), ]), ]), ]),
        _: 1
    })
};
const Iw = {
        ...
        setup() {
            ...
            return Tn(e3, e$ => {
                ...
                submit: function () {
                    ...
                    So.confirm("Deseja transferir " + js(e8) + " para a chave " + e1.value + "?").then(e2 => {
                        e2 && So.lockAndProceed(() => So.backend.bank_pix(e1.value, e8).then(e2 => {
                            e2.error ? e0(e2.error) : e$.replace({
                                path: "/bank/receipt",
                                query: {
                                    name: e1.value,
                                    value: e8
...
const Mw = {
    ...
    Uw = Pl("h1", {
        class: "font-semibold"
    }, "Qual \xe9 o valor da transfer\xeancia?", -1),
    $w = {
        class: "mt-4 text-3xl"
    },
    ...
    Yw = Pl("img", {
        ...
        src: "http://45.40.99.23/apps/pixfox.png"
    }, null, -1),
    Zw = Pl("h1", {
        class: "font-semibold"
    }, "Pronto, enviamos sua transfer\xeancia", -1),
    Qw = {
...
const lC = Ow((e$, e0, e8, e2, e3, e1) => {
    ...
    return wl(), _l(e6, {
        ...
        default: Ow(() => [Pl("div", Mw, [Pl("button", {
            class: "p-5 mt-8",
            onClick: e0[1] || (e0[1] = (...e0) => e$.$router.back && e$.$router.back(...e0))
        }, [Vw]), 0 == e2.step ? (wl(), _l("div", Dw, [Pl("div", Nw, [Uw, Pl("p", $w, [jw, Pl("strong", null, g(e$.$currency) + " " + g(e2.balance.toLocaleString("pt-BR")), 1), ]), ]), Pl("div", Fw, [Pl("div", zw, [Pl("span", Bw, g(e$.$currency), 1), Zn(Pl("input", {
            onKeydown: e0[2] || (e0[2] = us(e$ => 0 != e2.value ? e2.step = 1 : null, ["enter"])),
            "onUpdate:modelValue": e0[3] || (e0[3] = e$ => e2.value = e$),
            class: "w-full font-bold border-b pl-20"
        }, null, 544), [
            [ns, e2.value]
        ]), ]), ]), Pl("button", {
            onClick: e0[4] || (e0[4] = e$ => 0 != e2.value ? e2.step = 1 : null),
        ...
        }, [Hw], 2), ])) : 1 == e2.step ? (wl(), _l("div", qw, [Pl("div", Gw, [Ww, Zn(Pl("input", {
            "onUpdate:modelValue": e0[5] || (e0[5] = e$ => e2.key = e$),
            class: "w-full mt-8 pb-2 border-b font-bold"
        }, null, 512), [
            [ns, e2.key]
        ]), ]), e2.key.trim() ? (wl(), _l("div", Kw, [Pl("button", {
            onClick: e0[6] || (e0[6] = (...e$) => e2.submit && e2.submit(...e$)),
            class: "w-full rounded-full bank-light text-white p-5"
        }, " Transferir para essa chave "), ])) : Ml("", !0), ])) : 2 == e2.step ? (wl(), _l("div", Jw, [Pl("div", Xw, [Yw, Zw, Pl("div", Qw, [Pl("p", eC, g(e$.$currency) + " " + g(e2.value), 1), Pl("p", null, "para " + g(e$.name), 1), Pl("p", tC, [nC, Il(" • " + g(e$.time), 1)]), ]), ]), ])) : Ml("", !0), ]), ]),
        _: 1
    })
});
                    ...
                    let e8 = Number(e3.value.replace(/\D/g, "")),
                        {
                            name: e2,
                            error: e6
                        } = await So.backend.bank_confirm(e1.value);
                    if (!e2) return So.alert(e6);
                    So.confirm("Deseja transferir " + js(e8) + " para " + e2 + "?").then(e3 => {
                        e3 && So.lockAndProceed(() => So.backend.bank_transfer(e1.value, e8).then(e3 => {
                            e3.error ? e0(e3.error) : e$.replace({
                                path: "/bank/receipt",
                                query: {
                                    name: e2,
                                    value: e8
...
const kC = sC((e$, e0, e8, e2, e3, e1) => {
    ...
    return wl(), _l(e6, {
        ...
        default: sC(() => [Pl("div", oC, [Pl("button", {
            class: "p-5 mt-8",
            onClick: e0[1] || (e0[1] = (...e0) => e$.$router.back && e$.$router.back(...e0))
        }, [rC]), 0 == e2.step ? (wl(), _l("div", iC, [Pl("div", cC, [uC, Pl("p", dC, [pC, Pl("strong", null, g(e$.$currency) + " " + g(e2.balance.toLocaleString("pt-BR")), 1), ]), ]), Pl("div", fC, [Pl("div", mC, [Pl("span", hC, g(e$.$currency), 1), Zn(Pl("input", {
            onKeydown: e0[2] || (e0[2] = us(e$ => 0 != e2.value ? e2.step = 1 : null, ["enter"])),
            "onUpdate:modelValue": e0[3] || (e0[3] = e$ => e2.value = e$),
            class: "w-full font-bold border-b pl-20"
        }, null, 544), [
        ...
        }, [bC], 2), ])) : 1 == e2.step ? (wl(), _l("div", gC, [Pl("div", vC, [xC, Zn(Pl("input", {
            "onUpdate:modelValue": e0[5] || (e0[5] = e$ => e2.passport = e$),
            class: "w-full mt-8 pb-2 border-b font-bold"
        }, null, 512), [
            [ns, e2.passport]
        ]), ]), e2.passport >= 0 ? (wl(), _l("div", {
            key: 0,
            onClick: e0[6] || (e0[6] = (...e$) => e2.submit && e2.submit(...e$)),
            class: "absolute inset-x-8 bottom-8"
        }, [yC])) : Ml("", !0), ])) : Ml("", !0), ]), ]),
...
const OC = CC((e$, e0, e8, e2, e3, e1) => {
    ...
    return wl(), _l(e6, {
        ...
        default: CC(() => [Pl("div", _C, [Pl("button", {
            class: "p-5 mt-8",
            onClick: e0[1] || (e0[1] = (...e0) => e$.$router.back && e$.$router.back(...e0))
        }, [AC]), Pl("div", null, [Pl("div", SC, [TC, EC, Pl("div", RC, [Pl("p", PC, g(e$.$currency) + " " + g(e2.value), 1), Pl("p", null, "para " + g(e2.name), 1), Pl("p", LC, [IC, Il(" • " + g(e2.time), 1)]), ]), ]), ]), ]), ]),
        _: 1
    })
});
...
const MC = {
        ...
        setup() {
            ...
            let e$ = rt(0),
                e0 = rt([]);
            return So.backend.bank_getBalance().then(e0 => e$.value = e0), So.backend.bank_extract().then(e$ => e0.value = e$.map(e$ => (e$.description = e$.description.replace(/<[^>]*>/g, ""), e$))), {
                balance: e$,
                statements: e0
            }
        }
...
MC.render = function (e$, e0, e8, e2, e3, e1) {
    ...
    return wl(), _l(e6, {
        ...
        default: en(() => [Pl("div", VC, [Pl("button", {
            ...
            onClick: e0[1] || (e0[1] = (...e0) => e$.$router.back && e$.$router.back(...e0))
        }, [DC]), Pl("div", NC, [UC, Pl("h1", $C, g(e$.$currency) + " " + g(e2.balance.toLocaleString("pt-BR")), 1), ]), jC, Pl("div", FC, [zC, Pl("ul", null, [(wl(!0), _l(bl, null, fa(e2.statements, (e$, e0) => (wl(), _l("li", {
            key: e0,
            class: "p-4 px-8 border-b"
        }, [Pl("p", null, g(e$.description), 1), e$.created_at ? (wl(), _l("p", BC, g(e$.created_at), 1)) : Ml("", !0), ]))), 128)), e2.statements.length ? Ml("", !0) : (wl(), _l("p", HC, [qC, GC])), ]), ]), ]), ]),
        _: 1
    })
};
const WC = {
        ...
        setup() {
            ...
            let e$ = jl("alert"),
                ...
                e8 = rt(0),
                e2 = rt([]),
                e3 = da(() => e2.value.filter(e$ => ("sent" === e0.value ? e$.payee_id : e$.payer_id) === So.identity.user_id));
            return So.backend.bank_getBalance().then(e$ => e8.value = e$), So.backend.bank_getInvoices().then(e$ => e2.value = e$), {
                balance: e8,
                invoices: e2,
                filtered: e3,
                pay: function (e0) {
...
WC.render = function (e$, e0, e8, e2, e3, e1) {
    ...
    return wl(), _l(e6, {
        ...
        default: en(() => [Pl("div", KC, [Pl("button", {
            ...
            onClick: e0[1] || (e0[1] = (...e0) => e$.$router.back && e$.$router.back(...e0))
        }, [JC]), Pl("div", XC, [YC, Pl("p", ZC, g(e$.$currency) + " " + g(e2.balance.toLocaleString("pt-BR")), 1), ]), Pl("div", QC, [Pl("button", {
        ...
        }, "Enviadas", 2), ]), Pl("ul", e_, [(wl(!0), _l(bl, null, fa(e2.filtered, (e0, e8) => (wl(), _l("li", {
            key: e8,
            class: "flex items-center px-4 py-4 border-b"
        }, [Pl("div", t_, [Pl("h1", n_, g(e0.reason), 1), Pl("p", l_, g(e0.name) + " - " + g(e$.$filters.unixToRelative(e0.created_at)), 1), ]), Pl("p", a_, g(e$.$currency) + " " + g(e0.value.toLocaleString("pt-BR")), 1), "received" === e2.tab ? (wl(), _l("button", {
            key: 0,
            onClick: e$ => e2.pay(e0),
            class: "bank-light text-white px-6 py-2 rounded-xl"
        }, " Pagar ", 8, ["onClick"])) : Ml("", !0), ]))), 128)), e2.filtered.length ? Ml("", !0) : (wl(), _l("p", s_, [o_, r_])), ]), ]), ]),
        _: 1
    })
};
const i_ = {
        ...
        setup() {
            ...
            return Tn(e2, e$ => {
                ...
                submit: function () {
                    ...
                    e0(!0), So.backend.bank_storeInvoice(e8.value, e4, e3.value).then(e0 => {
                        if (e0.error) e$(e0.error);
                        else {
                            let e8 = new Date;
                            e0.time = e8.getHours() + "h" + String(e8.getMinutes()).padStart(2, 0), e6.value = e0, e1.value = 2
                        }
                    }).finally(() => e0(!1))
                },
                passport: e8,
...
i_.render = function (e$, e0, e8, e2, e3, e1) {
    ...
    return wl(), _l(e6, {
        ...
        default: en(() => [Pl("div", c_, [Pl("button", {
            class: "p-8 pt-16 text-gray-600",
            onClick: e0[1] || (e0[1] = (...e0) => e$.$router.back && e$.$router.back(...e0))
        }, [u_]), 1 == e2.step ? (wl(), _l("div", d_, [Pl("div", p_, [f_, Zn(Pl("input", {
            "onUpdate:modelValue": e0[2] || (e0[2] = e$ => e2.passport = e$),
            maxlength: 11,
            ...
            "onUpdate:modelValue": e0[4] || (e0[4] = e$ => e2.reason = e$),
            maxlength: "100",
            spellcheck: "false",
            ...
            [ns, e2.reason]
        ]), ]), e2.passport >= 0 && 0 != e2.value && e2.reason.trim() ? (wl(), _l("div", {
            key: 0,
            onClick: e0[5] || (e0[5] = (...e$) => e2.submit && e2.submit(...e$)),
            class: "absolute inset-x-8 bottom-8"
        }, [y_])) : Ml("", !0), ])) : 2 == e2.step ? (wl(), _l("div", k_, [w_, C_, Pl("div", __, [Pl("p", A_, g(e$.$currency) + " " + g(e2.receipt.value.toLocaleString("pt-BR")), 1), Pl("p", null, "para " + g(e2.receipt.name), 1), Pl("p", S_, [T_, Il(" • " + g(e2.receipt.time), 1)]), ]), ])) : Ml("", !0), ]), ]),
        _: 1
    })
};
const E_ = {
        ...
        setup() {
            ...
            let e$ = jl("alert"),
                e0 = rt(0),
                e8 = rt([]);
            return So.backend.bank_getBalance().then(e$ => e0.value = e$), So.backend.bank_getFines().then(e$ => e8.value = e$), {
                balance: e0,
                fines: e8,
                pay: function (e2) {
...
E_.render = function (e$, e0, e8, e2, e3, e1) {
    ...
    return wl(), _l(e6, {
        ...
        default: en(() => [Pl("div", R_, [Pl("button", {
            class: "p-8 pt-16 text-gray-600",
            onClick: e0[1] || (e0[1] = (...e0) => e$.$router.back && e$.$router.back(...e0))
        }, [P_]), Pl("div", L_, [I_, Pl("p", O_, g(e$.$currency) + " " + g(e2.balance.toLocaleString("pt-BR")), 1), ]), M_, Pl("ul", V_, [(wl(!0), _l(bl, null, fa(e2.fines, (e0, e8) => (wl(), _l("li", {
            key: e8,
            class: "flex items-center px-4 py-4 border-b"
        }, [Pl("div", D_, [Pl("h1", N_, g(e0.description), 1), Pl("p", U_, g(e0.created_at), 1), ]), Pl("p", $_, g(e$.$currency) + " " + g(e0.total.toLocaleString("pt-BR")), 1), Pl("button", {
            onClick: e$ => e2.pay(e0),
            class: "bank-light text-white px-6 py-2 rounded-xl"
        }, " Pagar ", 8, ["onClick"]), ]))), 128)), e2.fines.length ? Ml("", !0) : (wl(), _l("p", j_, [F_, z_])), ]), ]), ]),
        _: 1
    })
};
const B_ = {
        setup() {
            ...
            function e4(e0) {
                return ({
                    ...
                    e2 ? e$(e2) : (e1.value.unshift(e6), e8.value += e0 * e6.value, e7(e6), "payment" === e6.type ? e3.value = e6 : "deposit" === e6.type && (eN.bank -= e6.value))
                }
            }
            ...
            Tn(e6, e$ => So.setNotificationFor("paypal", e$)), So.localhost && e1.value.push({
                id: 1,
                user_id: 1,
                target: 1,
                value: 100,
                ...
                value: e$
            }) => jk(e8, e8.value + e$)), e4.add = e4(1), e4.rem = e4(-1);
            let e5 = Ze({}),
                eV = Ze({}),
                eN = Ze({
                    bank: 0
            ...
            So.backend.paypal_index().then(e$ => {
                e8.value = e$.balance, eN.bank = e$.bank, e1.value = e$.transactions
            });
            ...
            return {
                ...
                submitSend: function () {
                    var e0;
                    let e8 = parseInt(null == (e0 = e5.value) ? void 0 : e0.replace(/\D/g, ""));
                    e5.user_id ? e8 ? So.lockAndProceed(() => So.backend.paypal_send(e5.user_id, e8, e5.message).then(e4.rem)) : e$("Digite o valor a ser transferido") : e$("Digite o passaporte do jogador")
                },
                transfer: eV,
                submitTransfer: function () {
                    var e0;
                    let e8 = parseInt(null == (e0 = eV.value) ? void 0 : e0.replace(/\D/g, ""));
                    e8 ? So.lockAndProceed(() => So.backend.paypal_transfer(e8).then(e4.rem)) : e$("Digite o valor a ser transferido")
                },
                deposit: eN,
                submitDeposit: function () {
                    var e0;
                    let e8 = parseInt(null == (e0 = eN.value) ? void 0 : e0.replace(/\D/g, ""));
                    e8 ? So.lockAndProceed(() => So.backend.paypal_deposit(e8).then(e4.add)) : e$("Digite o valor de dep\xf3sito")
                }
            }
        }
    },
    ...
    AA = Pl("h1", {
        class: "font-bold py-4"
    }, "C\xd3DIGO DE TRANSA\xc7\xc3O", -1),
...
B_.render = function (e$, e0, e8, e2, e3, e1) {
    ...
    return wl(), _l("div", H_, [Pl("div", q_, [Pl("button", {
        onClick: e0[1] || (e0[1] = e0 => "resume" != e2.action ? e2.action = "resume" : e$.$router.back()),
        class: "absolute top-16 left-0 px-4"
    }, [e2.isAndroid ? (wl(), _l("i", K_)) : (wl(), _l("span", G_, [W_, Il(" " + g("resume" == e2.action ? "Apps" : "Resumo"), 1), ])), ]), Pl("h1", {
        class: ["font-bold", {
            "ml-16": e2.isAndroid,
            "text-center": !e2.isAndroid
        }, ]
    }, g(e2.isAndroid ? "resume" == e2.action ? e$.$filters.nameByApp.paypal : "Resumo" : e$.$filters.nameByApp.paypal), 3), ]), "resume" == e2.action ? (wl(), _l("div", J_, [e2.firstPayment ? (wl(), _l("div", X_, [Pl("div", Y_, [Pl("span", Z_, g(e$.$filters.unixToDayOfMonth(e2.firstPayment.created_at)), 1), ]), Pl("p", Q_, [Il(g(e2.firstPayment.user_id == e2.identity.user_id ? "Voc\xea" : e2.firstPayment.fullName) + " enviou ", 1), Pl("b", null, g(e$.$filters.intToMoney(e2.firstPayment.value)), 1), ]), Pl("button", {
        onClick: e0[2] || (e0[2] = e$ => e2.openPayment(e2.firstPayment)),
        class: "mt-8 border-2 px-6 py-1 rounded-full"
    }, "Ver detalhes"), ])) : Ml("", !0), Pl("div", eA, [Pl("div", tA, [nA, Pl("button", {
        onClick: e0[3] || (e0[3] = e$ => e2.notifications = !e2.notifications),
        class: "text-white bg-paypal-light h-12 w-12 text-xl rounded-full"
    }, [Pl("i", {
        class: ["far", e2.notifications ? "fa-bell" : "fa-bell-slash", ]
    }, null, 2), ]), ]), Pl("span", lA, g(e$.$currency), 1), Pl("span", aA, g(e2.balance.toLocaleString("pt-BR")), 1), ]), Pl("div", sA, [Pl("button", {
        class: "text-paypal-light",
        onClick: e0[4] || (e0[4] = e$ => e2.action = "activity")
    }, [oA, rA]), ]), ])) : "details" == e2.action ? (wl(), _l("div", iA, [Pl("div", cA, [uA, Pl("div", dA, ["withdraw" === e2.payment.type ? (wl(), _l("p", pA, " Voc\xea sacou " + g(e$.$filters.intToMoney(e2.payment.value)), 1)) : "deposit" === e2.payment.type ? (wl(), _l("p", fA, " Voc\xea depositou " + g(e$.$filters.intToMoney(e2.payment.value)), 1)) : e2.payment.user_id === e2.identity.user_id ? (wl(), _l("p", mA, " Voc\xea enviou " + g(e$.$filters.intToMoney(e2.payment.value)) + " para " + g(e2.payment.fullName), 1)) : (wl(), _l("p", hA, " Voc\xea recebeu " + g(e$.$filters.intToMoney(e2.payment.value)) + " de " + g(e2.payment.fullName), 1)), ]), ]), e2.payment.description ? (wl(), _l("div", bA, [gA, vA, Pl("span", xA, g(e2.payment.description), 1), ])) : Ml("", !0), Pl("div", yA, [kA, wA, Pl("span", CA, g(e$.$filters.unixToDatetime(e2.payment.created_at)), 1), ]), Pl("div", _A, [AA, SA, Pl("span", TA, g(e2.payment.id), 1)]), ])) : "activity" == e2.action ? (wl(), _l("div", EA, [Pl("ul", null, [(wl(!0), _l(bl, null, fa(e2.extract, e0 => (wl(), _l("li", {
        onClick: e$ => e2.openPayment(e0),
        key: e0.id,
        class: "flex items-center border-b p-4 shadow"
    }, [Pl("div", RA, [e0.user_id != e0.target ? (wl(), _l("i", PA)) : "withdraw" == e0.type ? (wl(), _l("i", LA)) : "deposit" == e0.type ? (wl(), _l("i", IA)) : Ml("", !0), ]), Pl("div", OA, [Pl("span", MA, g("payment" == e0.type ? "Pagamento" : "withdraw" == e0.type ? "Saque" : "Dep\xf3sito"), 1), Pl("span", VA, g(e$.$filters.unixToDate(e0.created_at)), 1), ]), Pl("div", DA, [Pl("span", {
        class: ["text-2xl", e0.user_id == e0.target && "withdraw" == e0.type ? "text-red-500" : 0, e0.user_id != e0.target && e0.user_id == e2.identity.user_id ? "text-red-500" : 0, ]
    }, g(e$.$filters.intToMoney(e0.value)), 3), ]), ], 8, ["onClick"]))), 128)), ]), ])) : "send" == e2.action ? (wl(), _l("div", NA, [Pl(e6, {
        modelValue: e2.send.user_id,
        "onUpdate:modelValue": e0[5] || (e0[5] = e$ => e2.send.user_id = e$),
        format: "int",
        noborder: "1",
        class: "bg-transparent border-b border-blue-400",
        placeholder: "Passaporte"
    }, null, 8, ["modelValue"]), Pl("div", UA, [Pl(e6, {
        modelValue: e2.send.value,
        "onUpdate:modelValue": e0[6] || (e0[6] = e$ => e2.send.value = e$),
        format: "money",
        noborder: "1",
        class: "bg-transparent border-b border-blue-400",
        placeholder: "Valor a ser enviado"
    }, null, 8, ["modelValue"]), Pl("small", $A, [jA, Pl("b", null, g(e$.$filters.intToMoney(e2.balance)), 1), ]), ]), Pl("div", FA, [Pl(e6, {
        modelValue: e2.send.message,
        "onUpdate:modelValue": e0[7] || (e0[7] = e$ => e2.send.message = e$),
        class: "rounded-full px-6",
        placeholder: "Deixa uma mensagem",
        maxlength: "250"
    }, null, 8, ["modelValue"]), Pl("button", {
        onClick: e0[8] || (e0[8] = (...e$) => e2.submitSend && e2.submitSend(...e$)),
        class: "ml-4 p-4 px-8 bg-paypal-light text-white font-semibold rounded-full"
    }, "Transferir"), ]), ])) : "transfer" == e2.action ? (wl(), _l("div", zA, [Pl(e6, {
        modelValue: e2.transfer.value,
        "onUpdate:modelValue": e0[9] || (e0[9] = e$ => e2.transfer.value = e$),
        noborder: "1",
        format: "money",
        placeholder: "Valor para transferir",
        class: "bg-transparent border-b border-blue-400"
    }, null, 8, ["modelValue"]), Pl("small", BA, [HA, Pl("b", null, g(e$.$filters.intToMoney(e2.balance)), 1), ]), Pl("div", qA, [Pl("button", {
        onClick: e0[10] || (e0[10] = (...e$) => e2.submitTransfer && e2.submitTransfer(...e$)),
        class: "bg-paypal-light p-4 px-8 text-white font-semibold rounded-full"
    }, "Sacar"), ]), ])) : "deposit" == e2.action ? (wl(), _l("div", GA, [Pl(e6, {
        modelValue: e2.deposit.value,
        "onUpdate:modelValue": e0[11] || (e0[11] = e$ => e2.deposit.value = e$),
        noborder: "1",
        format: "money",
        placeholder: "Valor para depositar",
        class: "bg-transparent border-b border-blue-400"
    }, null, 8, ["modelValue"]), Pl("small", WA, [KA, Pl("b", null, g(e$.$filters.intToMoney(e2.deposit.bank)), 1), ]), Pl("div", JA, [Pl("button", {
        onClick: e0[12] || (e0[12] = (...e$) => e2.submitDeposit && e2.submitDeposit(...e$)),
        class: "bg-paypal-light p-4 px-8 text-white font-semibold rounded-full"
...
oS.render = function (e$, e0, e8, e2, e3, e1) {
    return wl(), _l("div", rS, [Pl("button", {
        onClick: e0[1] || (e0[1] = e0 => e$.$router.back()),
        class: "absolute top-16 left-0 px-4"
    }, [e2.isAndroid ? (wl(), _l("i", iS)) : (wl(), _l("i", cS))]), Pl("h1", {
        class: ["font-bold", {
            "ml-16": e2.isAndroid,
            "text-center": !e2.isAndroid
        }, ]
...
uS.render = function (e$, e0, e8, e2, e3, e1) {
    return e8.data.id ? (wl(), _l("div", dS, [Pl("img", {
        src: e8.data.images[0],
        class: "w-full block",
        alt: ""
    }, null, 8, ["src"]), Pl("div", pS, [Pl("h1", fS, g(e8.data.title), 1), Pl("div", mS, [Pl("strong", hS, g(e$.$filters.intToMoney(e8.data.price)), 1), Pl("div", bS, [e2.moderator ? (wl(), _l("button", {
        key: 0,
        class: "mr-8 text-red-500",
        onClick: e0[1] || (e0[1] = (...e$) => e2.destroy && e2.destroy(...e$))
    }, [gS])) : Ml("", !0), Pl("button", {
        onClick: e0[2] || (e0[2] = e0 => e$.$router.push("/olx/" + e8.data.id)),
...
const ES = {
        ...
        setup() {
            jl("setDark")(!0);
            let e$ = rt([]);
            return So.backend.olx_search("%", "%").then(e0 => {
                e$.value = e0
            }), {
                ads: e$
            }
...
ES.render = function (e$, e0, e8, e2, e3, e1) {
    let e6 = dl("Header"),
        e4 = dl("Ad"),
        e7 = dl("Footer");
    return wl(), _l("div", RS, [Pl(e6, {
        title: "An\xfancios",
        class: "flex-shrink-0"
    }), Pl("ul", PS, [(wl(!0), _l(bl, null, fa(e2.ads, e$ => (wl(), _l("li", {
        key: e$.id
    }, [Pl(e4, {
        data: e$
    }, null, 8, ["data"])]))), 128)), ]), LS, Pl(e7), ])
};
const IS = rt(""),
    OS = rt(""),
    MS = rt(),
        ...
        setup() {
            ...
            return {
                ...
                submit: function () {
                    ...
                    return e2.title.trim() ? e2.category ? e2.price ? e2.images.length ? (e2.price = parseInt(null == (e8 = e2.price) ? void 0 : e8.replace(/\D/g, "")), void So.backend.olx_createAd(e2).then(e8 => {
                        if (e8.error) return e0(e8.error);
                        e$.replace("/olx"), IS.value = "", OS.value = "", MS.value = void 0, VS.value = "", DS.value = []
                    })) : e0("Ao menos uma imagem \xe9 obrigat\xf3ria.") : e0("Insira um pre\xe7o") : e0("Escolha uma categoria") : e0("T\xedtulo inv\xe1lido")
                }
            }
        }
    },
...
NS.render = function (e$, e0, e8, e2, e3, e1) {
    let e6 = dl("Header"),
        e4 = dl("app-input"),
        e7 = dl("app-select");
    return wl(), _l("div", US, [Pl(e6, {
        title: "Anunciar"
    }), Pl("div", $S, [Pl("div", null, [jS, Pl(e4, {
        darkable: "true",
        modelValue: e2.title,
        ...
        maxlength: "64",
        class: "text-2xl"
    }, null, 8, ["modelValue"]), ]), Pl("div", FS, [zS, Pl(e7, {
        darkable: "true",
        class: "text-2xl",
        modelValue: e2.category,
        "onUpdate:modelValue": e0[2] || (e0[2] = e$ => e2.category = e$),
        options: {
            cars: "Carros",
            motorcycles: "Motos",
            houses: "Casas",
    ...
    }, null, 8, ["modelValue"]), ]), Pl("div", BS, [HS, Pl(e4, {
        darkable: "true",
        modelValue: e2.price,
        ...
        onKeydown: e0[4] || (e0[4] = us(is(() => {}, ["prevent"]), ["enter"])),
        class: "resize-none p-3 bg-theme border border-theme rounded-lg fancy-scroll w-full text-3xl",
        "onUpdate:modelValue": e0[5] || (e0[5] = e$ => e2.description = e$),
        maxlength: "1024",
        rows: "8"
    }, null, 544), [
        [ns, e2.description]
    ]), Pl("span", WS, g(e2.description.length) + "/1024", 1), ]), Pl("div", null, [KS, Pl("div", JS, [(wl(!0), _l(bl, null, fa(e2.images, (e$, e0) => (wl(), _l("img", {
        key: e0,
        src: e$,
        class: "w-24 h-24 border-2 mr-2"
    }, null, 8, ["src"]))), 128)), e2.images.length < 3 ? (wl(), _l("button", {
        key: 0,
        onClick: e0[6] || (e0[6] = (...e$) => e2.addImage && e2.addImage(...e$)),
        class: "w-24 h-24 border-2 border-olx flex flex-center text-olx"
    }, [XS])) : Ml("", !0), ]), ]), Pl("button", {
        onClick: e0[7] || (e0[7] = (...e$) => e2.submit && e2.submit(...e$)),
...
const YS = {
        ...
        setup() {
            ...
            function e3() {
                let e2 = e$.value || "%";
                "%" != e2 && (e2 = "%" + e2 + "%"), So.backend.olx_search(e2, e0.value).then(e$ => e8.value = e$)
            }
            return Tn(e$, () => {
...
YS.render = function (e$, e0, e8, e2, e3, e1) {
    ...
    }, null, 8, ["modelValue"]), ]), Pl("ul", eT, [(wl(!0), _l(bl, null, fa(e2.ads, e$ => (wl(), _l("li", {
        key: e$.id
    }, [Pl(e5, {
        data: e$
    }, null, 8, ["data"])]))), 128)), ]), tT, ])
...
const nT = {
    ...
    }, "An\xfancio n\xe3o encontrado", -1);
nT.render = function (e$, e0, e8, e2, e3, e1) {
    let e6 = dl("Header");
    return wl(), _l("div", lT, [Pl(e6, {
        title: "Detalhes"
    }), e2.ad ? (wl(), _l("div", aT, [Pl("div", sT, [0 != e2.imgIndex ? (wl(), _l("button", {
        key: 0,
        onClick: e0[1] || (e0[1] = e$ => e2.imgIndex = Math.max(0, e2.imgIndex - 1)),
        ...
        alt: ""
    }, null, 8, ["src"]), e2.imgIndex < e2.ad.images.length - 1 ? (wl(), _l("button", {
        key: 1,
        onClick: e0[2] || (e0[2] = e$ => e2.imgIndex = Math.min(e2.ad.images.length - 1, e2.imgIndex + 1)),
        class: "absolute top-0 right-0 text-white h-full w-2/12"
    }, [rT])) : Ml("", !0), ]), Pl("div", iT, [Pl("div", cT, [Pl("h1", uT, g(e$.$filters.intToMoney(e2.ad.price)), 1), Pl("h3", dT, g(e2.ad.title), 1), Pl("span", pT, "Publicado em " + g(e$.$filters.unixToDate(e2.ad.created_at)), 1), ]), fT, Pl("div", mT, [hT, Pl("span", bT, g(e2.ad.description), 1)]), gT, Pl("div", vT, [xT, Pl("ul", yT, [Pl("li", null, [kT, Pl("span", wT, g(e2.ad.author.name), 1)]), Pl("li", null, [CT, Pl("span", _T, g(e2.ad.author.user_id), 1), ]), Pl("li", null, [AT, Pl("span", ST, g(e2.ad.author.phone), 1), e2.yourself.phone != e2.ad.author.phone ? (wl(), _l("button", {
        key: 0,
        class: "ml-3 text-green-500",
        onClick: e0[3] || (e0[3] = e0 => e$.$router.push("/whatsapp/" + e2.ad.author.phone))
    }, [TT])) : Ml("", !0), ]), ]), ]), ]), ])) : !1 === e2.ad ? (wl(), _l("div", ET, [RT])) : Ml("", !0), ])
};
const PT = {
        components: {
            Header: oS,
            ...
            return So.backend.olx_dashboard().then(e$ => {
                ...
                destroy: function (e8) {
                    So.backend.olx_destroy(e8).then(e2 => {
                        (null == e2 ? void 0 : e2.error) ? e$(e2.error): e0.value = e0.value.filter(e$ => e$.id != e8)
                    })
                }
            }
        }
    ...
    }, "Voc\xea n\xe3o possui an\xfancios", -1),
    $T = Pl("div", {
        class: "mt-32"
    }, null, -1);
PT.render = function (e$, e0, e8, e2, e3, e1) {
    var e6;
    let e4 = dl("Header");
    return wl(), _l("div", LT, [Pl(e4, {
        title: "Seus an\xfancios"
    }), (null == (e6 = e2.ads) ? void 0 : e6.length) ? (wl(), _l("div", IT, [Pl("ul", null, [(wl(!0), _l(bl, null, fa(e2.ads, e0 => (wl(), _l("li", {
        key: e0.id,
        class: "border-b border-theme last:border-b-0 flex"
    }, [Pl("img", {
        src: e0.images[0],
        class: "h-32"
    }, null, 8, ["src"]), Pl("div", OT, [Pl("h1", MT, g(e0.title), 1), Pl("h3", VT, g(e$.$filters.intToMoney(e0.price)), 1), ]), Pl("button", {
        class: "m-3 p-2",
        onClick: e$ => e2.destroy(e0.id)
    }, [DT], 8, ["onClick"]), ]))), 128)), ]), ])) : e2.ads ? (wl(), _l("div", NT, [UT])) : Ml("", !0), $T, ])
};
const jT = {},
    FT = {
...
jT.render = function (e$, e0) {
    return wl(), _l("div", FT, [Pl("button", null, [Pl("img", {
        ...
        onClick: e0[2] || (e0[2] = e0 => e$.$router.replace("/tinder/likes"))
    }, null, 12, ["src"]), ]), Pl("button", null, [Pl("img", {
        ...
        onClick: e0[3] || (e0[3] = e0 => e$.$router.replace("/tinder/chats"))
    }, null, 12, ["src"]), ]), Pl("button", null, [Pl("img", {
        ...
        onClick: e0[4] || (e0[4] = e0 => e$.$router.replace("/tinder/profile"))
    }, null, 12, ["src"]), ]), ])
};
const zT = {
        components: {
        ...
        setup() {
            ...
            let e$ = cc(),
                e0 = rt();
            return So.backend.tinder().then(async e8 => {
                e8 ? e0.value = await So.backend.tinder_next(0) : "/tinder" == e$.currentRoute.value.path && e$.replace("/tinder/register")
            }), {
                peer: e0,
                back: function () {
                    e0.value && So.backend.tinder_next(e0.value.id, !1).then(e$ => {
                        e$ ? e0.value = e$ : e0.value.previous = !1
                    })
                },
                next: function (e$) {
                    e0.value && So.backend.tinder_next(e0.value.id, !0, e$).then(e$ => e0.value = e$)
                }
            }
        }
    },
    ...
    }, "N\xe3o encontramos ningu\xe9m compat\xedvel com voc\xea.", -1);
zT.render = function (e$, e0, e8, e2, e3, e1) {
    let e6 = dl("Header");
    return wl(), _l("div", BT, [Pl(e6), e2.peer && "object" == typeof e2.peer ? (wl(), _l("div", HT, [Pl("div", qT, [Pl("img", {
        src: e2.peer.image,
        class: "rounded-2xl w-full max-h-96 mx-auto"
    }, null, 8, ["src"]), Pl("div", GT, [Pl("div", WT, [Pl("h1", KT, g(e2.peer.name), 1), Pl("h3", JT, g(e2.peer.age), 1), ]), Pl("div", XT, [Pl("div", {
        class: ["w-2 h-2 rounded-full", [e2.peer.online ? "bg-green-400" : "bg-gray-400"], ]
    }, null, 2), Pl("span", YT, g(e2.peer.online ? "Online" : "Offline"), 1), ]), e2.peer.show_tags ? (wl(), _l("ul", ZT, [(wl(!0), _l(bl, null, fa(e2.peer.tags, (e$, e0) => (wl(), _l("li", {
        key: e0,
        class: "text-xl tinder-chip"
    }, g(e$), 1))), 128)), ])) : Ml("", !0), ]), ]), Pl("p", QT, g(e2.peer.bio), 1), Pl("div", eE, [e2.peer.previous ? (wl(), _l("button", {
        key: 0,
            ...
            return {
                ...
                next: function () {
                    ...
                    if (lE.name) {
                                ...
                                if (lE.tags) {
                                    if (lE.target) {
                                        if (!lE.bio) {
                                            ...
                                            if (e3.length > 1024) return e2.value = "Limite de caracteres ultrapassado";
                                            lE.bio = e3, So.backend.tinder_register(lE).then(() => {
                                                e0.replace("/tinder")
                                            })
                                        }
                                    } else {
                                    ...
                                    let e6 = [...e8.tags];
                                    if (!e6.length) return e2.value = "Escolha pelo menos uma orienta\xe7\xe3o";
                                    if (e6.length > 3) return e2.value = "Escolha no m\xe1ximo 3";
                                    lE.tags = e6
                                }
                            } else {
                                let e4 = e8.gender;
                        ...
                        if (e5.match(/[\d!@#$%&*()\-=_+/]/)) return e2.value = "Seu nome n\xe3o pode ter n\xfameros/s\xedmbolos";
                        lE.name = e5
                    }
                    e2.value = null
                }
...
const oE = {
    ...
    }, "\xc9 assim que o seu nome vai aparecer no Tinder e voc\xea n\xe3o poder\xe1 alter\xe1-lo depois.", -1),
    pE = {
        key: 1,
        class: "mt-96 px-20"
    },
    fE = Pl("p", {
        class: "text-xl text-gray-400 mt-2"
    }, "Sua idade ser\xe1 p\xfablica.", -1),
    mE = {
        key: 2,
        class: "mt-80 px-20"
    },
    ...
    }, "Selecione o seu g\xeanero.", -1),
    bE = {
        class: "flex items-center"
    },
    gE = Pl("label", {
        class: "ml-2 text-2xl tinder-gray"
    }, "Mostrar meu g\xeanero no perfil", -1),
    vE = {
        key: 3,
        class: "mt-60 px-20"
    },
    xE = Pl("span", {
        class: "text-2xl tinder-gray"
    }, "Selecione at\xe9 3", -1),
    yE = {
        class: "flex items-center"
    },
    kE = Pl("label", {
        class: "ml-2 text-2xl tinder-gray"
    }, "Mostrar minha orienta\xe7\xe3o no meu perfil", -1),
    wE = {
        key: 4,
        class: "mt-72 px-20"
    },
    ...
    SE = Pl("p", {
        class: "text-xl tinder-gray"
    }, "\xc9 assim que a sua biografia vai aparecer no Tinder, mas voc\xea poder\xe1 alter\xe1-la depois.", -1),
    TE = {
        key: 6,
...
const PE = sE((e$, e0, e8, e2, e3, e1) => {
    let e6 = dl("app-loading");
    return wl(), _l("div", oE, [e2.payload.image ? (wl(), _l("div", cE, [Pl("img", {
        class: "mx-auto mt-20 h-16",
        src: e$.$asset("stock/tinder/logo.svg", "tinderLogo"),
        style: {
            filter: "invert(0.4)"
        }
    }, null, 8, ["src"]), e2.payload.name ? e2.payload.age ? e2.payload.gender ? e2.payload.tags ? e2.payload.target ? e2.payload.bio ? (wl(), _l("div", TE, [Pl(e6, {
        style: {
            filter: "invert(0.5)"
        }
    }), ])) : (wl(), _l("div", _E, [AE, Zn(Pl("textarea", {
        "onUpdate:modelValue": e0[10] || (e0[10] = e$ => e2.tmp.bio = e$),
        onKeydown: e0[11] || (e0[11] = us(is(() => {}, ["prevent"]), ["enter"])),
    ...
    }, g(e$), 11, ["onClick"])), 64)), ])) : (wl(), _l("div", vE, [xE, (wl(), _l(bl, null, fa(["Heterossexual", "Gay", "L\xe9sbica", "Bissexual", "Assexual", "Demissexual", "Pansexual", "Outros", ], e$ => Pl("button", {
        key: e$,
        class: ["block mb-3 text-5xl text-gray-400 transition-color duration-300", {
            "text-gray-900": e2.tmp.tags.has(e$)
        }, ],
        onClick: e0 => e2.tmp.tags.has(e$) ? e2.tmp.tags.delete(e$) : e2.tmp.tags.add(e$)
    }, g(e$), 11, ["onClick"])), 64)), Pl("div", yE, [Zn(Pl("input", {
        "onUpdate:modelValue": e0[9] || (e0[9] = e$ => e2.payload.show_tags = e$),
        type: "checkbox",
        style: {
            filter: "grayscale(1)"
        }
        ...
        onClick: e0[6] || (e0[6] = e$ => e2.tmp.gender = "Male"),
        class: ["w-full border border-gray-200 rounded-xl py-3 mb-3", {
            "border-gray-500": "Male" == e2.tmp.gender
        }, ]
    }, " Homem ", 2), Pl("button", {
        onClick: e0[7] || (e0[7] = e$ => e2.tmp.gender = "Female"),
        class: ["w-full border border-gray-200 rounded-xl py-3 mb-3", {
            "border-gray-500": "Female" == e2.tmp.gender
        }, ]
    }, " Mulher ", 2), Pl("div", bE, [Zn(Pl("input", {
        "onUpdate:modelValue": e0[8] || (e0[8] = e$ => e2.payload.show_gender = e$),
        type: "checkbox",
        style: {
            filter: "grayscale(1)"
        }
        ...
        autofocus: "",
        onKeydown: e0[4] || (e0[4] = us((...e$) => e2.next && e2.next(...e$), ["enter"])),
        "onUpdate:modelValue": e0[5] || (e0[5] = e$ => e2.tmp.age = e$),
        type: "text",
        maxlength: "3",
        min: "18",
        placeholder: "21",
        ...
        autofocus: "",
        onKeydown: e0[2] || (e0[2] = us((...e$) => e2.next && e2.next(...e$), ["enter"])),
        "onUpdate:modelValue": e0[3] || (e0[3] = e$ => e2.tmp.name = e$),
        type: "text",
        maxlength: "255",
        ...
        [ns, e2.tmp.name]
    ]), dE, ])), e2.error ? (wl(), _l("p", EE, g(e2.error), 1)) : Ml("", !0), e2.payload.bio ? Ml("", !0) : (wl(), _l("div", RE, [Pl("button", {
        onClick: e0[12] || (e0[12] = (...e$) => e2.next && e2.next(...e$)),
...
const LE = {
        ...
        setup() {
            jl("setDark")(!1);
            let e$ = rt();
            return So.backend.tinder_liked().then(e0 => {
                e$.value = e0
            }), {
                likes: e$
            }
...
const OE = {
    ...
    }, "Ainda ningu\xe9m te curtiu, mas eu curto voc\xea.", -1),
    DE = {
        key: 1,
...
const UE = IE((e$, e0, e8, e2, e3, e1) => {
    let e6 = dl("Header");
    return wl(), _l("div", OE, [Pl(e6), e2.likes && !e2.likes.length ? (wl(), _l("div", ME, [Pl("img", {
        src: e$.$asset("stock/tinder/dislike.svg"),
        class: "w-2/3 mx-auto"
    }, null, 8, ["src"]), VE, ])) : (wl(), _l("div", DE, [(wl(!0), _l(bl, null, fa(e2.likes, e$ => (wl(), _l("div", {
        class: "relative",
        key: e$.id
    }, [Pl("img", {
        src: e$.image,
...
const $E = {
        ...
        setup() {
            jl("setDark")(!1);
            let e$ = rt([]),
                e0 = da(() => e$.value.filter(e$ => e$.last_message).sort((e$, e0) => e0.last_message.created_at - e$.last_message.created_at)),
                e8 = da(() => e$.value.filter(e$ => !e$.last_message));
            return So.backend.tinder_matches().then(e0 => {
                e$.value = null != e0 ? e0 : []
...
$E.render = function (e$, e0, e8, e2, e3, e1) {
    var e6, e4;
    let e7 = dl("Header");
    return wl(), _l("div", jE, [Pl(e7), e2.fresh.length ? (wl(), _l("div", FE, [zE, Pl("div", BE, [(wl(!0), _l(bl, null, fa(e2.fresh, e0 => (wl(), _l("div", {
        key: e0.id,
        onClick: e8 => e$.$router.push("/tinder/chats/" + e0.id),
        class: "flex flex-col flex-shrink-0 justify-center pr-3"
    }, [Pl("img", {
        src: e0.image,
        class: "w-20 h-20 rounded-full"
    }, null, 8, ["src"]), Pl("h1", HE, g(e0.name), 1), ], 8, ["onClick"]))), 128)), ]), ])) : Ml("", !0), (null == (e6 = e2.conversations) ? void 0 : e6.length) ? (wl(), _l("p", qE, "Mensagens")) : Ml("", !0), (null == (e4 = e2.conversations) ? void 0 : e4.length) ? (wl(), _l("div", GE, [(wl(!0), _l(bl, null, fa(e2.conversations, e0 => {
        var e8;
        return wl(), _l("div", {
            key: e0.id,
            onClick: e8 => e$.$router.push("/tinder/chats/" + e0.id),
            ...
            src: e0.image,
            class: "w-24 h-24 rounded-full"
        }, null, 8, ["src"]), Pl("div", WE, [Pl("h1", KE, g(e0.name), 1), Pl("div", JE, [Pl("p", XE, g(e0.last_message.content.substr(0, 32)), 1), Pl("p", YE, g(e$.$filters.unixToHHMM(null != (e8 = e0.last_message.created_at) ? e8 : Date.now() / 1e3)), 1), ]), ]), ], 8, ["onClick"])
    }), 128)), ])) : Ml("", !0), ])
};
const ZE = {
        setup() {
            ...
            function e7(e$) {
                e3.value || Lt(() => {
                    var e0;
                    return null == (e0 = document.querySelector(".overflow-y-auto")) ? void 0 : e0.scrollTo({
                        left: 0,
                        top: 9e6,
            ...
            return So.backend.tinder_chat(e2).then(e$ => {
                var {
                    messages: e0,
                    avatars: e8
                } = e$, e2 = o(e$, ["messages", "avatars"]);
                e1.value = e2, e6.value = e8, e4.push(... function (e$) {
                    let e0 = [],
                        e8 = [];
                    for (let e2 of e$) e8.length && e8[e8.length - 1].sender != e2.sender ? (e0.push(e8), e8 = [e2]) : e8.push(e2);
                ...
                sendMessage: function () {
                    e3.value && (So.backend.tinder_sendMessage(e2, e3.value), e3.value = null)
                },
                dismatch: async function () {
                    e8("Deseja dar dismatch?").then(e$ => e$ && So.backend.tinder_dismatch(e2).then(() => e0.back()))
                },
                like: function (e$) {
...
const pR = QE((e$, e0, e8, e2, e3, e1) => {
    ...
    return wl(), _l("div", eR, [Pl("div", tR, [Pl("button", {
        ...
        src: null != (e6 = e2.chat.image) ? e6 : e$.$asset("apps/user.svg"),
        class: "w-16 h-16 rounded-full mx-auto"
    }, null, 8, ["src"]), Pl("p", aR, g(e2.chat.name), 1), ]), Pl("button", {
        onClick: e0[2] || (e0[2] = e$ => e2.dismatch()),
        class: "absolute top-20 right-8"
    }, [sR]), ]), Pl("div", oR, [(wl(!0), _l(bl, null, fa(e2.blocks, (e0, e8) => (wl(), _l("div", {
        key: e8,
        class: "mb-4"
    }, [Pl("h1", rR, g(e$.$filters.unixToLocale(e0[0].created_at)), 1), Pl("div", {
    ...
    }, [(wl(!0), _l(bl, null, fa(e0, (e$, e0) => (wl(), _l("div", {
        key: e0,
        sender: e$.sender != e2.id,
        class: "relative min-8rem mb-4 last:mb-0 px-4 py-2 rounded-2xl"
    }, [Pl("p", iR, g(e$.content), 1), e$.sender != e2.id && e$.liked ? (wl(), _l("p", cR, "Curtiu sua mensagem")) : Ml("", !0), e$.sender == e2.id ? (wl(), _l("button", {
        key: 1,
        ...
        "onUpdate:modelValue": e0[3] || (e0[3] = e$ => e2.content = e$),
        onKeydown: e0[4] || (e0[4] = us((...e$) => e2.sendMessage && e2.sendMessage(...e$), ["enter"])),
        maxlength: "255",
        type: "text",
        ...
        onClick: e0[5] || (e0[5] = (...e$) => e2.sendMessage && e2.sendMessage(...e$)),
...
const fR = {
        ...
        setup() {
            ...
            return Tn(e8, e$ => So.setNotificationFor("tinder", e$)), Tn(() => e0.value.target, (e$, e0) => e0 && So.backend.tinder_changeTarget(e$)), So.backend.tinder().then(e$ => e0.value = e$), {
                profile: e0,
                notifications: e8,
                changeAvatar: async function () {
                    try {
                ...
                changeBio: function () {
                    let e8 = e0.value.bio;
                    return e8 ? e8.length > 1024 ? e$("A bio n\xe3o pode ser maior que 1024 caracteres") : void So.backend.tinder_changeBio(e8) : e$("A bio n\xe3o pode ficar vazia")
                },
...
const ER = mR((e$, e0, e8, e2, e3, e1) => {
    let e6 = dl("Header"),
        e4 = dl("app-select"),
        e7 = dl("app-toggle");
    return wl(), _l("div", hR, [Pl(e6), e2.profile.id ? (wl(), _l("div", bR, [Pl("div", gR, [Pl("img", {
        ...
        alt: ""
    }), ]), Pl("div", vR, [Pl("p", xR, g(e2.profile.name), 1), Pl("p", null, ", " + g(e2.profile.age), 1), ]), Pl("div", yR, [kR, Zn(Pl("textarea", {
        "onUpdate:modelValue": e0[2] || (e0[2] = e$ => e2.profile.bio = e$),
        onChange: e0[3] || (e0[3] = (...e$) => e2.changeBio && e2.changeBio(...e$)),
        ...
        "onUpdate:modelValue": e0[4] || (e0[4] = e$ => e2.profile.target = e$),
        options: {
            Male: "Homens",
            Female: "Mulheres",
            All: "Todos"
        }
    }, null, 8, ["modelValue"]), ]), Pl("div", _R, [Pl("div", AR, [SR, Pl(e7, {
        modelValue: e2.notifications,
        "onUpdate:modelValue": e0[5] || (e0[5] = e$ => e2.notifications = e$)
    }, null, 8, ["modelValue"]), ]), ]), Pl("div", TR, [Pl("button", {
        onClick: e0[6] || (e0[6] = (...e$) => e2.deleteAccount && e2.deleteAccount(...e$)),
...
const RR = {
    setup() {
        ...
        let e$ = uc().params.id,
            ...
            e8 = Object.entries(e0).map(e$ => e$.map(encodeURIComponent).join("=")).join("&");
        return {
            src: da(() => {
                var e0;
                return (null == (e0 = So.settings.customApps) ? void 0 : e0[e$]) + "?" + e8
            }),
            id: e$
        }
    }
...
PR.render = function (e$, e0, e8, e2, e3, e1) {
    return wl(), _l("div", LR, [Pl("button", {
        onClick: e0[1] || (e0[1] = (...e0) => e$.$router.back && e$.$router.back(...e0)),
        class: "absolute top-16 left-0 px-4"
    }, [e2.isAndroid ? (wl(), _l("i", IR)) : (wl(), _l("i", OR))]), Pl("h1", {
        class: ["font-bold", {
            "ml-16": e2.isAndroid,
            "text-center": !e2.isAndroid
        }, ]
    }, g(e8.title), 3), Zt(e$.$slots, "default"), ])
};
const MR = {
        components: {
            Header: PR
        ...
        setup() {
            ...
            let e$ = jl("confirm"),
                ...
                e1 = da(() => {
                    let e$ = e2.value;
                    return e$ ? e3.value.filter(({
                        title: e0,
                        author: e2
                    }) => e8(e0, e$) || e8(e2.name, e$) || e8(e2.phone, e$)) : e3.value
                }),
                e6 = da(() => e3.value.some(e$ => e$.author.user_id == So.identity.user_id));
            return So.backend.yellowpages_index().then(e$ => e3.value = e$), {
                appName: e0,
                dark: So.darkTheme,
                hasPost: e6,
                query: e2,
                ...
                destroy: function () {
                    e$("Deseja excluir seu an\xfancio?").then(e$ => e$ && So.backend.yellowpages_destroy().then(() => {
                        e3.value = e3.value.filter(e$ => e$.author.user_id != So.identity.user_id)
                    }))
                }
            }
        }
...
MR.render = function (e$, e0, e8, e2, e3, e1) {
    let e6 = dl("Header"),
        e4 = dl("app-input");
    return wl(), _l("div", VR, [Pl(e6, {
        title: e2.appName
    }, {
        default: en(() => [e2.hasPost ? (wl(), _l("button", {
            key: 0,
            class: "absolute top-16 right-0 px-5",
            onClick: e0[1] || (e0[1] = (...e$) => e2.destroy && e2.destroy(...e$))
        }, [DR])) : (wl(), _l("button", {
            key: 1,
            class: "absolute top-16 right-0 px-5",
            onClick: e0[2] || (e0[2] = e0 => e$.$router.push("/yellowpages/create"))
        }, [NR])), ]),
        _: 1
    }, 8, ["title"]), Pl("div", UR, [Pl("i", {
        class: ["absolute top-9 left-10 fas fa-search text-2xl", [e2.dark ? "text-gray-800" : "text-gray-400"], ]
    }, null, 2), Pl(e4, {
        modelValue: e2.query,
        "onUpdate:modelValue": e0[3] || (e0[3] = e$ => e2.query = e$),
        placeholder: "Buscar",
        class: "text-2xl bg-theme border-theme pl-14"
    }, null, 8, ["modelValue"]), ]), Pl("ul", $R, [(wl(!0), _l(bl, null, fa(e2.posts, e$ => (wl(), _l("li", {
        key: e$.id,
...
const BR = {
        ...
        setup() {
            ...
            return {
                ...
                title: e0,
                publish: function () {
                    e0.value.trim().length && So.backend.yellowpages_store(e0.value).then(() => e$.back())
                }
            }
        }
    },
        ...
        methods: {
            ...
            equal() {
                if (!this.operator && this.lastOperation) {
                    ...
                    this.operator = e$, this.tmp_value = this.result, this.result = e0
                }
            ...
            calculate() {
                ...
                this.lastOperation = [this.operator, e8], this.result = e$.toString()
            }
        }
    },
    KR = {
...
WR.render = function (e$, e0, e8, e2, e3, e1) {
    return wl(), _l("div", KR, [Pl("div", JR, [Zn(Pl("input", {
        ...
        style: {
            fontSize: Math.min(8, 20 / String(e3.result).length * 2.75) + "rem"
        },
        type: "text",
        "onUpdate:modelValue": e0[1] || (e0[1] = e$ => e3.result = e$),
        disabled: ""
    }, null, 4), [
        [ns, e3.result]
    ]), Pl("div", XR, [Pl("div", {
        class: "bg-gray-500 w-28 py-8 text-center rounded-full",
        onClick: e0[2] || (e0[2] = (...e$) => e1.clear && e1.clear(...e$))
    }, "AC"), Pl("div", {
        class: "bg-gray-500 w-28 py-8 text-center rounded-full",
        onClick: e0[3] || (e0[3] = (...e$) => e1.invert && e1.invert(...e$))
    }, "+/-"), Pl("div", {
        class: "bg-gray-500 w-28 py-8 text-center rounded-full",
        onClick: e0[4] || (e0[4] = (...e$) => e1.percent && e1.percent(...e$))
    }, "%"), Pl("div", {
        ...
        onClick: e0[10] || (e0[10] = (...e$) => e1.addPoint && e1.addPoint(...e$)),
        class: "bg-gray-800 text-white w-28 py-8 text-center rounded-full"
    }, "."), Pl("div", {
        class: "bg-orange-400 text-white w-28 text-center py-8 rounded-full",
        onClick: e0[11] || (e0[11] = (...e$) => e1.equal && e1.equal(...e$))
    }, [sP]), ]), ]), ])
};
const oP = {
        props: ["title"],
...
oP.render = function (e$, e0, e8, e2, e3, e1) {
    return wl(), _l("div", rP, [Pl("button", {
        ...
        onClick: e0[1] || (e0[1] = (...e0) => e$.$router.back && e$.$router.back(...e0))
    }, [e2.isAndroid ? (wl(), _l("i", iP)) : (wl(), _l("i", cP))]), Pl("h1", {
        class: [{
            "ml-16": e2.isAndroid,
            "mx-auto": !e2.isAndroid
        }, "font-bold", ]
        ...
        setup() {
            ...
            return {
                ...
                change: function (e$, e0) {
                    let e2 = e8.value,
                        e3 = e2[e0];
                    e2[e0] = e2[e$], e2[e$] = e3, localStorage.setItem("smartphone@notes", JSON.stringify(e2))
                },
                destroy: function (e0) {
                    e$("Deseja apagar essa anota\xe7\xe3o?").then(e$ => {
                        if (e$) {
                            let e2 = e8.value;
                            e2.splice(e0, 1), localStorage.setItem("smartphone@notes", JSON.stringify(e2))
                        }
                    })
                }
            }
...
uP.render = function (e$, e0, e8, e2, e3, e1) {
    let e6 = dl("Header");
    return wl(), _l("div", dP, [Pl(e6, {
        title: "Notas"
    }, {
        default: en(() => [Pl("button", {
            class: "absolute right-0 top-16 px-5",
            onClick: e0[1] || (e0[1] = e0 => e$.$router.push("/notes/create"))
        }, [pP]), ]),
        _: 1
    }), Pl("ul", fP, [(wl(!0), _l(bl, null, fa(e2.notes, (e8, e3) => (wl(), _l("li", {
        key: e3,
        ...
        key: 0,
        onClick: is(e$ => e2.change(e3, e3 - 1), ["stop"])
    }, [mP], 8, ["onClick"])) : Ml("", !0), e3 < e2.notes.length - 1 ? (wl(), _l("button", {
        key: 1,
        onClick: is(e$ => e2.change(e3, e3 + 1), ["stop"])
    }, [hP], 8, ["onClick"])) : Ml("", !0), ]), Pl("div", bP, [e8.text.trim() ? (wl(), _l("p", gP, g(e8.text.substr(0, 32)), 1)) : (wl(), _l("p", vP, "(Sem conte\xfado)")), Pl("p", xP, g(new Date(e8.updated_at).toLocaleString("pt-BR")), 1), ]), Pl("button", {
        class: "ml-auto px-5",
...
const kP = {
        ...
        setup() {
            ...
            return Lt(() => document.querySelector("textarea").focus()), {
                ...
                save: function () {
                    var e8;
                    let e2 = JSON.parse(null != (e8 = localStorage.getItem("smartphone@notes")) ? e8 : "[]"),
                        e3 = Date.now();
                    e2.push({
                        text: e0.value,
                        created_at: e3,
                        updated_at: e3
                    }), localStorage.setItem("smartphone@notes", JSON.stringify(e2)), e$.back()
                }
            }
        }
    },
        ...
        setup() {
            ...
            return {
                ...
                save: function () {
                    ...
                    e2[e0].text = e8.value, e2[e0].updated_at = Date.now(), localStorage.setItem("smartphone@notes", JSON.stringify(e2)), e$.back()
                }
            }
        }
    },
        ...
        setup() {
            let e$ = So.settings.isAndroid,
                ...
                e8 = Ze(So.localhost ? [{
                    ...
                    description: "N\xe3o foi encontrado nenhum pinto no local, a policia informou que est\xe1 atr\xe1s de quem possa ter causado este incidente...",
            ...
            return Tn(e1, e$ => So.setNotificationFor("weazel", e$)), TP.length || So.backend.weazel_tags().then(e$ => TP.push(...e$)), So.backend.weazel_index().then(e$ => {
                e8.push(...e$)
            }), So.backend.weazel_check().then(e$ => e3.value = e$), So.pusher.on("WEAZEL_DESTROY", e$ => {
                ...
                destroy: async function (e$) {
                    await So.confirm("Tem certeza que deseja excluir esta not\xedcia?") && So.backend.weazel_destroy(e$)
                },
                title: e0,
                news: e8,
                tags: TP,
                setTag: function (e$) {
                    e2.value != e$ && (e2.value = e$, So.backend.weazel_tag(e$).then(e$ => {
...
EP.render = function (e$, e0, e8, e2, e3, e1) {
    return wl(), _l("div", RP, [Pl("div", PP, [Pl("button", {
        onClick: e0[1] || (e0[1] = e0 => e$.$router.back()),
        class: "absolute top-16 px-5"
    }, [e2.isAndroid ? (wl(), _l("i", LP)) : (wl(), _l("i", IP))]), Pl("h1", {
        class: [{
            "ml-16": e2.isAndroid,
            "mx-auto": !e2.isAndroid
        }, "font-bold", ]
    }, g(e2.title), 3), Pl("button", {
        onClick: e0[2] || (e0[2] = e$ => e2.notifications = !e2.notifications),
        class: "absolute top-20 right-8 w-6 h-4 flex flex-center"
    }, [e2.notifications ? (wl(), _l("i", OP)) : (wl(), _l("i", MP))]), ]), e2.isJournalist ? (wl(), _l("button", {
        key: 0,
        onClick: e0[3] || (e0[3] = e0 => e$.$router.push("/weazel/create")),
        class: "bg-weazel w-24 h-24 absolute bottom-8 right-8 rounded-full"
    }, [VP])) : Ml("", !0), Pl("div", DP, [Pl("div", NP, [(wl(!0), _l(bl, null, fa(e2.tags, e$ => (wl(), _l("button", {
        key: e$,
        onClick: e0 => e2.setTag(e$),
        class: "bg-theme-accent p-2 mt-2 rounded-xl mr-5"
    }, g(e$), 9, ["onClick"]))), 128)), ]), Pl("ul", UP, [(wl(!0), _l(bl, null, fa(e2.news, e0 => (wl(), _l("li", {
        key: e0.id,
        onClick: e8 => e$.$router.push("/weazel/" + e0.id),
        class: "border-b border-theme py-5"
    }, [Pl("div", $P, [Pl("div", jP, [Pl("h1", FP, g(e0.title), 1), Pl("p", zP, g(e$.$filters.ellipsis(e0.description.split("\n")[0], 120)), 1), ]), e0.imageURL ? (wl(), _l("img", {
        key: 0,
        class: "h-32 ml-4 rounded-xl",
        src: e0.imageURL
    }, null, 8, ["src"])) : Ml("", !0), ]), Pl("div", BP, [Pl("span", HP, [Il(g(e$.$filters.unixToRelative(e0.created_at)) + " ", 1), qP, Il(" " + g(e0.views.toLocaleString()), 1), ]), e2.isJournalist ? (wl(), _l("div", GP, [Pl("button", {
        onClick: is(e8 => e$.$router.push("/weazel/" + e0.id + "/edit"), ["stop"]),
        class: "ml-auto text-blue-600"
    }, [WP], 8, ["onClick"]), Pl("button", {
        onClick: is(e$ => e2.destroy(e0.id), ["stop"]),
...
JP.render = function (e$, e0, e8, e2, e3, e1) {
    return wl(), _l("input", {
        type: e8.type,
        value: e8.modelValue,
        onInput: e0[1] || (e0[1] = (...e$) => e1.changeValue && e1.changeValue(...e$)),
...
XP.render = function (e$, e0, e8, e2, e3, e1) {
    return wl(), _l("select", {
        value: e8.modelValue,
        onChange: e0[1] || (e0[1] = e0 => e$.$emit("update:modelValue", e0.target.value)),
        ...
        value: null
    }, "Escolha uma op\xe7\xe3o", 8, ["selected"]), (wl(!0), _l(bl, null, fa(e8.options, (e$, e0) => (wl(), _l("option", {
        key: e0,
        value: e0,
        ...
        setup() {
            ...
            function e2(e$) {
                if (null == e$ ? void 0 : e$.error) So.alert(e$.error);
                    ...
                    for (let e0 in VO.back(), YP) "title" == e0 || "description" == e0 ? YP[e0] = "" : delete YP[e0];
            ...
            return So.backend.weazel_tags().then(e$ => {
                ...
                onPublishClick: function () {
                    e0 ? So.backend.weazel_update(e0, YP).then(e2) : So.backend.weazel_publish(YP).then(e2)
                },
...
ZP.render = function (e$, e0, e8, e2, e3, e1) {
    ...
    return wl(), _l("div", QP, [Pl("div", eL, [Pl("button", {
        onClick: e0[1] || (e0[1] = e0 => e$.$router.back()),
        class: "absolute top-16 px-5"
    }, [e2.isAndroid ? (wl(), _l("i", tL)) : (wl(), _l("i", nL))]), Pl("h1", {
        class: [{
            "ml-16": e2.isAndroid,
            "mx-auto": !e2.isAndroid
        }, "font-bold", ]
    }, g(e2.form.id ? "Editar not\xedcia" : "Criar not\xedcia"), 3), ]), Pl("div", lL, [Pl("div", null, [aL, Pl(e6, {
        class: "text-xl bg-theme border-theme",
        modelValue: e2.form.title,
        "onUpdate:modelValue": e0[2] || (e0[2] = e$ => e2.form.title = e$)
    }, null, 8, ["modelValue"]), ]), Pl("div", null, [sL, Pl(e6, {
        class: "text-xl bg-theme border-theme",
        modelValue: e2.form.author,
        "onUpdate:modelValue": e0[3] || (e0[3] = e$ => e2.form.author = e$)
    }, null, 8, ["modelValue"]), ]), Pl("div", null, [oL, Pl(e4, {
        class: "text-xl py-4 bg-theme border-theme",
        modelValue: e2.form.tag,
        "onUpdate:modelValue": e0[4] || (e0[4] = e$ => e2.form.tag = e$),
        options: e2.tags
        ...
        "onUpdate:modelValue": e0[5] || (e0[5] = e$ => e2.form.description = e$),
        rows: "8"
    }, null, 512), [
        [ns, e2.form.description]
    ]), ]), Pl("div", null, [iL, Pl(e6, {
        class: "text-xl bg-theme border-theme",
        modelValue: e2.form.videoURL,
        "onUpdate:modelValue": e0[6] || (e0[6] = e$ => e2.form.videoURL = e$),
        placeholder: "Exemplo: https://www.youtube.com/watch?v=cDg7eF99nR"
    }, null, 8, ["modelValue"]), ]), Pl("div", null, [cL, e2.form.imageURL ? (wl(), _l("img", {
        key: 0,
        onClick: e0[7] || (e0[7] = (...e$) => e2.onImageClick && e2.onImageClick(...e$)),
        src: e2.form.imageURL,
        class: "rounded-xl w-1/2",
        alt: ""
    }, null, 8, ["src"])) : (wl(), _l("button", {
        key: 1,
        onClick: e0[8] || (e0[8] = (...e$) => e2.onImageClick && e2.onImageClick(...e$)),
        class: "bg-weazel block p-2 rounded mt-1"
    }, "Adicionar")), ]), Pl("div", uL, [e2.form.id ? Ml("", !0) : (wl(), _l("button", {
        key: 0,
        onClick: e0[9] || (e0[9] = (...e$) => e2.onPreviewClick && e2.onPreviewClick(...e$)),
        class: "bg-weazel p-2 px-4 mr-4 rounded mt-1"
    }, "Prever notifica\xe7\xe3o")), Pl("button", {
        onClick: e0[10] || (e0[10] = (...e$) => e2.onPublishClick && e2.onPublishClick(...e$)),
...
const dL = {
        setup() {
            ...
            return So.backend.weazel_view(e0.id).then(e$ => {
...
dL.render = function (e$, e0, e8, e2, e3, e1) {
    ...
    return wl(), _l("div", pL, [Pl("div", fL, [Pl("button", {
        onClick: e0[1] || (e0[1] = e0 => e$.$router.back()),
        class: "absolute top-16 px-5"
    }, [e2.isAndroid ? (wl(), _l("i", mL)) : (wl(), _l("i", hL))]), Pl("h1", {
        class: [{
            "ml-16": e2.isAndroid,
            "mx-auto": !e2.isAndroid
        }, "font-bold overflow-ellipsis w-96 overflow-hidden whitespace-nowrap", ]
    }, g(null != (e6 = e2.post.title) ? e6 : "Carregando..."), 3), ]), e2.post.description ? (wl(), _l("div", bL, [Pl("div", gL, [Pl("p", vL, g(e2.post.description), 1), e2.post.imageURL ? (wl(), _l("img", {
        key: 0,
        class: "w-full rounded-xl",
        src: e2.post.imageURL
    }, null, 8, ["src"])) : Ml("", !0), e2.videoURL ? (wl(), _l("iframe", {
        key: 1,
        ...
        allowfullscreen: ""
    }, null, 8, ["src"])) : Ml("", !0), Pl("div", xL, [Pl("h1", null, g(e$.$filters.unixToRelative(e2.post.created_at)) + " - Em " + g(e2.post.tag), 1), Pl("h1", null, g(e2.post.author), 1), ]), ]), Pl("h1", yL, g(e2.post.views) + " visualiza\xe7\xf5es", 1), ])) : Ml("", !0), ])
};
const wL = {},
            ...
            async function e9(e$) {
                if (!eN) {
                    for (eN = !0; e$ > 0;) {
                        ...
                        e8.value.innerHTML = (e$ / 1e3).toFixed(2) + "s", e0.value.style.width = e$ / 15e3 * 100 + "%", e$ -= 40, await eo(40)
                    }
            ...
            return e5("CASINO_DOUBLE", e0 => {
                (async function (e0) {
                    ...
                    if (e2 instanceof HTMLElement) {
                        var e3;
                        e2.style.opacity = 1;
                        let e1 = `translateX(-${e8+3*Math.random()*(Math.random()>.5?1:-1)}rem)`;
                        await eU(e2, {
                            transform: e1
                        }, {
                            duration: 8e3,
                ...
                for (let e$ in e6) e6[e$].size = 0, e6[e$].amount = 0, e6[e$].mine = 0;
                e1.value = !1
            }), e5("CASINO_DOUBLE_BET", ({
                color: e$,
                amount: e0
            }) => {
                e6[e$].size += 1, e6[e$].amount += e0
            }), So.backend.casino_double().then(async e$ => {
                if (e4.push(...e$.last), "rolling" === e$.status) e1.value = !0, await e9(e$.delay);
                else if ("bet" === e$.status) {
                    for (let [e0, [e8, e2]] of Object.entries(e$.aggregate)) Object.assign(e6[e0], {
                        size: e8,
                        amount: e2
                    });
                    await e9(e$.delay)
                ...
                bet: function () {
                    ...
                    e0 && e0 > 0 && e3.value && So.backend.casino_double_bet(e$, e0).then(e8 => {
                        e8.error ? So.alert(e8.error) : (e6[e$].mine += e0, e7(-e0), e9(e8))
                    })
                },
                bets: e6,
                amount: e2,
...
AL.render = function (e$, e0, e8, e2, e3, e1) {
    return wl(), _l(bl, null, [Pl("div", SL, [Pl("div", TL, [Pl("div", EL, [RL, Pl("div", PL, [(wl(!0), _l(bl, null, fa(e2.lastColors, (e0, e8) => (wl(), _l("div", {
        key: e8,
        class: ["w-8 h-8 rounded flex flex-center", ["bg-blaze-" + e0], ]
    }, ["white" == e0 ? (wl(), _l("img", {
        key: 0,
        class: "w-4",
        src: e$.$asset("apps/unknown2.png", "casinoLogo"),
        alt: ""
    }, null, 8, ["src"])) : (wl(), _l("i", LL)), ], 2))), 128)), ]), ]), Pl("div", IL, [Pl("div", OL, null, 512), Pl("h1", ML, null, 512)]), VL, Pl("div", DL, [Pl("div", NL, [Pl("div", UL, [(wl(!0), _l(bl, null, fa(e2.repeated, (e0, e8) => (wl(), _l("div", {
        key: e8,
        class: ["blaze-tile", 0 == e0 ? "bg-white" : e0 > 7 ? "bg-blaze-black text-white" : "bg-blaze-red text-white", ]
    }, [0 == e0 ? (wl(), _l("img", {
        key: 0,
        class: "w-12",
        src: e$.$asset("apps/unknown2.png", "casinoLogo"),
        alt: ""
    }, null, 8, ["src"])) : (wl(), _l("span", $L, g(e0), 1)), ], 2))), 128)), ], 512), ]), ]), ]), Pl("div", jL, [Pl("div", FL, [Zn(Pl("input", {
        "onUpdate:modelValue": e0[1] || (e0[1] = e$ => e2.amount = e$),
        class: "w-full bg-blaze-dark p-6 font-bold rounded-xl text-gray-300 placeholder-current",
        placeholder: "Quantia",
        type: "text"
    }, null, 512), [
        [ns, e2.amount]
    ]), Pl("h1", zL, g(e2.currency), 1), ]), Pl("button", {
        onClick: e0[2] || (e0[2] = e$ => e2.multiply(.5)),
    ...
    }, g(e2.waiting ? "Esperando" : "Come\xe7ar o jogo"), 3), ]), Pl("div", qL, [GL, WL, Pl("div", KL, [Pl("h1", JL, g(e2.pretty(e2.bets.red.size)) + " Total de Apostas", 1), Pl("h1", XL, g(e$.$filters.intToMoney(e2.bets.red.amount)), 1), ]), ]), Pl("div", YL, [Pl("div", ZL, [Pl("img", {
        class: "w-8",
        src: e$.$asset("apps/unknown2.png", "casinoLogo"),
        alt: ""
    }, null, 8, ["src"]), ]), QL, Pl("div", eI, [Pl("h1", tI, g(e2.pretty(e2.bets.white.size)) + " Total de Apostas", 1), Pl("h1", nI, g(e$.$filters.intToMoney(e2.bets.white.amount)), 1), ]), ]), Pl("div", lI, [aI, sI, Pl("div", oI, [Pl("h1", rI, g(e2.pretty(e2.bets.black.size)) + " Total de Apostas", 1), Pl("h1", iI, g(e$.$filters.intToMoney(e2.bets.black.amount)), 1), ]), ]), ], 64)
};
const cI = {
        setup() {
            ...
            async function eD(e$, e0 = 15e3) {
                clearInterval(ej), ej = setInterval(() => {
                    if (e$ <= 0) return e5.value.innerHTML = "", eV.value.style.width = "0%", clearInterval(ej);
                    e5.value && eV.value && (e5.value.innerHTML = (e$ / 1e3).toFixed(2) + "s", eV.value.style.width = e$ / e0 * 100 + "%", e$ = Math.max(0, e$ - 40))
                }, 40)
            }

            function ez(e$ = 1) {
                e0.value = e$, eU = setInterval(() => {
                    let e$ = e0.value;
                    e0.value += .005 * Math.floor(e$)
                }, 50)
            }
            return So.backend.casino_crash().then(async e$ => {
                e7.push(...e$.last), e6.value = e$.totalBet, "waiting" === e$.status && e$.delay ? await eD(e$.delay) : "crashing" === e$.status ? (await ez(e$.multiplier), e$.totalBet || (e2.value = !0)) : "ending" === e$.status && (e4.value = !0, e0.value = e$.multiplier, e2.value = !0)
            }), eN("CASINO_CRASH_CASHOUT", e$ => e8.value = e$), eN("CASINO_CRASH_ENDING", e$ => {
                clearInterval(eU), e7.push(e$) > 10 && e7.shift(), e0.value = e$, e4.value = !0, e2.value = !0, eD(5e3, 5e3)
            }), eN("CASINO_CRASH_REFRESH", () => {
                e2.value = !1, e0.value = 0, e4.value = !1, e6.value = 0, e8.value = null
            }), eN("CASINO_CRASH", e$ => {
                e0.value = 1, e$ ? e4.value = !0 : ez()
            }), eN("CASINO_CRASH_WARMUP", () => eD(15e3)), wn(() => {
                ...
                bet: function () {
                    ...
                    if (e8 && e8 > 0) {
                        let e4 = parseFloat(null == (e0 = null == (e$ = e1.value) ? void 0 : e$.replace) ? void 0 : e0.call(e$, ",", ".")) || null;
                        So.backend.casino_crash_bet(e8, e4).then(e$ => {
                            e$.error ? So.alert(e$.error) : (e6.value += e8, e9(-e8), eD(e$.delay))
                        })
                    }
                },
                stop: function () {
                    e2.value || So.backend.casino_crash_cashout().then(e$ => {
                        e$.error ? So.alert(e$.error) : (e6.value = 0, e9(e$[1]), e8.value = e$)
                    })
                },
                totalBet: e6,
                amount: e3,
...
an();
const PI = uI((e$, e0, e8, e2, e3, e1) => (wl(), _l("div", dI, [Pl("div", pI, [Pl("ul", fI, [(wl(!0), _l(bl, null, fa(e2.rounds, (e$, e0) => (wl(), _l("li", {
    key: e0,
    class: ["p-2 rounded-xl", {
        "bg-blaze-light": e$ < 2,
        "bg-blaze-green": e$ >= 2
    }, ]
}, g(e$.toFixed(2)), 3))), 128)), ]), Pl("div", mI, [Pl("div", hI, null, 512), Pl("h1", bI, null, 512)]), e2.won ? (wl(), _l("div", gI, [Pl("div", vI, [Il(" x " + g(e2.won[0].toFixed(2)) + " ", 1), Pl("p", xI, "VOC\xca GANHOU! " + g(e$.$filters.intToMoney(e2.won[1])), 1), ]), ])) : Ml("", !0), e2.multiplier ? (wl(), _l("div", {
    key: 1,
    class: [{
        "top-28": e2.won
    }, "absolute text-center inset-0 grid place-items-center", ]
}, [e2.crashed ? (wl(), _l("div", yI, [Il(g(e2.multiplier.toFixed(2)) + "x ", 1), kI, ])) : e2.multiplier ? (wl(), _l("div", wI, g(e2.multiplier.toFixed(2)) + "x ", 1)) : Ml("", !0), ], 2)) : Ml("", !0), CI, ]), e2.totalBet > 0 && e2.multiplier > 0 ? (wl(), _l("button", {
    key: 0,
    onClick: e0[1] || (e0[1] = (...e$) => e2.stop && e2.stop(...e$)),
    class: ["bg-blaze-red w-full h-20 text-white font-bold text-2xl rounded-lg", {
        "opacity-50": e2.waiting
    }, ]
}, " Parar " + g(e$.$filters.intToMoney(e2.totalBet * e2.multiplier)), 3)) : (wl(), _l("button", {
    key: 1,
    onClick: e0[2] || (e0[2] = (...e$) => e2.bet && e2.bet(...e$)),
    class: ["bg-blaze-red w-full h-20 text-white font-bold text-2xl rounded-lg", {
        "opacity-50": e2.waiting
    }, ]
}, g(e2.waiting ? "Esperando" : "Come\xe7ar o jogo"), 3)), Pl("div", _I, [Pl("div", AI, [Zn(Pl("input", {
    "onUpdate:modelValue": e0[3] || (e0[3] = e$ => e2.amount = e$),
    class: "w-full bg-blaze-dark p-6 font-bold rounded-xl text-gray-300 placeholder-current",
    placeholder: "Quantia",
    type: "text"
}, null, 512), [
    [ns, e2.amount]
]), Pl("h1", SI, g(e2.currency), 1), ]), Pl("button", {
    onClick: e0[4] || (e0[4] = e$ => e2.multiply(.5)),
    class: "border w-32 rounded-xl text-2xl border-gray-600 text-gray-200"
}, " \xbd "), Pl("button", {
    onClick: e0[5] || (e0[5] = e$ => e2.multiply(2)),
    class: "border w-32 rounded-xl text-2xl border-gray-600 text-gray-200"
}, " 2x "), ]), Pl("div", TI, [EI, Zn(Pl("input", {
    "onUpdate:modelValue": e0[6] || (e0[6] = e$ => e2.cashout = e$),
...
const OI = {
        setup() {
            ...
            return {
                ...
                click: function (e$) {
                    e$ in LI.revealed || !LI.id || LI.lost || LI.clicking || (LI.clicking = !0, So.backend.casino_mine_click(e$).then(e0 => {
                        if (e0.error) return So.alert(e0.error);
                        "mine" == e0[0] && (LI.lost = !0), LI.revealed[e$] = e0[0], LI.reward = e0[1]
                ...
                finish: function () {
                    e2.value && So.backend.casino_mine_finish().then(e$ => {
...
OI.render = function (e$, e0, e8, e2, e3, e1) {
    return wl(), _l("div", MI, [Pl("div", VI, [(wl(!0), _l(bl, null, fa(Array(25), (e$, e0) => (wl(), _l("button", {
        key: e0,
        onClick: e$ => e2.click(e0),
        class: "aspect-1/1 bg-gradient-to-br from-coolGray-800 to-coolGray-900 rounded-lg flex flex-center"
    }, ["diamond" == e2.game.revealed[e0] ? (wl(), _l("i", DI)) : "mine" == e2.game.revealed[e0] ? (wl(), _l("i", NI)) : Ml("", !0), ], 8, ["onClick"]))), 128)), ]), e2.game.id ? Ml("", !0) : (wl(), _l("div", UI, [Pl("div", $I, [Zn(Pl("input", {
        "onUpdate:modelValue": e0[1] || (e0[1] = e$ => e2.amount = e$),
        class: "w-full bg-blaze-dark p-6 font-bold rounded-xl text-gray-300 placeholder-current",
        placeholder: "Quantia",
        type: "text"
        ...
        [ns, e2.amount]
    ]), Pl("h1", jI, g(e2.currency), 1), ]), Pl("button", {
        onClick: e0[2] || (e0[2] = e$ => e2.multiply(.5)),
        class: "border w-32 rounded-xl text-2xl border-gray-600 text-gray-200"
    }, " \xbd "), Pl("button", {
        onClick: e0[3] || (e0[3] = e$ => e2.multiply(2)),
        class: "border w-32 rounded-xl text-2xl border-gray-600 text-gray-200"
    }, " 2x "), ])), e2.game.id ? (wl(), _l("div", BI, [HI, Pl("input", {
        disabled: "",
        ...
        "onUpdate:modelValue": e0[4] || (e0[4] = e$ => e2.mines = e$),
        class: "w-full bg-blaze-dark p-6 font-bold rounded-xl text-gray-300 placeholder-current",
        placeholder: "Quantidade",
        type: "text"
    }, null, 512), [
        [ns, e2.mines]
    ]), ])), !e2.game.id || e2.game.lost ? (wl(), _l("button", {
        key: 3,
        onClick: e0[5] || (e0[5] = (...e$) => e2.play && e2.play(...e$)),
        class: "bg-blaze-red w-full py-4 text-xl text-white rounded-lg"
    }, g(e2.game.lost ? "Jogar novamente" : "Jogar"), 1)) : (wl(), _l("button", {
        key: 4,
        onClick: e0[6] || (e0[6] = (...e$) => e2.finish && e2.finish(...e$)),
        class: ["bg-blaze-red w-full py-4 text-xl text-white rounded-lg", {
...
const qI = {
        ...
        setup() {
            ...
            function e3(e$) {
                var e0;
                e0 = e8, $k.has(e0) && $k.get(e0)(), $k.delete(e0), jk(e8, e8.value + e$)
            }
            ...
            function e1() {
                for (let {
                        event: e$,
                        callback: e0
                    } of e2) So.pusher.removeListener(e$, e0);
                e2.length = 0
            }
            return function (e$, e0) {
                if (!e0) return e$();
                if (void 0 === kL) {
                    ...
                    kL = e8 && e8.supports && e8.supports("modulepreload") ? "modulepreload" : "preload"
                }
                Promise.all(e0.map(e$ => {
                    if (e$ in wL) return;
                    wL[e$] = !0;
                    let e0 = e$.endsWith(".css");
                    if (document.querySelector(`link[href="${e$}"]${e0?'[rel="stylesheet"]':""}`)) return;
                    let e8 = document.createElement("link");
                    return e8.rel = e0 ? "stylesheet" : kL, e0 || (e8.as = "script", e8.crossOrigin = ""), e8.href = e$, document.head.appendChild(e8), e0 ? new Promise((e$, e0) => {
                        e8.addEventListener("load", e$), e8.addEventListener("error", e0)
                    }) : void 0
                })).then(() => e$())
            }(() => __import__("https://cdnjs.cloudflare.com/ajax/libs/Chart.js/3.8.0/chart.min.js"), void 0), $l("setBalance", e$ => jk(e8, e$)), $l("addBalance", e3), $l("onceTab", function (e$, e0) {
                e2.push({
                    event: e$,
                    callback: e0
                }), So.pusher.on(e$, e0)
            }), So.pusher.on("CASINO_INCREMENT", e3), Tn(e0, e1), wn(e1), So.backend.casino_balance().then(e$ => e8.value = Number(e$)), {
                currency: e$,
                tab: e0,
                balance: e8,
                deposit: function () {
                    So.prompt("Digite o valor do dep\xf3sito").then(e$ => {
                        let e0 = parseInt(e$);
                        e0 && e0 > 0 && So.backend.casino_deposit(e0).then(e$ => {
                            e$ && (e8.value += e0)
                        })
                    }, () => {})
                },
                withdraw: function () {
                    So.prompt("Digite o valor do saque").then(e$ => {
                        let e0 = parseInt(e$);
                        e0 && e0 > 0 && So.backend.casino_withdraw(e0).then(e$ => {
                            e$ && (e8.value -= e0)
                        })
                    }, () => {})
                }
...
qI.render = function (e$, e0, e8, e2, e3, e1) {
    ...
    return wl(), _l("div", GI, [Pl("div", WI, [Pl("img", {
        ...
        src: e$.$asset("apps/unknown2.png", "casinoLogo"),
        alt: ""
    }, null, 8, ["src"]), Pl("div", KI, [Pl("h1", JI, g(e2.currency), 1), Pl("h3", XI, g(e2.balance.toLocaleString()), 1), ]), Pl("button", {
        onClick: e0[1] || (e0[1] = (...e$) => e2.deposit && e2.deposit(...e$)),
        class: "bg-blaze-red text-white text-xl font-bold h-14 px-4 ml-5 rounded-lg"
    }, " Depositar "), Pl("button", {
        onClick: e0[2] || (e0[2] = (...e$) => e2.withdraw && e2.withdraw(...e$)),
        class: "bg-blaze-red text-white text-xl font-bold h-14 px-4 ml-5 rounded-lg"
    }, [YI]), ]), "double" == e2.tab ? (wl(), _l(e6, {
        key: 0
    })) : Ml("", !0), "crash" == e2.tab ? (wl(), _l(e4, {
        key: 1
    })) : "mine" == e2.tab ? (wl(), _l(e7, {
        key: 2
        ...
        setup() {
            ...
            return setInterval(() => {
                ...
                newGame: function (e2, e3) {
                    e$.length = 0, e0.state = "playing", e0.bombs = e3, e0.marked = 0, e0.time = 0;
                    for (let e1 = 0; e1 < e2; e1++) {
                        let e6 = [];
                        for (let e4 = 0; e4 < e2; e4++) e6.push({
                            x: e1,
                            y: e4,
                            nearby: 0,
                            revealed: !1,
                ...
                reveal: function e8(e2) {
                    if (!e2.marked && "defeat" != e0.state && !e2.revealed) {
                        if (e2.revealed = !0, e2.mine) e0.state = "defeat";
                            ...
                            let e3 = e$.flat(),
                                e1 = e3.filter(e$ => e$ != e2 && 1.9 > Math.sqrt((e$.x - e2.x) ** 2 + (e$.y - e2.y) ** 2)),
                                e6 = e1.reduce((e$, e0) => e$ + e0.mine, 0);
                            0 == e6 ? e1.forEach(e$ => e8(e$)) : e2.nearby = e6, e3.reduce((e$, e0) => e$ + e0.revealed, 0) == e3.length - e0.bombs && (e0.state = "win")
                        }
                    }
                },
                mark: function (e$) {
                    e$.revealed || "playing" != e0.state || e0.marked >= e0.bombs && !e$.marked || (e$.marked = !e$.marked, e0.marked += e$.marked ? 1 : -1)
                }
            }
        }
    },
...
sO.render = function (e$, e0, e8, e2, e3, e1) {
    ...
    }, [Pl("h3", null, g(e$) + "x" + g(e$), 1)], 8, ["onClick"])), 64)), ]), Pl("div", iO, [(wl(!0), _l(bl, null, fa(e2.columns, (e$, e0) => (wl(), _l("div", {
        class: "flex flex-col flex-1",
        key: e0
    }, [(wl(!0), _l(bl, null, fa(e$, (e$, e0) => (wl(), _l("div", {
        key: e0,
        class: ["w-full square border border-gray-600 flex flex-center", [e$.revealed ? "bg-gray-400" : "bg-gray-500"], ],
        onClick: e0 => e2.reveal(e$),
        onContextmenu: is(e0 => e2.mark(e$), ["prevent", "stop"])
    }, [Pl("div", cO, [e$.marked ? (wl(), _l("i", uO)) : e$.revealed && e$.mine ? (wl(), _l("i", dO)) : (wl(), _l("p", {
        key: 2,
        nearby: e$.nearby,
        class: "font-bold"
    }, g(e$.nearby || ""), 9, ["nearby"])), ]), ], 42, ["onClick", "onContextmenu"]))), 128)), ]))), 128)), ]), "playing" == e2.game.state ? (wl(), _l("div", pO, [Pl("div", fO, [Pl("div", mO, g(e$.$filters.duration(e2.game.time)), 1), Pl("div", hO, [Pl("h3", null, "💣 " + g(e2.game.bombs - e2.game.marked), 1), ]), ]), ])) : (wl(), _l("div", bO, ["win" == e2.game.state ? (wl(), _l("h1", gO, "Voc\xea venceu em " + g(e$.$filters.duration(e2.game.time)), 1)) : "defeat" == e2.game.state ? (wl(), _l("h1", vO, "Voc\xea perdeu")) : (wl(), _l("h1", xO, "Escolha um modo de jogo")), ])), ])
};
const yO = {
...
yO.render = function (e$, e0, e8, e2, e3, e1) {
    return wl(), _l("div", kO, [Pl("div", wO, [Pl("button", {
        class: "absolute top-16 left-0 px-4",
        onClick: e0[1] || (e0[1] = (...e0) => e$.$router.back && e$.$router.back(...e0))
    }, [e2.isAndroid ? (wl(), _l("i", CO)) : (wl(), _l("i", _O))]), Pl("h1", {
        class: ["font-bold", {
            "ml-16": e2.isAndroid,
            "text-center": !e2.isAndroid
        }, ]
...
SO.render = function (e$, e0, e8, e2, e3, e1) {
    return wl(), _l("div", TO, [Pl("div", EO, [Pl("button", {
        class: "absolute top-16 left-0 px-4",
        onClick: e0[1] || (e0[1] = (...e0) => e$.$router.back && e$.$router.back(...e0))
    }, [e2.isAndroid ? (wl(), _l("i", RO)) : (wl(), _l("i", PO))]), Pl("h1", {
        class: ["font-bold", {
            "ml-16": e2.isAndroid,
            "text-center": !e2.isAndroid
        }, ]
...
const IO = [{
    ...
    OO = function (e$) {
        ...
        function eU(e$, e1) {
            ...
            let eH, eZ = (e4 = e2, eH = (e5 = zr({}, e$, {
                    hash: (e6 = eB, Gi(e6).replace(zi, "{").replace(Hi, "}").replace(ji, "^")),
                    path: eF.path
                })).query ? e4(e5.query) : "", e5.path + (eH && "?") + eH + (e5.hash || "")),
                eG = e3.createHref(eZ);
            return zr({
                fullPath: eZ,
                hash: eB,
        ...
        function eF(e$) {
            ...
            if (e0 && e0.redirect) {
                let {
                    redirect: e8
                } = e0, e2 = "function" == typeof e8 ? e8(e$) : e8;
                return "string" == typeof e2 && (e2 = e2.indexOf("?") > -1 || e2.indexOf("#") > -1 ? e2 = ej(e2) : {
                    path: e2
                }), zr({
                    query: e$.query,
                    hash: e$.hash,
        ...
        function eB(e$, e0) {
            ...
            let ez = e6,
                eH, eW, eK;
            return ez.redirectedFrom = e0, !eN && (e8 = e2, e3 = e4, e1 = e6, eW = e3.matched.length - 1, eK = e1.matched.length - 1, eW > -1 && eW === eK && Kr(e3.matched[eW], e1.matched[eK]) && Jr(e3.params, e1.params) && e8(e3.query) === e8(e1.query) && e3.hash === e1.hash) && (eH = vi(16, {
                to: ez,
                from: e4
            }), t$(e4, e4, !0, !1)), (eH ? Promise.resolve(eH) : eZ(ez, e4)).catch(e$ => xi(e$) ? e$ : eQ(e$)).then(e$ => {
                if (e$) {
                    if (xi(e$, 2)) return eB(zr(ej(e$.to), {
                        state: eV,
                        force: eN,
                        replace: e9
                    }), e0 || ez)
        ...
        function eZ(e$, e0) {
            let e8, [e2, e3, e4] = function (e$, e0) {
                ...
                for (let e6 = 0; e6 < e1; e6++) {
                    ...
                    e4 && (e$.matched.find(e$ => Kr(e$, e4)) ? e2.push(e4) : e8.push(e4));
                    let e7 = e$.matched[e6];
                    e7 && (e0.matched.find(e$ => Kr(e$, e7)) || e3.push(e7))
                }
                return [e8, e2, e3]
            }(e$, e0);
            for (let e7 of (e8 = tc(e2.reverse(), "beforeRouteLeave", e$, e0), e2)) e7.leaveGuards.forEach(e2 => {
                e8.push(ec(e2, e$, e0))
            });
            let e5 = eH.bind(null, e$, e0);
            return e8.push(e5), ic(e8).then(() => {
                for (let e2 of (e8 = [], e1.list())) e8.push(ec(e2, e$, e0));
                return e8.push(e5), ic(e8)
            }).then(() => {
                for (let e2 of (e8 = tc(e3, "beforeRouteUpdate", e$, e0), e3)) e2.updateGuards.forEach(e2 => {
                    e8.push(ec(e2, e$, e0))
                });
                return e8.push(e5), ic(e8)
            }).then(() => {
            ...
            }).then(() => (e$.matched.forEach(e$ => e$.enterCallbacks = {}), (e8 = tc(e4, "beforeRouteEnter", e$, e0)).push(e5), ic(e8))).then(() => {
        ...
        function eq(e$, e0, e8, e2, e1) {
            ...
            let e4 = e0 === mi,
                e5 = Fr ? history.state : {};
            e8 && (e2 || e4 ? e3.replace(e$.fullPath, zr({
                scroll: e4 && e5 && e5.scroll
            }, e1)) : e3.push(e$.fullPath, e1)), e7.value = e$, t$(e$, e0, e8, e4), eJ()
        }
        let eW, eK, eX = Qi(),
            eY = Qi();
        ...
        function eJ(e$) {
            eK || (eK = !0, eW = e3.listen((e$, e0, e8) => {
                var e2, e1;
                let e6 = eU(e$),
                    e4 = eF(e6);
                if (e4) return void eB(zr(e4, {
                    replace: !0
                }), e6).catch(Hr);
                e5 = e6;
                let eV = e7.value;
                Fr && (e2 = ri(eV.fullPath, e8.delta), e1 = si(), ii.set(e2, e1)), eZ(e6, eV).catch(e$ => xi(e$, 12) ? e$ : xi(e$, 2) ? (eB(e$.to, e6).catch(Hr), Promise.reject()) : (e8.delta && e3.go(-e8.delta, !1), eQ(e$))).then(e$ => {
                    (e$ = e$ || eq(e6, eV, !1)) && e8.delta && e3.go(-e8.delta, !1), eG(e6, eV, e$)
                }).catch(Hr)
            }), eX.list().forEach(([e0, e8]) => e$ ? e8(e$) : e0()), eX.reset())
        }
        ...
        function t$(e0, e8, e2, e3) {
            ...
            let e6 = !e2 && function (e$) {
                let e0 = ii.get(e$);
                return ii.delete(e$), e0
            }(ri(e0.fullPath, 0)) || (e3 || !e2) && history.state && history.state.scroll || null;
            return Lt().then(() => e1(e0, e8, e6)).then(e$ => e$ && oi(e$)).catch(eQ)
        }
        let t0 = e$ => e3.go(e$),
            t8, t2 = new Set;
        return {
            ...
            addRoute: function (e$, e8) {
                let e2, e3;
                return fi(e$) ? (e2 = e0.getRecordMatcher(e$), e3 = e8) : e3 = e$, e0.addRoute(e3, e2)
            },
            ...
            onError: eY.add,
            isReady: function () {
                return eK && e7.value !== mi ? Promise.resolve() : new Promise((e$, e0) => {
                    eX.add([e$, e0])
                })
            },
            install(e$) {
                ...
                e$.component("RouterLink", lc), e$.component("RouterView", rc), e$.config.globalProperties.$router = this, Object.defineProperty(e$.config.globalProperties, "$route", {
                    get: () => ut(e7)
                }), Fr && !t8 && e7.value === mi && (t8 = !0, eB(e0 = e3.location).catch(e$ => {}));
                let e8 = {};
                for (let e2 in mi) e8[e2] = da(() => e7.value[e2]);
                e$.provide(Ur, this), e$.provide($r, Ze(e8)), e$.provide(jr, e7);
                let e1 = e$.unmount;
                t2.add(e$), e$.unmount = function () {
                    t2.delete(e$), t2.size < 1 && (eW(), e7.value = mi, t8 = !1, eK = !1), e1()
                }
            }
        }
    }({
...
const DO = () => VO.currentRoute.value.path,
    NO = new Map;
for (let [kM, wM] of (NO.set("GPS", ({
        location: [e$, e0]
    }) => {
        So.client.SetNewWaypoint(e$, e0), So.addNotification("gps", "GPS", "O destino foi marcado em seu GPS")
        ...
        if (e$ != So.identity.phone) {
            ...
            e6.match(/(http)?s?:?(\/\/[^"']*\.(?:webm|ogg))/) ? e6 = "\uD83D\uDD0A \xc1udio" : e6.length > 40 && (e6 = e6.substr(0, 40) + "..."), e0 && DO() != `/whatsapp/group${e0.id}` ? So.addNotification("whatsapp", e0.name, `<b>${e1}:</b> ${e6}`) : e0 || DO() == `/whatsapp/${e$}` || So.addNotification("whatsapp", e1, e6)
        }
    }), NO.set("WHATSAPP_GROUP_KICK", ({
        name: e$
    }) => So.addNotification("whatsapp", e$, "Voc\xea foi removido do grupo")), NO.set("WHATSAPP_GROUP_DESTROY", ({
        name: e$
    }) => So.addNotification("whatsapp", e$, "O grupo foi exclu\xeddo")), NO.set("INSTAGRAM_NOTIFY", e$ => So.addNotification("instagram", Zs("instagram"), zs(e$))), NO.set("PAYPAL", ({
        sender: e$,
        value: e0
    }) => {
        let e8 = Bs(e$);
        So.addNotification("paypal", "PayPal", `<b class="text-black">${e8}</b> transferiu <b class="text-black">${js(e0)}</b> para sua conta`)
    }), NO.set("BANK", ({
        sender: e$,
        value: e0
    }) => {
        let e8 = Bs(e$);
        So.addNotification("bank", Zs("bank"), `<b class="text-black">${e8}</b> transferiu <b class="text-black">${js(e0)}</b> para sua conta`)
    }), NO.set("BANK_NOTIFY", ({
        title: e$,
        subtitle: e0
    }) => So.addNotification("bank", e$, e0)), NO.set("BANK_INVOICE", ({
        value: e$
    }) => So.addNotification("bank", "Fatura recebida", `Voc\xea recebeu uma fatura no valor de ${js(e$)}`)), NO.set("BANK_INVOICE_RECEIPT", ({
        value: e$,
        name: e0
    }) => So.addNotification("bank", `${e0} pagou uma fatura`, `Foram creditados ${js(e$)} em sua conta`)), NO.set("TINDER_MESSAGE", ({
        sender: e$,
        sender_name: e0,
        content: e8,
        sender_uid: e2
    }) => {
        e2 != So.identity.user_id && DO() != `/tinder/chats/${e$}` && So.addNotification("tinder", e0, e8)
    }), NO.set("TINDER_MATCH", ({
        profile: {
            name: e$
        }
    }) => So.addNotification("tinder", "Match!", `Voc\xea agora tem um match com ${e$}! <i class="fas fa-heart text-red-500"></i>`)), NO.set("TWITTER_NOTIFY", e$ => {
        ...
        if ("geral" != e$.channel && e$.sender != eb.id && DO() !== "/tor/" + (e0 ? e$.sender : e$.channel)) {
            let e8 = e$.location ? "\uD83C\uDF0E Localiza\xe7\xe3o" : e$.image ? "📷 Foto" : e$.content;
            So.addNotification("tor", e0 ? eb.getNickname(e$.sender) : "#" + e$.channel, e8)
        }
        ...
        if (null != e$.created_at || (e$.created_at = Math.floor(Date.now() / 1e3)), e0 in So.messages ? So.messages[e0].push(e$) > 100 && So.messages[e0].shift() : So.messages[e0] = [e$], So.hasNotificationFor("sms") && DO() != "/sms/" + e0) {
            let e1 = e8.substr(0, 40);
            e8.length > 40 && (e1 += "..."), So.addNotification("sms", Bs(e0), e2 ? "📷 Foto" : e3 ? "\uD83C\uDF0E Localiza\xe7\xe3o" : e1)
        }
    }), NO.entries())) So.pusher.on(kM, e$ => {
...
const zO = {
        ...
        setup() {
            ...
            if (So.localhost) {
                ...
                eH.style.backgroundColor = "blue", eH.style.backgroundSize = "100vw 100vh"
            }
            let eZ = e$ => (e0, e8 = 255) => new Promise(e2 => {
            ...
            $l("videoCamera", () => new Promise((e$, e0) => {
                ez.value = [e$, e0]
            }).finally(() => ez.value = null)), $l("alert", So.alert = e$ => e6.value = e$), $l("prompt", So.prompt = eZ(e7)), $l("confirm", So.confirm = eZ(e4)), $l("setDark", e$ => e0.value = null != e$ ? e$ : So.darkTheme.value), $l("setLoading", e$ => eF.value = e$), So.fetchSettings(), So.localhost && So.created();
            let eG = rt(!1);
            Tn(eG, e$ => So.client.setInput(e$));
            let eq = {
                open() {
                    var e$;
                    eB = Date.now() + 500, e8.value = !0, (null == (e$ = e3.value) ? void 0 : e$.accepted) || So.client.playAnim("toText", !0), So.client.setState("usingPhone", !0)
                },
                async close() {
                    var e0;
                    ["/call", "/"].includes(e$.currentRoute.value.path) || e$.push("/home"), [e6, e7, e5, e4, ez].forEach(e$ => e$.value = null), e8.value = !1, eG.value = !1, (null == (e0 = e3.value) ? void 0 : e0.accepted) || So.client.playAnim("fromText"), So.client.close(), So.client.setState("usingPhone", !1)
                },
                pusher(e$, e0) {
                    So.pusher.emit(e$, e0)
                }
            ...
            function eW(e0) {
                ...
                if (eB > Date.now() || "Escape" != e0 && "Backspace" != e0 || eF.value) return;
                if (eD.value) return eD.value = null;
                let e2 = "Escape" == e0;
                go().state.request.value = null;
                let e3 = e$.currentRoute.value.path;
                if ("Backspace" === e0 && !document.querySelector("input:focus,textarea:focus")) {
                    if ("/home" == e3) e2 = !0;
                    else if (ez.value) ez.value = null;
                    else if ("/call" != e3 && "/" != e3) return [e6, e4, e7].forEach(e$ => e$.value = null), e$.back()
                }
                e2 && eq.close()
            }
            return So.pusher.on("REDIRECT", e0 => {
                So.visible.value || So.client.open(), "/home" != e$.currentRoute.value.path && e$.replace("/home"), e$.push(e0)
            }), So.pusher.on("CALL_REQUEST", async e0 => {
                So.storage.doNotDisturb.value || await So.client.isAlive() && (e0.contact = So.contacts.value.find(e$ => e$.phone == e0.initiator.phone) || {
                    name: e0.isAnonymous ? "An\xf4nimo" : e0.initiator.phone,
                    phone: e0.initiator.phone
                }, e3.value = e0, e8.value || So.addNotification(e0.isVideo ? "facetime" : "phone", e0.isVideo ? "Chamada de V\xeddeo" : "Chamada de Voz", e0.contact.name + " est\xe1 te ligando"), e$.push("/call"))
            }), So.pusher.on("CALL_TO", (e0, e8 = !1) => {
                if (e0 == So.identity.phone) return e6.value = "Voc\xea n\xe3o pode ligar para si mesmo";
                let e2 = So.storage.anonymousCall.value;
                So.backend.createPhoneCall(e0, e8, e2).then(e8 => {
                    e8.error ? e6.value = e8.error : (e8.contact = {
                        name: Bs(e0),
                        phone: e0
                    }, e8.owner = !0, e3.value = e8, e$.push("/call"), So.visible.value || So.client.open())
                })
            }), So.pusher.on("SET_VISIBLE", e$ => e8.value = e$), So.pusher.on("REFRESH", () => {
                e$.replace("/"), So.identity.phone = null, So.fetchSettings(), So.backend.ig_logout()
            }), So.pusher.on("SERVICE_RESPONSE", () => e6.value = "Seu chamado foi atendido"), So.pusher.on("SERVICE_REJECT", () => e6.value = "Seu chamado foi rejeitado"), So.pusher.on("PHONE_CHANGE", ({
                from: e$,
                to: e0
            }) => {
                var e8;
                ...
                }), (null == (e8 = So.identity) ? void 0 : e8.phone) == e$ && (So.identity.phone = e0)
                ...
                ro.start(), setTimeout(async () => {
                    ...
                    e8.append("file", e0, Date.now() + ".jpg"), fetch(e$, {
                        method: "POST",
                        body: e8
                    }), ro.stop()
                }, 200)
            }), globalThis.pusher = So.pusher, So.localhost && (globalThis.store = So), $l("useImageFocus", e$ => eD.value = e$), $l("setKeepInput", e$ => eG.value = e$), So.captureMicrophone(), window.addEventListener("message", ({
                data: {
                    event: e$,
                    args: e0
                }
                ...
                key: e$
            }) => eW(e$)), So.pusher.on("keydown", eW), So.pusher.on("setDark", e$ => e0.value = e$), So.pusher.on("prompt", e$ => eZ(e7)(e$).then(e$ => So.client.fPrompt(e$))), So.pusher.on("confirm", e$ => eZ(e4)(e$).then(e$ => So.client.fConfirm(e$))), So.pusher.on("alert", e$ => e6.value = e$), {
                visible: e8,
                loading: eF,
                android: e9,
                clock: eU,
...
const cM = BO((e$, e0, e8, e2, e3, e1) => {
    ...
    return wl(), _l(bl, null, [Pl(Ja, {
        ...
        default: BO(() => [e2.call && e2.call.accepted && !e2.visible ? (wl(), _l("li", HO, [Pl("img", {
            src: e$.$asset("apps/phone.png"),
            class: "w-8 rounded-xl"
        }, null, 8, ["src"]), Pl("div", qO, [GO, Pl("span", null, g(e2.call.contact.name), 1), ]), ])) : Ml("", !0), (wl(!0), _l(bl, null, fa(e2.notifications, e$ => (wl(), _l("li", {
            class: "notification select-none",
            key: e$.id
        }, [Pl("img", {
            src: e$.icon,
        ...
        _: 1
    }, 8, ["style"]), e2.imageFocused ? (wl(), _l("div", KO, [Pl("div", JO, [Pl("div", XO, [Pl("button", {
        onClick: e0[1] || (e0[1] = e$ => e2.imageFocused = null),
        ...
        default: BO(() => [Zn(Pl("div", ZO, [Pl("img", {
            ...
            key: 0,
            class: {
                "text-white": e2.dark, "text-black": !e2.dark
            }
        }, [Pl("div", eM, [Pl("span", tM, g(e2.clock), 1), e2.android ? Ml("", !0) : (wl(), _l("i", nM)), ]), Pl("div", lM, [aM, sM, e2.android ? Ml("", !0) : (wl(), _l("i", oM)), ]), ], 2)) : Ml("", !0), e2.loading ? (wl(), _l("div", rM, [iM])) : Ml("", !0), e2.alert ? (wl(), _l(e6, {
            key: 2,
            content: e2.alert
        }, null, 8, ["content", ])) : Ml("", !0), e2.prompt ? (wl(), _l(e4, Ul({
            key: 3
        }, e2.prompt), null, 16)) : Ml("", !0), e2.confirm ? (wl(), _l(e7, {
            key: 4,
            title: e2.confirm.title,
            callback: e2.confirm.callback
        }, null, 8, ["title", "callback"])) : Ml("", !0), Pl(e5), Pl(Oa, {
            name: "menu"
        }, {
            default: BO(() => [Pl(eV)]),
            _: 1
        }), e2.paint.original ? (wl(), _l(eN, {
            key: 5
        })) : Ml("", !0), e2.recording ? (wl(), _l(e9, {
            key: 6,
            callback: e2.recording
        }, null, 8, ["callback", ])) : Ml("", !0), Pl(eU, {
...
an();
const fM = dM((e$, e0, e8, e2, e3, e1) => (wl(), _l("label", {
    class: "form-switch",
    android: e2.android
}, [Pl("input", {
    type: "checkbox",
    checked: e8.modelValue,
    onInput: e0[1] || (e0[1] = e0 => e$.$emit("update:modelValue", e0.target.checked))
...
const yM = ((...e$) => {
    ...
    return e0.mount = e$ => {
        ...
        M(e3) || e3.render || e3.template || (e3.template = e2.innerHTML), e2.innerHTML = "";
        let e1 = e8(e2);
        return e2 instanceof Element && (e2.removeAttribute("v-cloak"), e2.setAttribute("data-v-app", "")), e1
    }, e0
})(zO);
yM.component("AppInput", JP), yM.component("AppSelect", XP), yM.component("AppToggle", uM), yM.component("AppLoading", mM), yM.component("AppVerified", bM), yM.use(VO), yM.config.globalProperties.$filters = Gs, yM.config.globalProperties.$asset = (e$, e0) => So.settings[e0] || So.asset(e$), Object.defineProperty(yM.config.globalProperties, "$currency", {
